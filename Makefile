...
scripts-check:
	...
	python3 -m compileall -q scripts sdk/scripts/annotate_go_nullable_updates.py sdk/scripts/check_fixture_vocabulary.py sdk/scripts/check_package_files.py sdk/scripts/check_facade_parity.py sdk/scripts/fix_typescript_turn_input.py
