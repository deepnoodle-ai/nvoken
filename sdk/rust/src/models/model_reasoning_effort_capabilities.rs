...
pub struct ModelReasoningEffortCapabilities {
    #[serde(rename = "supported")]
    pub supported: bool,
    #[serde(rename = "values")]
    pub values: Vec<models::ReasoningEffort>,
    #[serde(rename = "with_temperature")]
    pub with_temperature: bool,
}

impl ModelReasoningEffortCapabilities {
    pub fn new(
        supported: bool,
        values: Vec<models::ReasoningEffort>,
