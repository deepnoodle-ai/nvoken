...
pub struct SubmitHostToolResultsRequest {
    #[serde(rename = "results")]
    pub results: Vec<models::SubmitHostToolResultsRequestResultsInner>,
}

impl SubmitHostToolResultsRequest {
    pub fn new(
        results: Vec<models::SubmitHostToolResultsRequestResultsInner>,
    ) -> SubmitHostToolResultsRequest {
        SubmitHostToolResultsRequest { results }
    }
}
