...
pub enum ErrorCode {
    ...
    NotFound,
    #[serde(rename = "invocation_erased")]
    InvocationErased,
    ...
    #[serde(rename = "invocation_active")]
    InvocationActive,
    #[serde(rename = "invocation_session_bound")]
    InvocationSessionBound,
...
impl std::fmt::Display for ErrorCode {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::InvocationErased => write!(f, "invocation_erased"),
            ...
            Self::InvocationActive => write!(f, "invocation_active"),
            Self::InvocationSessionBound => write!(f, "invocation_session_bound"),
