...
pub struct Tenant {
    ...
    /// When this tenant last had a turn admitted, or null if it never has. Read from retained Invocation facts, so Session deletion does not change it.
    #[serde(
        rename = "last_invocation_at",
        deserialize_with = "Option::deserialize"
    )]
    pub last_invocation_at: Option<chrono::DateTime<chrono::FixedOffset>>,
...
impl Tenant {
    pub fn new(
        ...
        last_invocation_at: Option<chrono::DateTime<chrono::FixedOffset>>,
