...
pub struct StreamResyncEvent {
    ...
    /// The Invocation whose previews are void. Absent means every Invocation in the Session: an absent field is scope, where a null identifier would be scope wearing an identifier's name.
    #[serde(rename = "invocation_id", skip_serializing_if = "Option::is_none")]
    pub invocation_id: Option<String>,
    #[serde(rename = "reason")]
    pub reason: models::StreamResyncReason,
}
...
impl StreamResyncEvent {
    pub fn new(
        r#type: Type,
        session_id: String,
        reason: models::StreamResyncReason,
    ) -> StreamResyncEvent {
        StreamResyncEvent {
            r#type,
            session_id,
