...
pub struct StreamResyncEvent {
    ...
    /// The Turn whose previews are void. Absent means every Turn in the Conversation: an absent field is scope, where a null identifier would be scope wearing an identifier's name.
