...
/// ForkSessionRequestFromMessage : Inclusive fork point, by stable message ID or sequence.
/// Inclusive fork point, by stable message ID or sequence.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ForkSessionRequestFromMessage {
    /// UUIDv7 with the public `smsg_` prefix.
    SessionMessageId(String),
    Integer(u64),
}

impl Default for ForkSessionRequestFromMessage {
    fn default() -> Self {
        Self::SessionMessageId(Default::default())
    }
}
