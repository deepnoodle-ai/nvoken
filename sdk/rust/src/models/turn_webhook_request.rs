...
pub struct TurnWebhookRequest {
    #[serde(rename = "nvoken")]
    pub nvoken: Box<models::TurnWebhookContext>,
    #[serde(rename = "turn")]
    pub turn: Box<models::TurnWebhookSubject>,
}

impl TurnWebhookRequest {
    pub fn new(
        nvoken: models::TurnWebhookContext,
        turn: models::TurnWebhookSubject,
    ) -> TurnWebhookRequest {
        TurnWebhookRequest {
            nvoken: Box::new(nvoken),
            turn: Box::new(turn),
        }
    }
}
