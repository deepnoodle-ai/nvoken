...
pub struct InlineTurnBehaviorSource {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "digest")]
    pub digest: String,
...
impl InlineTurnBehaviorSource {
    pub fn new(kind: Kind, digest: String) -> InlineTurnBehaviorSource {
        InlineTurnBehaviorSource { kind, digest }
    }
}
///
