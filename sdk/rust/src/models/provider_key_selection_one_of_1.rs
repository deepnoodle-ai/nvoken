...
pub struct ProviderKeySelectionOneOf1 {
...
impl ProviderKeySelectionOneOf1 {
    pub fn new(provider: String, source: Source) -> ProviderKeySelectionOneOf1 {
        ProviderKeySelectionOneOf1 { provider, source }
    }
}
///
