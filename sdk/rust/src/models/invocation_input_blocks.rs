...
pub struct InvocationInputBlocks {
    /// Ordered caller-input blocks.
    #[serde(rename = "content")]
    pub content: Vec<models::TextInputBlock>,
}

impl InvocationInputBlocks {
    pub fn new(content: Vec<models::TextInputBlock>) -> InvocationInputBlocks {
        InvocationInputBlocks { content }
    }
}
