...
#[serde(untagged)]
pub enum InvocationStreamResponse {
    InvocationStreamEvent(Box<models::InvocationStreamEvent>),
    ClientInvocationStreamEvent(Box<models::ClientInvocationStreamEvent>),
}

impl Default for InvocationStreamResponse {
    fn default() -> Self {
        Self::InvocationStreamEvent(Default::default())
    }
}
///
