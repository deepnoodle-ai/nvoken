...
pub struct ConversationCompactionList {
    #[serde(rename = "items")]
    pub items: Vec<models::ConversationCompaction>,
...
impl ConversationCompactionList {
    pub fn new(
        items: Vec<models::ConversationCompaction>,
        has_more: bool,
