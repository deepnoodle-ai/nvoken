...
pub struct AdmissionReasonCount {
...
impl AdmissionReasonCount {
    pub fn new(error_code: String, count: i64) -> AdmissionReasonCount {
        AdmissionReasonCount { error_code, count }
    }
}
