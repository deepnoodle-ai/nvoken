...
pub struct ActivityMetrics {
    ...
    pub invocations: u32,
    #[serde(rename = "completed_invocations")]
    pub completed_invocations: u32,
    #[serde(rename = "incomplete_invocations")]
    pub incomplete_invocations: u32,
    #[serde(rename = "failed_invocations")]
    pub failed_invocations: u32,
    #[serde(rename = "cancelled_invocations")]
    pub cancelled_invocations: u32,
    #[serde(rename = "open_invocations")]
    pub open_invocations: u32,
    /// Exact distinct non-null user identities over this row's window.
    #[serde(rename = "active_users")]
    pub active_users: u32,
    #[serde(rename = "unattributed_invocations")]
    pub unattributed_invocations: u32,
...
impl ActivityMetrics {
    pub fn new(
        ...
        incomplete_invocations: u32,
        failed_invocations: u32,
        cancelled_invocations: u32,
        open_invocations: u32,
        active_users: u32,
        unattributed_invocations: u32,
        active_tenants: u32,
        active_agents: u32,
    ) -> ActivityMetrics {
        ActivityMetrics {
