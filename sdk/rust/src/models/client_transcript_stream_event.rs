...
#[serde(untagged)]
pub enum ClientTranscriptStreamEvent {
    ClientTranscriptUpdate(Box<models::ClientTranscriptUpdate>),
...
impl Default for ClientTranscriptStreamEvent {
    fn default() -> Self {
        Self::ClientTranscriptUpdate(Default::default())
    }
}
///
