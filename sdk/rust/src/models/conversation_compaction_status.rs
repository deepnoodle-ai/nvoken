...
pub enum ConversationCompactionStatus {
...
impl std::fmt::Display for ConversationCompactionStatus {
...
impl Default for ConversationCompactionStatus {
    fn default() -> ConversationCompactionStatus {
        Self::Pending
    }
}
