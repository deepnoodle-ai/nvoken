...
pub struct ModelControlCapabilities {
    #[serde(rename = "sampling")]
    pub sampling: Box<models::ModelSamplingCapabilities>,
    #[serde(rename = "reasoning")]
    pub reasoning: Box<models::ModelReasoningCapabilities>,
    #[serde(rename = "tools")]
    pub tools: Box<models::ModelToolCapabilities>,
    #[serde(rename = "input")]
    pub input: Box<models::ModelInputCapabilities>,
}

impl ModelControlCapabilities {
    pub fn new(
        sampling: models::ModelSamplingCapabilities,
        reasoning: models::ModelReasoningCapabilities,
        tools: models::ModelToolCapabilities,
        input: models::ModelInputCapabilities,
