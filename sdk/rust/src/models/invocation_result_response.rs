...
#[serde(untagged)]
pub enum InvocationResultResponse {
    InvocationResult(Box<models::InvocationResult>),
    ClientInvocationResult(Box<models::ClientInvocationResult>),
}

impl Default for InvocationResultResponse {
    fn default() -> Self {
        Self::InvocationResult(Default::default())
    }
}
