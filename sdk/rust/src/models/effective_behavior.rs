...
/// EffectiveBehavior : Turn-owned normalized behavior after any permitted limit narrowing.
...
impl EffectiveBehavior {
    ...
    pub fn new(instructions: String, model: models::ModelInput) -> EffectiveBehavior {
        EffectiveBehavior {
            instructions,
            model: Box::new(model),
            sampling: None,
