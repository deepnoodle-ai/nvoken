...
pub struct CharLocationCitation {
    #[serde(rename = "type")]
    pub r#type: Type,
    #[serde(rename = "cited_text", skip_serializing_if = "Option::is_none")]
    pub cited_text: Option<String>,
    #[serde(rename = "document_index", skip_serializing_if = "Option::is_none")]
    pub document_index: Option<u32>,
    #[serde(rename = "document_title", skip_serializing_if = "Option::is_none")]
    pub document_title: Option<String>,
    #[serde(rename = "start_char_index", skip_serializing_if = "Option::is_none")]
    pub start_char_index: Option<u32>,
    #[serde(rename = "end_char_index", skip_serializing_if = "Option::is_none")]
    pub end_char_index: Option<u32>,
}

impl CharLocationCitation {
    /// A location inside one indexed input document.
    pub fn new(r#type: Type) -> CharLocationCitation {
