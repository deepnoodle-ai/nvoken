...
pub struct AllocateCreditsResult {
    #[serde(rename = "allocation")]
    pub allocation: Box<models::CreditAllocation>,
    #[serde(rename = "account")]
    pub account: Box<models::CreditAccount>,
}

impl AllocateCreditsResult {
    pub fn new(
        allocation: models::CreditAllocation,
