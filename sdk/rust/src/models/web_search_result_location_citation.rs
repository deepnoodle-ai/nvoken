...
pub struct WebSearchResultLocationCitation {
    ...
    #[serde(rename = "title")]
    pub title: String,
    #[serde(rename = "encrypted_index", skip_serializing_if = "Option::is_none")]
    pub encrypted_index: Option<String>,
    #[serde(rename = "cited_text", skip_serializing_if = "Option::is_none")]
    pub cited_text: Option<String>,
}

impl WebSearchResultLocationCitation {
    /// A provider search result cited by the generated text.
    pub fn new(r#type: Type, url: String, title: String) -> WebSearchResultLocationCitation {
...
impl Default for Type {
    fn default() -> Type {
        Self::TypeWebSearchResultLocation
    }
}
