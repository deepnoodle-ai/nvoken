...
pub struct CreateConsoleDeviceAuthorizationRequest {
    #[serde(rename = "label")]
    pub label: String,
}

impl CreateConsoleDeviceAuthorizationRequest {
    pub fn new(label: String) -> CreateConsoleDeviceAuthorizationRequest {
        CreateConsoleDeviceAuthorizationRequest { label }
    }
}
