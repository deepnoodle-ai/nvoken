...
pub enum StreamEvent {
    ...
    MessageDelta(Box<models::MessageDeltaEvent>),
    #[serde(rename = "stream.resync")]
    StreamResync(Box<models::StreamResyncEvent>),
    #[serde(rename = "connection.closing")]
    ConnectionClosing(Box<models::ConnectionClosingEvent>),
}
