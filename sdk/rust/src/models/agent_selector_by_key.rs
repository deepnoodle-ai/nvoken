...
/// AgentSelectorByKey : Tenant and user owner coordinates come from this Turn's request scope.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AgentSelectorByKey {
    #[serde(rename = "owner_kind")]
    pub owner_kind: models::AgentOwnerKind,
    /// Caller-owned key, unique only inside one explicit Agent owner namespace.
    #[serde(rename = "agent_key")]
    pub agent_key: String,
    #[serde(rename = "revision")]
    pub revision: Box<models::AgentRevisionSelector>,
}

impl AgentSelectorByKey {
    /// Tenant and user owner coordinates come from this Turn's request scope.
    pub fn new(
        owner_kind: models::AgentOwnerKind,
        agent_key: String,
        revision: models::AgentRevisionSelector,
    ) -> AgentSelectorByKey {
        AgentSelectorByKey {
            owner_kind,
            agent_key,
