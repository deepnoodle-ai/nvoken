...
pub struct ClientCurrentIdentity {
    #[serde(rename = "authentication")]
    pub authentication: Box<models::ClientCurrentIdentityAuthentication>,
}

impl ClientCurrentIdentity {
    pub fn new(
        authentication: models::ClientCurrentIdentityAuthentication,
