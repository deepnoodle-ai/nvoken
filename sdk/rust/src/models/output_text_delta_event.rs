...
/// OutputTextDeltaEvent : A live preview of assistant text. Not saved, never replayed, and never a message. Accumulate it by `(invocation_id, attempt, iteration, content_index)` and discard it under the rules in Streaming above.
