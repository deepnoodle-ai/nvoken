...
pub struct DefaultMemoryNone {
    #[serde(rename = "default_scope")]
    pub default_scope: DefaultScope,
}

impl DefaultMemoryNone {
    pub fn new(default_scope: DefaultScope) -> DefaultMemoryNone {
        DefaultMemoryNone { default_scope }
    }
}
///
