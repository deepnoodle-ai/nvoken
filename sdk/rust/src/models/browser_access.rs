...
/// BrowserAccess : Complete browser-direct configuration. Enabling it requires App default_rate_limits and an active webhook-purpose signing key.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BrowserAccess {
    /// Canonical exact origins, returned sorted. Wildcards, userinfo, paths, queries, and fragments are invalid. HTTPS is required, except that exact localhost and loopback origins may use HTTP for development. Browser requests must match exactly before CORS is emitted.
    #[serde(rename = "allowed_origins")]
    pub allowed_origins: Vec<String>,
    #[serde(rename = "invocation_webhook")]
    pub invocation_webhook: Box<models::BrowserInvocationWebhook>,
    #[serde(rename = "limits")]
    pub limits: Box<models::BrowserRateLimits>,
}
...
impl BrowserAccess {
    ...
    pub fn new(
        ...
        invocation_webhook: models::BrowserInvocationWebhook,
        limits: models::BrowserRateLimits,
    ) -> BrowserAccess {
        BrowserAccess {
            allowed_origins,
            invocation_webhook: Box::new(invocation_webhook),
