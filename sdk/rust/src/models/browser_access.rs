...
/// BrowserAccess : Complete dormant browser-direct configuration. Enabling it requires App default_rate_limits and an active webhook-purpose signing key.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BrowserAccess {
    /// Canonical exact origins, returned sorted. Wildcards, userinfo, paths, queries, and fragments are invalid. HTTPS is required, except that exact localhost and loopback origins may use HTTP for development. CORS is not emitted until PRD 065.
