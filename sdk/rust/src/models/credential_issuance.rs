...
pub struct CredentialIssuance {
    ...
    pub credential: Box<models::Credential>,
    #[serde(rename = "secret")]
    pub secret: String,
    #[serde(rename = "delivery_expires_at")]
    pub delivery_expires_at: chrono::DateTime<chrono::FixedOffset>,
...
impl CredentialIssuance {
    pub fn new(
        ...
        secret: String,
        delivery_expires_at: chrono::DateTime<chrono::FixedOffset>,
        replayed: bool,
    ) -> CredentialIssuance {
        CredentialIssuance {
