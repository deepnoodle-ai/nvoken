...
#[serde(untagged)]
pub enum InvocationListResponse {
    InvocationList(Box<models::InvocationList>),
    ClientInvocationList(Box<models::ClientInvocationList>),
}

impl Default for InvocationListResponse {
    fn default() -> Self {
        Self::InvocationList(Default::default())
    }
}
