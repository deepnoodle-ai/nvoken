...
pub struct ConsoleDeviceAuthorizationExchangeState {
    #[serde(rename = "status")]
    pub status: Status,
}

impl ConsoleDeviceAuthorizationExchangeState {
    pub fn new(status: Status) -> ConsoleDeviceAuthorizationExchangeState {
        ConsoleDeviceAuthorizationExchangeState { status }
    }
}
///
