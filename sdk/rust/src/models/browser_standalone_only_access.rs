...
pub struct BrowserStandaloneOnlyAccess {
    #[serde(rename = "scope")]
    pub scope: Scope,
}

impl BrowserStandaloneOnlyAccess {
    pub fn new(scope: Scope) -> BrowserStandaloneOnlyAccess {
        BrowserStandaloneOnlyAccess { scope }
    }
}
///
