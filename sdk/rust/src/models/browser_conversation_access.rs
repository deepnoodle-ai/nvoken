...
pub enum BrowserConversationAccess {
    ...
    #[serde(rename = "exact")]
    Exact(Box<models::BrowserExactConversationAccess>),
    #[serde(rename = "user_conversations")]
    UserConversations(Box<models::BrowserUserConversationsAccess>),
}

impl Default for BrowserConversationAccess {
    fn default() -> Self {
        Self::StandaloneOnly(Default::default())
    }
}
