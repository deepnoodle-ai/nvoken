...
#[serde(untagged)]
pub enum TurnConversation {
    #[serde(rename = "new")]
    New(Box<models::NewTurnConversation>),
    #[serde(rename = "continue")]
    Continue(Box<models::ContinueTurnConversation>),
    #[serde(rename = "continue_or_create")]
    ContinueOrCreate(Box<models::ContinueOrCreateTurnConversation>),
}

impl Default for TurnConversation {
    fn default() -> Self {
