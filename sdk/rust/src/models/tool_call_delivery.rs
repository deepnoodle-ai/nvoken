...
pub struct ToolCallDelivery {
    #[serde(rename = "outcome")]
    pub outcome: models::CallbackDeliveryOutcome,
    /// Number of leased HTTP delivery attempts.
    #[serde(rename = "attempts")]
    pub attempts: u64,
    /// Last HTTP status returned by the endpoint, or null before any response.
    #[serde(rename = "last_http_status", deserialize_with = "Option::deserialize")]
    pub last_http_status: Option<u32>,
}

impl ToolCallDelivery {
    pub fn new(
        outcome: models::CallbackDeliveryOutcome,
        attempts: u64,
        last_http_status: Option<u32>,
    ) -> ToolCallDelivery {
        ToolCallDelivery {
            outcome,
            attempts,
