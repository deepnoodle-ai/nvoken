...
pub struct BrowserInvocationWebhook {
    /// Guarded absolute HTTPS Invocation webhook endpoint.
    #[serde(rename = "url")]
    pub url: String,
    /// Must include invocation.waiting and invocation.ended. Omission selects every current Invocation webhook event.
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<models::WebhookEvent>>,
}

impl BrowserInvocationWebhook {
    pub fn new(url: String) -> BrowserInvocationWebhook {
        BrowserInvocationWebhook { url, events: None }
    }
}
