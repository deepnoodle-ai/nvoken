...
pub struct TenantMemorySpaceSelector {
    #[serde(rename = "scope")]
    pub scope: Scope,
...
impl TenantMemorySpaceSelector {
    pub fn new(scope: Scope, namespace: String) -> TenantMemorySpaceSelector {
        TenantMemorySpaceSelector { scope, namespace }
    }
}
///
