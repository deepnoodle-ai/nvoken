...
pub struct BrowserUserMemoryAccess {
    #[serde(rename = "scope")]
    pub scope: Scope,
...
impl BrowserUserMemoryAccess {
    pub fn new(scope: Scope, namespace: String) -> BrowserUserMemoryAccess {
        BrowserUserMemoryAccess { scope, namespace }
    }
}
///
