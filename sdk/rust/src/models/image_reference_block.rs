...
/// ImageReferenceBlock : A stored input image, described rather than sent back. You get its media type, size, and checksum, but not the bytes.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ImageReferenceBlock {
    #[serde(rename = "type")]
    pub r#type: Type,
