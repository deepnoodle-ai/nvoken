...
pub struct ForkSessionRequest {
    ...
    pub from_message: Box<models::ForkSessionRequestFromMessage>,
    ...
    pub session_options: Option<Box<models::ForkSessionOptions>>,
}

impl ForkSessionRequest {
    pub fn new(from_message: models::ForkSessionRequestFromMessage) -> ForkSessionRequest {
        ForkSessionRequest {
            from_message: Box::new(from_message),
            session_key: None,
            user_key: None,
