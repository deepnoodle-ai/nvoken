...
pub struct AdmissionTenantCount {
    #[serde(rename = "tenant_key")]
    pub tenant_key: String,
    #[serde(rename = "refusals")]
    pub refusals: i64,
    #[serde(rename = "last_refused_at")]
    pub last_refused_at: chrono::DateTime<chrono::FixedOffset>,
}

impl AdmissionTenantCount {
    pub fn new(
        tenant_key: String,
        refusals: i64,
        last_refused_at: chrono::DateTime<chrono::FixedOffset>,
