...
pub struct App {
    ...
    /// Dormant App-wide admission ceilings shared by machine and future client-token callers. Null means unlimited machine admission. These values are recorded but not enforced until PRD 065.
    #[serde(
