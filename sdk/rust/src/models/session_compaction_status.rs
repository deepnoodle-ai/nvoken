...
/// SessionCompactionStatus : `applied` means the summary became the Session's private context projection. `fell_through` means the turn continued with the prior projection after a failed or invalid summary pass.
/// `applied` means the summary became the Session's private context projection. `fell_through` means the turn continued with the prior projection after a failed or invalid summary pass.
