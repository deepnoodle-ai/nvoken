...
pub struct UsageMetrics {
    ...
    pub activity: Box<models::ActivityMetrics>,
    #[serde(rename = "model")]
    pub model: Box<models::ModelMetrics>,
    #[serde(rename = "tools")]
    pub tools: Box<models::ToolMetrics>,
    #[serde(rename = "cost")]
    pub cost: Box<models::CostMetrics>,
}

impl UsageMetrics {
    pub fn new(
        activity: models::ActivityMetrics,
        model: models::ModelMetrics,
        tools: models::ToolMetrics,
