...
pub struct ServerToolUseBlock {
    #[serde(rename = "type")]
    pub r#type: Type,
    /// The provider's own ID for a tool it ran itself, such as web search. This is not a ToolCall ID: you never send a result for it, and it never appears in your pending tool calls. It is here so you can show the user what the model looked up.
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "name")]
    pub name: String,
