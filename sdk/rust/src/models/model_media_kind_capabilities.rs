...
pub struct ModelMediaKindCapabilities {
    #[serde(rename = "supported")]
    pub supported: bool,
    /// The exact media types this model accepts. An empty list means it does not accept this kind of input at all.
    #[serde(rename = "media_types")]
    pub media_types: Vec<String>,
}

impl ModelMediaKindCapabilities {
    pub fn new(supported: bool, media_types: Vec<String>) -> ModelMediaKindCapabilities {
