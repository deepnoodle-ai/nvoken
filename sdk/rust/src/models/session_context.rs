...
pub struct SessionContext {
    /// Estimated tokens in the retained generation context: the latest applied summary plus the generation-eligible messages after its watermark. This is the same estimate the compaction trigger uses.
