...
pub struct SubmitClientToolResultsRequest {
    #[serde(rename = "results")]
    pub results: Vec<models::SubmitClientToolResultsRequestResultsInner>,
}

impl SubmitClientToolResultsRequest {
    pub fn new(
        results: Vec<models::SubmitClientToolResultsRequestResultsInner>,
    ) -> SubmitClientToolResultsRequest {
        SubmitClientToolResultsRequest { results }
    }
}
