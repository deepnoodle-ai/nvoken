...
pub struct ClientInvocationFailure {
    #[serde(rename = "code")]
    pub code: String,
...
impl ClientInvocationFailure {
    pub fn new(code: String, message: String) -> ClientInvocationFailure {
        ClientInvocationFailure { code, message }
    }
}
