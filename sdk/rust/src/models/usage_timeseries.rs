...
pub struct UsageTimeseries {
    ...
    pub interval: models::UsageInterval,
    #[serde(rename = "timezone")]
    pub timezone: String,
    #[serde(rename = "group_by", skip_serializing_if = "Option::is_none")]
    pub group_by: Option<GroupBy>,
    #[serde(rename = "totals")]
    pub totals: Box<models::UsageMetrics>,
    #[serde(rename = "buckets")]
    pub buckets: Vec<models::UsageTimeseriesBucket>,
}
...
impl UsageTimeseries {
    pub fn new(
        ...
        timezone: String,
        totals: models::UsageMetrics,
        buckets: Vec<models::UsageTimeseriesBucket>,
    ) -> UsageTimeseries {
        UsageTimeseries {
            start_at,
            end_at,
