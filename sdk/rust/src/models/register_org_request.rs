...
pub struct RegisterOrgRequest {
    ...
    /// Optional unique identity-provider Org identifier. Reusing it returns the existing Org unchanged.
    #[serde(rename = "external_ref", skip_serializing_if = "Option::is_none")]
    pub external_ref: Option<String>,
}

impl RegisterOrgRequest {
    pub fn new(display_name: String) -> RegisterOrgRequest {
        RegisterOrgRequest {
            display_name,
            external_ref: None,
        }
