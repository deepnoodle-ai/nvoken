...
pub struct CurrentIdentityAuthentication {
    ...
    /// Machine credentials only.
    #[serde(rename = "effective_profile", skip_serializing_if = "Option::is_none")]
    pub effective_profile: Option<models::CredentialProfile>,
    ...
    pub agent_definition_revision: Option<u32>,
