...
pub struct Reasoning {
    ...
    /// Provider reasoning target, not a separate Invocation hard budget. Requires an explicit, larger limits.max_output_tokens and exact support in the selected model descriptor.
