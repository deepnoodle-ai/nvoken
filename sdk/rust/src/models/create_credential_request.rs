...
pub struct CreateCredentialRequest {
    ...
    /// Target App for an app-less Operator provisioning an app credential. Omit to issue another app-less credential. An app-bound Operator may omit this field or repeat its own App ID, but cannot name a different App.
