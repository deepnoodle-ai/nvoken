...
pub struct CreateCredentialRequest {
    ...
    pub profile: models::CredentialProfile,
    /// Target App for an Org or installation Operator provisioning an App credential. Org callers may name only Apps contained by their Org. App callers may omit this field or repeat their own App ID.
    #[serde(rename = "app_id", skip_serializing_if = "Option::is_none")]
    pub app_id: Option<String>,
    /// Target Org for an installation Operator provisioning an Org credential. Installation issuer tokens require `admin: true`. Mutually exclusive with `app_id`. Org and App callers cannot mint Org credentials.
...
impl CreateCredentialRequest {
    pub fn new(name: String, profile: models::CredentialProfile) -> CreateCredentialRequest {
