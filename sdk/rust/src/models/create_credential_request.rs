...
pub struct CreateCredentialRequest {
    ...
    /// Required for App and App-read-only credentials. Console Org callers may name only Apps contained by their Org. Installation admins may name any App. Full App keys cannot create a new key family.
...
impl CreateCredentialRequest {
    pub fn new(name: String, r#type: models::CredentialType) -> CreateCredentialRequest {
