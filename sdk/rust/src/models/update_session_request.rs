...
pub struct UpdateSessionRequest {
    ...
    /// Replaces the Session lifetime cost cap; null removes it. A finite cap may not be lower than estimated cost already consumed. Raising or removing it atomically requeues a turn paused on it.
    #[serde(
    ...
    pub max_estimated_cost_usd: Option<Option<f64>>,
}
