...
#[serde(untagged)]
pub enum ClientInvocationStreamEvent {
    ClientInvocationAcceptedEvent(Box<models::ClientInvocationAcceptedEvent>),
    OutputTextDeltaEvent(Box<models::OutputTextDeltaEvent>),
    ClientInvocationUpdateEvent(Box<models::ClientInvocationUpdateEvent>),
    ClientInvocationResultEvent(Box<models::ClientInvocationResultEvent>),
    StreamResyncEvent(Box<models::StreamResyncEvent>),
    StreamEndEvent(Box<models::StreamEndEvent>),
}

impl Default for ClientInvocationStreamEvent {
    fn default() -> Self {
        Self::ClientInvocationAcceptedEvent(Default::default())
    }
}
///
