...
pub struct CreditAllocationList {
    #[serde(rename = "items")]
    pub items: Vec<models::CreditAllocation>,
    #[serde(rename = "next_cursor", deserialize_with = "Option::deserialize")]
    pub next_cursor: Option<String>,
}

impl CreditAllocationList {
    pub fn new(
        items: Vec<models::CreditAllocation>,
        next_cursor: Option<String>,
    ) -> CreditAllocationList {
        CreditAllocationList { items, next_cursor }
    }
}
