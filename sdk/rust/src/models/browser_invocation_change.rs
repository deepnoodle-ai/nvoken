...
/// BrowserInvocationChange : One lifecycle step of one turn, in the browser projection. It carries the same lifecycle detail as the browser Invocation projection, and nothing the browser projection withholds.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BrowserInvocationChange {
    ...
    pub error: Option<Box<models::BrowserInvocationFailure>>,
...
impl BrowserInvocationChange {
    ...
    pub fn new(
        ...
        error: Option<models::BrowserInvocationFailure>,
