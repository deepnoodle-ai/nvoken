...
pub struct BrowserInvocationResultEvent {
    #[serde(rename = "type")]
    pub r#type: Type,
    ...
    #[serde(rename = "result")]
    pub result: Box<models::BrowserInvocationResult>,
}

impl BrowserInvocationResultEvent {
    pub fn new(
        r#type: Type,
        session_id: String,
        invocation_id: String,
        result: models::BrowserInvocationResult,
