...
/// CompactionPolicy : Durable Conversation context-compaction policy. Omission of model uses the installing Turn's primary model. An explicit model must be cataloged and use the same provider. Later Turns automatically use this resolved policy and the latest Conversation summary.
...
impl CompactionPolicy {
    /// Durable Conversation context-compaction policy. Omission of model uses the installing Turn's primary model. An explicit model must be cataloged and use the same provider. Later Turns automatically use this resolved policy and the latest Conversation summary.
