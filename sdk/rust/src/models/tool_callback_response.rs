...
/// ToolCallbackResponse : Strict callback reply. The encoded content is limited to 256 KiB and 32 nesting levels. `is_error` defaults to false when omitted.
...
impl ToolCallbackResponse {
    ...
    pub fn new(content: Option<serde_json::Value>) -> ToolCallbackResponse {
