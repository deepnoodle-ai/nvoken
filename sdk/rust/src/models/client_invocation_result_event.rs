...
pub struct ClientInvocationResultEvent {
    #[serde(rename = "type")]
    pub r#type: Type,
    ...
    #[serde(rename = "result")]
    pub result: Box<models::ClientInvocationResult>,
}

impl ClientInvocationResultEvent {
    pub fn new(
        r#type: Type,
        session_id: String,
        invocation_id: String,
        result: models::ClientInvocationResult,
