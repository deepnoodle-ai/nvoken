...
/// MemoryConfig : Opts this Agent Definition into durable memory and automatically attaches nvoken_memory_remember, nvoken_memory_recall, and nvoken_memory_forget. Omission attaches no memory capability.
...
pub struct MemoryConfig {
    ...
    pub context: Option<Box<models::MemoryContextConfig>>,
}
