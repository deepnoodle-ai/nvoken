...
/// CallbackDeliveryOutcome : `pending` means nvoken has not reached a final transport outcome. The other values are terminal transport outcomes.
/// `pending` means nvoken has not reached a final transport outcome. The other values are terminal transport outcomes.
