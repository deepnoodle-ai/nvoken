...
/// CallbackDeliveryOutcome : `pending` covers a blocked, available, or currently leased delivery. The other values are terminal transport outcomes.
/// `pending` covers a blocked, available, or currently leased delivery. The other values are terminal transport outcomes.
