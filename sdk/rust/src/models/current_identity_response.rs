...
#[serde(untagged)]
pub enum CurrentIdentityResponse {
    CurrentIdentity(Box<models::CurrentIdentity>),
    ClientCurrentIdentity(Box<models::ClientCurrentIdentity>),
}

impl Default for CurrentIdentityResponse {
    fn default() -> Self {
        Self::CurrentIdentity(Default::default())
    }
}
