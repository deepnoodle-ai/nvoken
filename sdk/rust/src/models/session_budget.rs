...
/// SessionBudget : Mutable Session-wide USD list-price guardrail. The estimate is derived from durable model-call evidence and is operational control, not a billing ledger. Models without catalog pricing fail closed.
...
impl SessionBudget {
    /// Mutable Session-wide USD list-price guardrail. The estimate is derived from durable model-call evidence and is operational control, not a billing ledger. Models without catalog pricing fail closed.
