...
#[serde(untagged)]
pub enum TurnMemorySelection {
    #[serde(rename = "none")]
    None(Box<models::NoTurnMemory>),
    #[serde(rename = "user")]
    User(Box<models::UserTurnMemory>),
    #[serde(rename = "tenant")]
    Tenant(Box<models::TenantTurnMemory>),
}

impl Default for TurnMemorySelection {
    fn default() -> Self {
