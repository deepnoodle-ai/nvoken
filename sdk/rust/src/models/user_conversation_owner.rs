...
pub struct UserConversationOwner {
    #[serde(rename = "kind")]
    pub kind: Kind,
...
impl UserConversationOwner {
    pub fn new(kind: Kind, user_key: String) -> UserConversationOwner {
        UserConversationOwner { kind, user_key }
    }
}
///
