...
/// CredentialProfile : Fixed authorization profile. Runtime is meaningful for App-bound execution and cannot be selected for an Org credential.
/// Fixed authorization profile. Runtime is meaningful for App-bound execution and cannot be selected for an Org credential.
...
impl std::fmt::Display for CredentialProfile {
