...
impl Definition {
    ...
    pub fn new(model: models::Model) -> Definition {
        Definition {
            instructions: None,
            model: Box::new(model),
            sampling: None,
