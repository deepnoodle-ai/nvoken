...
pub struct BrowserTurnWebhook {
    /// Guarded absolute HTTPS Turn webhook endpoint.
    #[serde(rename = "url")]
    pub url: String,
    /// Must include turn.waiting and turn.ended. Omission selects every current Turn webhook event.
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<models::WebhookEvent>>,
}

impl BrowserTurnWebhook {
    pub fn new(url: String) -> BrowserTurnWebhook {
        BrowserTurnWebhook { url, events: None }
    }
}
