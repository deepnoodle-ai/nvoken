...
pub struct TurnResult {
    #[serde(rename = "turn")]
    pub turn: Box<models::Turn>,
    /// Every canonical ConversationMessage owned by this Turn, all roles, ascending sequence, composed at read time from the canonical transcript. Nothing is stored twice.
