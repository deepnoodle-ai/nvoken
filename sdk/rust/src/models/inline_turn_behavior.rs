...
pub struct InlineTurnBehavior {
    #[serde(rename = "kind")]
    pub kind: Kind,
    #[serde(rename = "behavior")]
    pub behavior: Box<models::BehaviorInput>,
}

impl InlineTurnBehavior {
    pub fn new(kind: Kind, behavior: models::BehaviorInput) -> InlineTurnBehavior {
        InlineTurnBehavior {
            kind,
