...
pub struct DocumentInputSource {
    ...
    /// Public HTTPS URL fetched once during admission. The response is size-bounded while reading and its bytes are sniffed. media_type is optional for this form. When present it must be application/pdf.
