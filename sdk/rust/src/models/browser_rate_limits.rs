...
/// BrowserRateLimits : Browser-specific ceilings enforced at Turn admission.
...
pub struct BrowserRateLimits {
    ...
    #[serde(rename = "max_admissions_per_user_per_minute")]
    pub max_admissions_per_user_per_minute: u64,
}

impl BrowserRateLimits {
    /// Browser-specific ceilings enforced at Turn admission.
    pub fn new(
        max_concurrent_turns_per_tenant: u64,
        max_concurrent_turns_per_user: u64,
        max_admissions_per_user_per_minute: u64,
    ) -> BrowserRateLimits {
        BrowserRateLimits {
            max_concurrent_turns_per_tenant,
            max_concurrent_turns_per_user,
            max_admissions_per_user_per_minute,
        }
    }
}
