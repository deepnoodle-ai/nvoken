...
pub struct MemoryList {
    #[serde(rename = "items")]
    pub items: Vec<models::MemorySearchResult>,
    #[serde(rename = "search_coverage")]
    pub search_coverage: Box<models::MemorySearchCoverage>,
...
impl MemoryList {
    pub fn new(
        items: Vec<models::MemorySearchResult>,
        search_coverage: models::MemorySearchCoverage,
        has_more: bool,
        next_cursor: Option<String>,
    ) -> MemoryList {
        MemoryList {
            items,
            search_coverage: Box::new(search_coverage),
            has_more,
            next_cursor,
        }
    }
