...
#[serde(tag = "kind")]
pub enum DeliveryBehaviorSource {
    #[serde(rename = "agent_revision")]
    AgentRevision(Box<models::DeliveryAgentRevisionSource>),
    #[serde(rename = "inline")]
    Inline(Box<models::DeliveryInlineSource>),
}

impl Default for DeliveryBehaviorSource {
    fn default() -> Self {
        Self::AgentRevision(Default::default())
    }
}
