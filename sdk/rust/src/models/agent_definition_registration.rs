...
pub struct AgentDefinitionRegistration {
    ...
    pub agent_definition: Box<models::AgentDefinition>,
}

impl AgentDefinitionRegistration {
    pub fn new(
        agent_definition_id: String,
        agent_definition: models::AgentDefinition,
    ) -> AgentDefinitionRegistration {
        AgentDefinitionRegistration {
            agent_definition_id,
            agent_definition: Box::new(agent_definition),
        }
    }
}
