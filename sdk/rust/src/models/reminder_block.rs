...
/// ReminderBlock : One application-owned state snapshot recorded at Turn admission. Contextual reminders use the user role; operator reminders use the system role. The typed tier remains authoritative for provider mapping.
