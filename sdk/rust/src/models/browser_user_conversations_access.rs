...
pub struct BrowserUserConversationsAccess {
    #[serde(rename = "scope")]
    pub scope: Scope,
}

impl BrowserUserConversationsAccess {
    pub fn new(scope: Scope) -> BrowserUserConversationsAccess {
        BrowserUserConversationsAccess { scope }
    }
}
///
