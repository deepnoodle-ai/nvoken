...
pub struct McpListToolsResponse {
    #[serde(rename = "tools")]
    pub tools: Vec<models::McpProjectedTool>,
    #[serde(rename = "exclusions")]
    pub exclusions: Vec<models::McpToolExclusion>,
}

impl McpListToolsResponse {
    pub fn new(
        tools: Vec<models::McpProjectedTool>,
        exclusions: Vec<models::McpToolExclusion>,
    ) -> McpListToolsResponse {
        McpListToolsResponse { tools, exclusions }
    }
}
