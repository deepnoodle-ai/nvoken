...
pub struct ModelReasoningCapabilities {
    #[serde(rename = "effort")]
    pub effort: Box<models::ModelReasoningEffortCapabilities>,
    #[serde(rename = "budget_tokens")]
    pub budget_tokens: Box<models::ModelReasoningBudgetCapabilities>,
    #[serde(rename = "effort_budget_compatible")]
    pub effort_budget_compatible: bool,
}

impl ModelReasoningCapabilities {
    pub fn new(
        effort: models::ModelReasoningEffortCapabilities,
        budget_tokens: models::ModelReasoningBudgetCapabilities,
        effort_budget_compatible: bool,
    ) -> ModelReasoningCapabilities {
        ModelReasoningCapabilities {
            effort: Box::new(effort),
            budget_tokens: Box::new(budget_tokens),
