...
pub struct ApproveConsoleDeviceAuthorizationRequest {
    #[serde(rename = "credential_type")]
    pub credential_type: CredentialType,
}

impl ApproveConsoleDeviceAuthorizationRequest {
    pub fn new(credential_type: CredentialType) -> ApproveConsoleDeviceAuthorizationRequest {
        ApproveConsoleDeviceAuthorizationRequest { credential_type }
    }
}
///
