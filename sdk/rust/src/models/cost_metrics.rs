...
pub struct CostMetrics {
    ...
    pub model_cost: Box<models::Money>,
    #[serde(rename = "cost_coverage")]
    pub cost_coverage: CostCoverage,
    #[serde(rename = "priced_model_calls")]
    pub priced_model_calls: u32,
    #[serde(rename = "unpriced_model_calls")]
    pub unpriced_model_calls: u32,
    #[serde(rename = "uncertain_model_calls")]
    pub uncertain_model_calls: u32,
    #[serde(rename = "unbounded_uncertain_model_calls")]
    pub unbounded_uncertain_model_calls: u32,
    #[serde(rename = "max_cost_at_risk")]
    pub max_cost_at_risk: Box<models::Money>,
}

impl CostMetrics {
    pub fn new(
        model_cost: models::Money,
        cost_coverage: CostCoverage,
        priced_model_calls: u32,
        unpriced_model_calls: u32,
        uncertain_model_calls: u32,
        unbounded_uncertain_model_calls: u32,
        max_cost_at_risk: models::Money,
    ) -> CostMetrics {
        CostMetrics {
            model_cost: Box::new(model_cost),
            cost_coverage,
            priced_model_calls,
            unpriced_model_calls,
            uncertain_model_calls,
            unbounded_uncertain_model_calls,
            max_cost_at_risk: Box::new(max_cost_at_risk),
        }
    }
}
///
