...
/// SeedMessageContent : Text-only canonical history. A string is shorthand for one text block; both forms normalize to the same stored content-block array.
...
#[serde(untagged)]
pub enum SeedMessageContent {
    String(String),
    ArrayVecTextInputBlock(Vec<models::TextInputBlock>),
}

impl Default for SeedMessageContent {
    fn default() -> Self {
