...
pub struct ModelMediaCapabilities {
    #[serde(rename = "image")]
    pub image: Box<models::ModelMediaKindCapabilities>,
    #[serde(rename = "document")]
    pub document: Box<models::ModelMediaKindCapabilities>,
}

impl ModelMediaCapabilities {
    pub fn new(
        image: models::ModelMediaKindCapabilities,
        document: models::ModelMediaKindCapabilities,
