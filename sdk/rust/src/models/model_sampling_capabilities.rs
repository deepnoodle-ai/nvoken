...
pub struct ModelSamplingCapabilities {
    /// Whether nvoken can guarantee an explicit temperature reaches this exact model path.
    #[serde(rename = "temperature")]
    pub temperature: bool,
}

impl ModelSamplingCapabilities {
    pub fn new(temperature: bool) -> ModelSamplingCapabilities {
        ModelSamplingCapabilities { temperature }
    }
}
