...
pub struct ClientTranscriptSnapshot {
    #[serde(rename = "messages")]
    pub messages: Vec<models::ClientSessionMessage>,
    #[serde(rename = "invocation_changes")]
    pub invocation_changes: Vec<models::ClientInvocationChange>,
...
impl ClientTranscriptSnapshot {
    pub fn new(
        messages: Vec<models::ClientSessionMessage>,
        invocation_changes: Vec<models::ClientInvocationChange>,
        has_more: bool,
