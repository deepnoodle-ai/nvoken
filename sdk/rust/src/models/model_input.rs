...
/// ModelInput : Model selection accepted at Invocation admission. The object is canonical. The `provider/id` string is caller convenience: nvoken splits on the first slash and always echoes the object form.
