...
/// ModelInput : Which model to use. The object form — separate `provider` and `id` — is the real shape. You may also send a single `provider/id` string for convenience; nvoken splits it at the first slash and always returns the object form.
