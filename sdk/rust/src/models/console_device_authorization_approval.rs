...
pub struct ConsoleDeviceAuthorizationApproval {
    #[serde(rename = "status")]
    pub status: models::ConsoleDeviceAuthorizationStatus,
    #[serde(rename = "label")]
    pub label: String,
...
impl ConsoleDeviceAuthorizationApproval {
    pub fn new(
        status: models::ConsoleDeviceAuthorizationStatus,
        label: String,
