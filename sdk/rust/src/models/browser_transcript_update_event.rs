...
pub struct BrowserTranscriptUpdateEvent {
    #[serde(rename = "type")]
    pub r#type: Type,
    ...
    pub messages: Vec<models::BrowserSessionMessage>,
    #[serde(rename = "invocation_changes")]
    pub invocation_changes: Vec<models::BrowserInvocationChange>,
    #[serde(rename = "resume_cursor")]
    pub resume_cursor: String,
}

impl BrowserTranscriptUpdateEvent {
    pub fn new(
        r#type: Type,
        session_id: String,
        messages: Vec<models::BrowserSessionMessage>,
        invocation_changes: Vec<models::BrowserInvocationChange>,
