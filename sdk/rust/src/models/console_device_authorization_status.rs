...
pub enum ConsoleDeviceAuthorizationStatus {
...
impl std::fmt::Display for ConsoleDeviceAuthorizationStatus {
...
impl Default for ConsoleDeviceAuthorizationStatus {
    fn default() -> ConsoleDeviceAuthorizationStatus {
        Self::Pending
    }
}
