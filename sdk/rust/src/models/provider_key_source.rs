...
impl std::fmt::Display for ProviderKeySource {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::CallerEphemeral => write!(f, "caller_ephemeral"),
            Self::AppByok => write!(f, "app_byok"),
            Self::TenantByok => write!(f, "tenant_byok"),
            Self::Platform => write!(f, "platform"),
            Self::ConfigByok => write!(f, "config_byok"),
        }
    }
}
