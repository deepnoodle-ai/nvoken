...
#[serde(untagged)]
pub enum TranscriptStreamResponse {
    TranscriptStreamEvent(Box<models::TranscriptStreamEvent>),
    ClientTranscriptStreamEvent(Box<models::ClientTranscriptStreamEvent>),
}

impl Default for TranscriptStreamResponse {
    fn default() -> Self {
        Self::TranscriptStreamEvent(Default::default())
    }
}
///
