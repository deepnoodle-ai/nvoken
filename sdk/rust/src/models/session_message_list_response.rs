...
#[serde(untagged)]
pub enum SessionMessageListResponse {
    SessionMessageList(Box<models::SessionMessageList>),
    ClientSessionMessageList(Box<models::ClientSessionMessageList>),
}

impl Default for SessionMessageListResponse {
    fn default() -> Self {
        Self::SessionMessageList(Default::default())
    }
}
