...
pub struct BrowserInvocationUpdateEvent {
    #[serde(rename = "type")]
    pub r#type: Type,
    ...
    pub invocation: Box<models::BrowserInvocation>,
    #[serde(rename = "new_messages")]
    pub new_messages: Vec<models::BrowserSessionMessage>,
}

impl BrowserInvocationUpdateEvent {
    pub fn new(
        r#type: Type,
        session_id: String,
        invocation_id: String,
        invocation: models::BrowserInvocation,
        new_messages: Vec<models::BrowserSessionMessage>,
