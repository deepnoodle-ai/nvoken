...
pub struct Sampling {
    /// Portable sampling temperature. Omit sampling to preserve the provider default. An explicit zero remains explicit. Admission fails closed unless the selected model descriptor positively declares support.
