...
pub enum Citation {
    ...
    CharLocation(Box<models::CharLocationCitation>),
    #[serde(rename = "web_search_result_location")]
    WebSearchResultLocation(Box<models::WebSearchResultLocationCitation>),
    #[serde(rename = "url_citation")]
    UrlCitation(Box<models::UrlCitation>),
}

impl Default for Citation {
    fn default() -> Self {
        Self::CharLocation(Default::default())
    }
}
