...
pub struct McpServerHeaders {
    ...
    #[serde(rename = "name")]
    pub name: String,
    /// Secret request headers, limited to 8 KiB encoded. Routing, framing, proxy, cookie, hop-by-hop, and MCP conversation headers are rejected. Headers are encrypted per Turn and never returned.
