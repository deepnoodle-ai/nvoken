...
/// AppDefaultRateLimits : The one App-wide admission contract shared by machine and future client-token callers. Both positive values are required. They are authoritative configuration but unenforced until PRD 065.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppDefaultRateLimits {
    #[serde(rename = "max_concurrent_invocations")]
    pub max_concurrent_invocations: u64,
    #[serde(rename = "max_admissions_per_minute")]
    pub max_admissions_per_minute: u64,
}

impl AppDefaultRateLimits {
    ...
    pub fn new(
        max_concurrent_invocations: u64,
