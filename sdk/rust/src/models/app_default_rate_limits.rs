...
/// AppDefaultRateLimits : The one App-wide admission contract shared by machine and browser callers. Both positive values are required and enforced at admission.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppDefaultRateLimits {
    #[serde(rename = "max_concurrent_turns")]
...
impl AppDefaultRateLimits {
    ...
    pub fn new(max_concurrent_turns: u64, max_admissions_per_minute: u64) -> AppDefaultRateLimits {
