...
pub struct ClientInvocationUpdateEvent {
    #[serde(rename = "type")]
    pub r#type: Type,
    ...
    pub invocation: Box<models::ClientInvocation>,
    #[serde(rename = "new_messages")]
    pub new_messages: Vec<models::ClientSessionMessage>,
}

impl ClientInvocationUpdateEvent {
    pub fn new(
        r#type: Type,
        session_id: String,
        invocation_id: String,
        invocation: models::ClientInvocation,
        new_messages: Vec<models::ClientSessionMessage>,
