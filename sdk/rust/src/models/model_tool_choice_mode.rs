...
impl std::fmt::Display for ModelToolChoiceMode {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::ChoiceAuto => write!(f, "auto"),
            Self::ChoiceNone => write!(f, "none"),
            Self::ChoiceRequired => write!(f, "required"),
            Self::ChoiceNamed => write!(f, "named"),
        }
    }
}

impl Default for ModelToolChoiceMode {
    fn default() -> ModelToolChoiceMode {
        Self::ChoiceAuto
    }
}
