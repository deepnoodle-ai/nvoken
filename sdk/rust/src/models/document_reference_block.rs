...
/// DocumentReferenceBlock : A stored input document, described rather than sent back. You get its media type, size, and checksum, but not the bytes.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DocumentReferenceBlock {
    #[serde(rename = "type")]
    pub r#type: Type,
