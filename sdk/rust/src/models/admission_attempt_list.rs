...
pub struct AdmissionAttemptList {
    #[serde(rename = "items")]
    pub items: Vec<models::AdmissionAttempt>,
    #[serde(rename = "next_cursor", deserialize_with = "Option::deserialize")]
    pub next_cursor: Option<String>,
}

impl AdmissionAttemptList {
    pub fn new(
        items: Vec<models::AdmissionAttempt>,
        next_cursor: Option<String>,
    ) -> AdmissionAttemptList {
        AdmissionAttemptList { items, next_cursor }
    }
}
