...
/// ToolChoice : Portable Turn tool selection. auto preserves normal selection; none disables tools for the Turn; required and named apply only to the first durable model iteration, then return to auto. name is required only for named mode. The final bounded iteration always disables tools.
...
impl ToolChoice {
    /// Portable Turn tool selection. auto preserves normal selection; none disables tools for the Turn; required and named apply only to the first durable model iteration, then return to auto. name is required only for named mode. The final bounded iteration always disables tools.
