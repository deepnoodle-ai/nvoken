...
/// ToolChoice : Portable Invocation tool selection. auto preserves normal selection; none disables tools for the Invocation; required and named apply only to the first durable model iteration, then return to auto. name is required only for named mode. The final bounded iteration always disables tools.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ToolChoice {
    #[serde(rename = "mode")]
    pub mode: models::ModelToolChoiceMode,
...
impl ToolChoice {
    ...
    pub fn new(mode: models::ModelToolChoiceMode) -> ToolChoice {
        ToolChoice { mode, name: None }
    }
}
