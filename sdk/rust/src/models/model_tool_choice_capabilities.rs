...
pub struct ModelToolChoiceCapabilities {
    #[serde(rename = "modes")]
    pub modes: Vec<models::ModelToolChoiceMode>,
    /// Modes that remain exact when explicit reasoning is active.
    #[serde(rename = "with_reasoning")]
    pub with_reasoning: Vec<models::ModelToolChoiceMode>,
}

impl ModelToolChoiceCapabilities {
    pub fn new(
        modes: Vec<models::ModelToolChoiceMode>,
        with_reasoning: Vec<models::ModelToolChoiceMode>,
