...
/// `rotate` means the server is cycling the connection — reconnect with your last `resume_cursor`. `terminal` means there is nothing more coming: the turn finished, or for a Session stream, nothing is running any more.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum Reason {
