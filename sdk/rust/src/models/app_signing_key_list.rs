...
pub struct AppSigningKeyList {
    #[serde(rename = "items")]
    pub items: Vec<models::AppSigningKey>,
}

impl AppSigningKeyList {
    pub fn new(items: Vec<models::AppSigningKey>) -> AppSigningKeyList {
        AppSigningKeyList { items }
    }
}
