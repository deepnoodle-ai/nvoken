...
/// RegisterAgentDefinitionRequest : One Agent Definition accepted by registration or nested under `agent_definition` during Invocation creation. The model string shorthand is accepted on write; the resolved Agent Definition returns object form.
...
impl RegisterAgentDefinitionRequest {
    ...
    pub fn new(model: models::ModelInput) -> RegisterAgentDefinitionRequest {
