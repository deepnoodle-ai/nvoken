...
class InvocationsApi:
    ...
    async def delete_invocation(
        ...
        _param = self._delete_invocation_serialize(
            invocation_id=invocation_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def delete_invocation_with_http_info(
        self,
        invocation_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def delete_invocation_without_preload_content(
        self,
        invocation_id: Annotated[str, Field(min_length=1, strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _delete_invocation_serialize(
        self,
        invocation_id,
        _request_auth,
        _content_type,
