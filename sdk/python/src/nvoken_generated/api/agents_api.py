...
class AgentsApi:
    ...
    async def list_agents(
        ...
        agent_definition_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None,
    ...
    def _list_agents_serialize(
        ...
        if agent_definition_id is not None:
            ...
            _query_params.append(('agent_definition_id', agent_definition_id))
