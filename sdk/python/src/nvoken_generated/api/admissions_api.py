...
class AdmissionsApi:
    ...
    async def list_admissions(
        ...
        :param outcome: Limit to admitted or refused attempts.
        ...
        :type user_key: str
        :param start_at: Inclusive RFC 3339 lower bound on `attempted_at`.
        :type start_at: datetime
        :param end_at: Exclusive RFC 3339 upper bound on `attempted_at`.
        ...
        _param = self._list_admissions_serialize(
            outcome=outcome,
    ...
    @validate_call
    async def list_admissions_with_http_info(
        self,
        outcome: Annotated[Optional[AdmissionOutcome], Field(description="Limit to admitted or refused attempts.")] = None,
        error_code: Annotated[Optional[Annotated[str, Field(strict=True, max_length=64)]], Field(description="Limit to one refusal code, for example `insufficient_credits`.")] = None,
        tenant_key: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]], Field(description="Exact non-default tenant partition reference.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AdmissionAttemptList]:
        """List attempts to start an Invocation, admitted and refused
    ...
    @validate_call
    async def list_admissions_without_preload_content(
        self,
        outcome: Annotated[Optional[AdmissionOutcome], Field(description="Limit to admitted or refused attempts.")] = None,
        error_code: Annotated[Optional[Annotated[str, Field(strict=True, max_length=64)]], Field(description="Limit to one refusal code, for example `insufficient_credits`.")] = None,
        tenant_key: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]], Field(description="Exact non-default tenant partition reference.")] = None,
    ...
    def _list_admissions_serialize(
        self,
        outcome,
        error_code,
        tenant_key,
        ...
        if error_code is not None:
            ...
            _query_params.append(('error_code', error_code))
    ...
    @validate_call
    async def summarize_admissions(
        self,
        start_at: Annotated[Optional[datetime], Field(description="Inclusive RFC 3339 lower bound. Defaults to 24 hours ago; the window is always bounded, since an unbounded count would change meaning silently as records age out. ")] = None,
        end_at: Annotated[Optional[datetime], Field(description="Exclusive RFC 3339 upper bound. Defaults to now.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param start_at: Inclusive RFC 3339 lower bound. Defaults to 24 hours ago; the window is always bounded, since an unbounded count would change meaning silently as records age out.
        :type start_at: datetime
        :param end_at: Exclusive RFC 3339 upper bound. Defaults to now.
        :type end_at: datetime
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._summarize_admissions_serialize(
            start_at=start_at,
            end_at=end_at,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def summarize_admissions_with_http_info(
        self,
        start_at: Annotated[Optional[datetime], Field(description="Inclusive RFC 3339 lower bound. Defaults to 24 hours ago; the window is always bounded, since an unbounded count would change meaning silently as records age out. ")] = None,
        end_at: Annotated[Optional[datetime], Field(description="Exclusive RFC 3339 upper bound. Defaults to now.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def summarize_admissions_without_preload_content(
        self,
        start_at: Annotated[Optional[datetime], Field(description="Inclusive RFC 3339 lower bound. Defaults to 24 hours ago; the window is always bounded, since an unbounded count would change meaning silently as records age out. ")] = None,
        end_at: Annotated[Optional[datetime], Field(description="Exclusive RFC 3339 upper bound. Defaults to now.")] = None,
        _request_timeout: Union[
    ...
    def _summarize_admissions_serialize(
        self,
        start_at,
        end_at,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/admissions/summary',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
