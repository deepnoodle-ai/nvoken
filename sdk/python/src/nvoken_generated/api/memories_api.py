...
class MemoriesApi:
    ...
    async def delete_memory(
        self,
        memory_id: Annotated[str, Field(min_length=1, strict=True)],
    ...
    def _delete_memory_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/memories/{memory_id}',
    ...
    async def list_memories(
        ...
        query: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = None,
        search_mode: Optional[MemorySearchMode] = None,
        ...
        :type query: str
        :param search_mode:
        :type search_mode: MemorySearchMode
        :param kind:
        :type kind: MemoryKind
    ...
    def _list_memories_serialize(
        ...
        if search_mode is not None:
            ...
            _query_params.append(('search_mode', search_mode.value))
