...
class ToolCallbackResponse(BaseModel):
    """
    Strict callback reply. The encoded content is limited to 256 KiB and 32 nesting levels. `is_error` defaults to false when omitted.
    """ # noqa: E501
    content: Optional[Any]
    is_error: Optional[StrictBool] = False
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["content", "is_error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolCallbackResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolCallbackResponse from a dict"""
        if obj is None:
            return None
