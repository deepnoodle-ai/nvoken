...
class ToolMetrics(BaseModel):
    ...
    ToolMetrics
    """ # noqa: E501
    tool_calls: Annotated[int, Field(strict=True, ge=0)]
    completed_tool_calls: Annotated[int, Field(strict=True, ge=0)]
    failed_tool_calls: Annotated[int, Field(strict=True, ge=0)]
    cancelled_tool_calls: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["tool_calls", "completed_tool_calls", "failed_tool_calls", "cancelled_tool_calls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "completed_tool_calls": obj.get("completed_tool_calls"),
            "failed_tool_calls": obj.get("failed_tool_calls"),
            "cancelled_tool_calls": obj.get("cancelled_tool_calls")
        })
        return _obj
