...
class Sampling(BaseModel):
    ...
    Sampling
    """ # noqa: E501
    temperature: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="Portable sampling temperature. Omit sampling to preserve the provider default. An explicit zero remains explicit. Admission fails closed unless the selected model descriptor positively declares support. ")
