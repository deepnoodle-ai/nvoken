...
class ClientCurrentIdentity(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientCurrentIdentity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientCurrentIdentity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "authentication": ClientCurrentIdentityAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None
        })
