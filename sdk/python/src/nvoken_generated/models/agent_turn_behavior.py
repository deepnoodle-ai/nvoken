...
class AgentTurnBehavior(BaseModel):
    """
    AgentTurnBehavior
    """ # noqa: E501
    kind: StrictStr
    agent: AgentSelector
    __properties: ClassVar[List[str]] = ["kind", "agent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentTurnBehavior from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentTurnBehavior from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind"),
            "agent": AgentSelector.from_dict(obj["agent"]) if obj.get("agent") is not None else None
        })
        return _obj
