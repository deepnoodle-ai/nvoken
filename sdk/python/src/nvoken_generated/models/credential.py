...
class Credential(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "prefix", "status", "profile", "app_id", "creator_credential_id", "creator_subject", "tenant_key", "session_id", "operations", "expires_at", "rotated_from_id", "rotation_overlap_ends_at", "revoked_at", "last_used_at", "created_at", "updated_at"]
