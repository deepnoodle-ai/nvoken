...
class ModelMediaKindCapabilities(BaseModel):
    """
    ModelMediaKindCapabilities
    """ # noqa: E501
    supported: StrictBool
    media_types: List[StrictStr] = Field(description="The exact media types this model accepts. An empty list means it does not accept this kind of input at all. ")
    __properties: ClassVar[List[str]] = ["supported", "media_types"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelMediaKindCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelMediaKindCapabilities from a dict"""
        if obj is None:
            return None
