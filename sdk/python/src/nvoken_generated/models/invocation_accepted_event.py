...
class InvocationAcceptedEvent(BaseModel):
    ...
    limits: Optional[ResolvedLimits] = Field(default=None, description="The limits this turn is actually running under, after your installation's defaults and minimums were applied. Repeated here so you can see what you got without a second request — worth checking when you left `max_iterations` out, since the default may be lower than you expect. ")
