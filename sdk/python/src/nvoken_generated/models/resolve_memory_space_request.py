...
class ResolveMemorySpaceRequest(BaseModel):
    """
    ...
    retention_ttl_seconds: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    expires_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["tenant_key", "selector", "retention_ttl_seconds", "expires_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResolveMemorySpaceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResolveMemorySpaceRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "selector": MemorySpaceSelector.from_dict(obj["selector"]) if obj.get("selector") is not None else None,
