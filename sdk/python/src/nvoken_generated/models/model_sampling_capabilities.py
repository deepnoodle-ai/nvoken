...
class ModelSamplingCapabilities(BaseModel):
    """
    ModelSamplingCapabilities
    """ # noqa: E501
    temperature: StrictBool = Field(description="Whether nvoken can guarantee an explicit temperature reaches this exact model path.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelSamplingCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelSamplingCapabilities from a dict"""
        if obj is None:
            return None
