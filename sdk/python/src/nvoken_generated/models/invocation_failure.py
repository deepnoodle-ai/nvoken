...
class InvocationFailure(BaseModel):
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['deadline_exceeded', 'budget_exceeded', 'credential_unavailable', 'provider_error', 'structured_output_unsatisfied', 'internal']):
            raise ValueError("must be one of enum values ('deadline_exceeded', 'budget_exceeded', 'credential_unavailable', 'provider_error', 'structured_output_unsatisfied', 'internal')")
        return value
