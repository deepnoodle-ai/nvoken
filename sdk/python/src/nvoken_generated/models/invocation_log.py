...
class InvocationLog(BaseModel):
    ...
    timestamp: datetime
    severity: StrictStr
    severity_number: Annotated[int, Field(le=24, strict=True, ge=0)]
    message: StrictStr
    service_name: Optional[StrictStr] = None
    trace_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Lowercase W3C trace ID. Possession does not grant access.")
    span_id: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvocationLog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvocationLog from a dict"""
        if obj is None:
            return None
