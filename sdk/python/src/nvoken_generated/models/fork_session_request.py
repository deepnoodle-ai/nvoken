...
class ForkSessionRequest(BaseModel):
    ...
    user_key: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="Optional opened-by label for the child Session.")
    session_options: Optional[ForkSessionOptions] = None
    __properties: ClassVar[List[str]] = ["from_message", "session_key", "user_key", "session_options"]
