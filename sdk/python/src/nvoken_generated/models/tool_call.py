...
class ToolCall(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["invocation_id", "session_id", "content_expires_at", "id", "mode", "name", "status", "iteration", "created_at", "ended_at", "attempts", "result_origin", "delivery"]
