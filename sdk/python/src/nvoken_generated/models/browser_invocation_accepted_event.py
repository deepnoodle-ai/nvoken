...
class BrowserInvocationAcceptedEvent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "session_id", "invocation_id", "status", "deduplicated", "deadline_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserInvocationAcceptedEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserInvocationAcceptedEvent from a dict"""
        if obj is None:
            return None
