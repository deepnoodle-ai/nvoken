...
class DailyUsage(BaseModel):
    ...
    DailyUsage
    """ # noqa: E501
    start_date: date = Field(description="Inclusive first UTC day of the served window.")
    end_date: date = Field(description="Inclusive last UTC day of the served window.")
    items: List[DailyUsageBucket] = Field(description="Buckets ordered by day, app, provider, and model. Days with no usage produce no bucket.")
    __properties: ClassVar[List[str]] = ["start_date", "end_date", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [DailyUsageBucket.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
