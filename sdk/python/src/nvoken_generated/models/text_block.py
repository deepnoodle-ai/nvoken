...
class TextBlock(BaseModel):
    ...
    citations: Optional[Annotated[List[Citation], Field(min_length=1)]] = Field(default=None, description="Source locations attached to generated text.")
    __properties: ClassVar[List[str]] = ["type", "text", "citations"]
