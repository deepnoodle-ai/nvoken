...
class WebSearchLocation(BaseModel):
    """
    Approximate location used to bias results. Every member is optional; the host decides how precise to be about its end user.
    """ # noqa: E501
    city: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    region: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    country: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    timezone: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    __properties: ClassVar[List[str]] = ["city", "region", "country", "timezone"]
