...
class ModelReasoningCapabilities(BaseModel):
    ...
    budget_tokens: ModelReasoningBudgetCapabilities
    effort_budget_compatible: StrictBool
    __properties: ClassVar[List[str]] = ["effort", "budget_tokens", "effort_budget_compatible"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of budget_tokens
        if self.budget_tokens:
            _dict['budget_tokens'] = self.budget_tokens.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "effort": ModelReasoningEffortCapabilities.from_dict(obj["effort"]) if obj.get("effort") is not None else None,
            "budget_tokens": ModelReasoningBudgetCapabilities.from_dict(obj["budget_tokens"]) if obj.get("budget_tokens") is not None else None,
            "effort_budget_compatible": obj.get("effort_budget_compatible")
        })
        return _obj
