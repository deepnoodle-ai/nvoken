...
class BrowserTurnWebhook(BaseModel):
    """
    BrowserTurnWebhook
    """ # noqa: E501
    url: Annotated[str, Field(min_length=1, strict=True, max_length=2048)] = Field(description="Guarded absolute HTTPS Turn webhook endpoint.")
    events: Optional[Annotated[List[WebhookEvent], Field(min_length=2, max_length=3)]] = Field(default=None, description="Must include turn.waiting and turn.ended. Omission selects every current Turn webhook event. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserTurnWebhook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserTurnWebhook from a dict"""
        if obj is None:
            return None
