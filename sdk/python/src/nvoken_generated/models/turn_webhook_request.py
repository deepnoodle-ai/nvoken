...
class TurnWebhookRequest(BaseModel):
    """
    TurnWebhookRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["nvoken", "turn"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TurnWebhookRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TurnWebhookRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nvoken": TurnWebhookContext.from_dict(obj["nvoken"]) if obj.get("nvoken") is not None else None,
            "turn": TurnWebhookSubject.from_dict(obj["turn"]) if obj.get("turn") is not None else None
        })
