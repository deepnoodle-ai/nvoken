...
class ClientKey(BaseModel):
    ...
    def fingerprint_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[A-Za-z0-9_-]{43}$", value):
            raise ValueError(r"must validate the regular expression /^[A-Za-z0-9_-]{43}$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientKey from a dict"""
        if obj is None:
            return None
