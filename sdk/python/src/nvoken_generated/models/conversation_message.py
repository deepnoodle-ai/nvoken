...
class ConversationMessage(BaseModel):
    ...
    turn_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="The Turn that wrote this row, or null for a copied fork-history row. `copied_from_message_id` explains that null. ")
