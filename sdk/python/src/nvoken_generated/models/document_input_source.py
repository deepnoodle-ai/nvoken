...
class DocumentInputSource(BaseModel):
    """
    ...
    data: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=22369624)]] = Field(default=None, description="Standard padded base64 with no whitespace.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocumentInputSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocumentInputSource from a dict"""
        if obj is None:
            return None
