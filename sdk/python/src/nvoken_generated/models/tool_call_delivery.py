...
class ToolCallDelivery(BaseModel):
    """
    ToolCallDelivery
    """ # noqa: E501
    outcome: CallbackDeliveryOutcome
    attempts: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of leased HTTP delivery attempts.")
    last_http_status: Optional[Annotated[int, Field(le=599, strict=True, ge=100)]] = Field(description="Last HTTP status returned by the endpoint, or null before any response.")
    __properties: ClassVar[List[str]] = ["outcome", "attempts", "last_http_status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolCallDelivery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolCallDelivery from a dict"""
        if obj is None:
            return None
