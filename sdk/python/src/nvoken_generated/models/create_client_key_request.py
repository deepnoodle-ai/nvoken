...
class CreateClientKeyRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Bounded operator-facing display name.")
    public_key: Union[Annotated[bytes, Field(min_length=44, strict=True, max_length=44)], Annotated[str, Field(min_length=44, strict=True, max_length=44)]] = Field(description="Standard padded base64 for exactly 32 Ed25519 public-key bytes.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateClientKeyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateClientKeyRequest from a dict"""
        if obj is None:
            return None
