...
class Nudge(BaseModel):
    ...
    created_at: datetime
    drained_at: Optional[datetime] = Field(default=None, description="When the Nudge was promoted into the transcript. Present only when drained.")
    ...
    __properties: ClassVar[List[str]] = ["id", "invocation_id", "status", "content", "idempotency_key", "created_at", "drained_at", "drained_message_sequence", "ended_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Nudge from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Nudge from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "drained_at": obj.get("drained_at"),
            "drained_message_sequence": obj.get("drained_message_sequence"),
