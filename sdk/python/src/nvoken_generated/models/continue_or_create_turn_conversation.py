...
class ContinueOrCreateTurnConversation(BaseModel):
    ...
    def mode_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['continue_or_create']):
            raise ValueError("must be one of enum values ('continue_or_create')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContinueOrCreateTurnConversation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContinueOrCreateTurnConversation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "if_active": obj.get("if_active") if obj.get("if_active") is not None else ConversationActivePolicy.REJECT,
