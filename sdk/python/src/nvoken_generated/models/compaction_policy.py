...
class CompactionPolicy(BaseModel):
    ...
    """ # noqa: E501
    trigger_tokens: CompactionPolicyTriggerTokens
    model: Optional[Model] = None
    __properties: ClassVar[List[str]] = ["trigger_tokens", "model"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompactionPolicy from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of trigger_tokens
        if self.trigger_tokens:
            _dict['trigger_tokens'] = self.trigger_tokens.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompactionPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "trigger_tokens": CompactionPolicyTriggerTokens.from_dict(obj["trigger_tokens"]) if obj.get("trigger_tokens") is not None else None,
