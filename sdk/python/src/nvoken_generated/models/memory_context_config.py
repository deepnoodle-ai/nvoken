...
class MemoryContextConfig(BaseModel):
    ...
    MemoryContextConfig
    """ # noqa: E501
    mode: Optional[MemoryContextMode] = MemoryContextMode.INDEX
    max_bytes: Optional[Annotated[int, Field(le=245760, strict=True, ge=0)]] = Field(default=None, description="Defaults to 1536 for index and 131072 for full; must be zero for off.")
    __properties: ClassVar[List[str]] = ["mode", "max_bytes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemoryContextConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemoryContextConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode") if obj.get("mode") is not None else MemoryContextMode.INDEX,
