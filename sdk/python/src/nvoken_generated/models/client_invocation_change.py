...
class ClientInvocationChange(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["invocation_id", "revision", "status", "through_message_sequence", "error", "structured_output", "occurred_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientInvocationChange from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientInvocationChange from a dict"""
        if obj is None:
            return None
