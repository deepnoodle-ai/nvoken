...
class AgentDefinitionWrite(BaseModel):
    """
    ...
    mcp_servers: Optional[Annotated[List[MCPServer], Field(max_length=8)]] = Field(default=None, description="MCP server declarations for later Invocations. Secrets are never part of an Agent Definition.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentDefinitionWrite from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentDefinitionWrite from a dict"""
        if obj is None:
            return None
