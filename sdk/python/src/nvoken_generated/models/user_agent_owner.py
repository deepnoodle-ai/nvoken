...
class UserAgentOwner(BaseModel):
    """
    UserAgentOwner
    """ # noqa: E501
    kind: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["kind", "tenant_key", "user_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserAgentOwner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserAgentOwner from a dict"""
        if obj is None:
            return None
