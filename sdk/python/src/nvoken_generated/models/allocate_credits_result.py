...
class AllocateCreditsResult(BaseModel):
    """
    AllocateCreditsResult
    """ # noqa: E501
    allocation: CreditAllocation
    account: CreditAccount
    __properties: ClassVar[List[str]] = ["allocation", "account"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllocateCreditsResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllocateCreditsResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "allocation": CreditAllocation.from_dict(obj["allocation"]) if obj.get("allocation") is not None else None,
            "account": CreditAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
