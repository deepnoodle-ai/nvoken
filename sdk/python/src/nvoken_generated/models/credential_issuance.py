...
class CredentialIssuance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["credential", "secret", "delivery_expires_at", "replayed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CredentialIssuance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CredentialIssuance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "delivery_expires_at": obj.get("delivery_expires_at"),
