...
class InvocationInputBlocks(BaseModel):
    """
    InvocationInputBlocks
    """ # noqa: E501
    content: Annotated[List[TextInputBlock], Field(min_length=1, max_length=64)] = Field(description="Ordered caller-input blocks.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvocationInputBlocks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvocationInputBlocks from a dict"""
        if obj is None:
            return None
