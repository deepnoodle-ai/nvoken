...
class BrowserInvocationWebhook(BaseModel):
    """
    BrowserInvocationWebhook
    """ # noqa: E501
    url: Annotated[str, Field(min_length=1, strict=True, max_length=2048)] = Field(description="Guarded absolute HTTPS Invocation webhook endpoint.")
    events: Optional[Annotated[List[WebhookEvent], Field(min_length=2, max_length=3)]] = Field(default=None, description="Must include invocation.waiting and invocation.ended. Omission selects every current Invocation webhook event. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserInvocationWebhook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserInvocationWebhook from a dict"""
        if obj is None:
            return None
