...
class ImageInputSource(BaseModel):
    ...
    url: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = Field(default=None, description="Public HTTPS URL fetched once during admission. The response is size-bounded while reading and its bytes are sniffed. media_type is optional for this form. When present it must match the sniffed type. ")
