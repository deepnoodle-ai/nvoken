...
class CreateAgentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agent_key", "name", "owner", "instructions", "model", "sampling", "reasoning", "tool_choice", "limits", "output_schema", "tools", "mcp_servers", "provider_tools", "memory", "client_interface"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "owner": AgentOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
