...
SESSIONLISTRESPONSE_ONE_OF_SCHEMAS = ["ClientSessionList", "SessionList"]
...
class SessionListResponse(BaseModel):
    ...
    # data type: ClientSessionList
    oneof_schema_2_validator: Optional[ClientSessionList] = None
    actual_instance: Optional[Union[ClientSessionList, SessionList]] = None
    one_of_schemas: Set[str] = { "ClientSessionList", "SessionList" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, SessionList):
            ...
            match += 1
        # validate data type: ClientSessionList
        if not isinstance(v, ClientSessionList):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ClientSessionList`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in SessionListResponse with oneOf schemas: ClientSessionList, SessionList. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in SessionListResponse with oneOf schemas: ClientSessionList, SessionList. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into ClientSessionList
        try:
            instance.actual_instance = ClientSessionList.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into SessionListResponse with oneOf schemas: ClientSessionList, SessionList. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into SessionListResponse with oneOf schemas: ClientSessionList, SessionList. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ClientSessionList, SessionList]]:
