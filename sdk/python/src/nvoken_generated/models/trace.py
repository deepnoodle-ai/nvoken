...
class Trace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trace_id", "root_span_id", "name", "status", "started_at", "ended_at", "duration_ms", "span_count", "error_count", "is_partial", "attempt", "invocation_id", "session_id", "content_expires_at", "spans"]
