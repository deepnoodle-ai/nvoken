...
class SessionContext(BaseModel):
    ...
    SessionContext
    """ # noqa: E501
    estimated_tokens: Annotated[int, Field(strict=True, ge=0)] = Field(description="Estimated tokens in the retained generation context: the latest applied summary plus the generation-eligible messages after its watermark. This is the same estimate the compaction trigger uses. ")
