...
class BuiltinToolDeclaration(BaseModel):
    """
    BuiltinToolDeclaration
    """ # noqa: E501
    name: StrictStr = Field(description="Fixed runtime-owned public-web fetch capability.")
    mode: StrictStr
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['nvoken_fetch']):
            raise ValueError("must be one of enum values ('nvoken_fetch')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BuiltinToolDeclaration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BuiltinToolDeclaration from a dict"""
        if obj is None:
            return None
