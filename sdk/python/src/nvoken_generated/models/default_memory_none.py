...
class DefaultMemoryNone(BaseModel):
    """
    DefaultMemoryNone
    """ # noqa: E501
    default_scope: StrictStr
    __properties: ClassVar[List[str]] = ["default_scope"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultMemoryNone from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultMemoryNone from a dict"""
        if obj is None:
            return None
