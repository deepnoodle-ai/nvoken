...
class SessionBudget(BaseModel):
    """
    A spending cap in USD covering every turn in this Session. You can change it at any time.  The figure is nvoken's own estimate, based on published list prices and the model calls it recorded — it is a control for stopping runaway work, not a bill. If a model has no price in nvoken's catalog, turns using it are refused rather than run uncosted.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["max_estimated_cost_usd"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionBudget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionBudget from a dict"""
        if obj is None:
            return None
