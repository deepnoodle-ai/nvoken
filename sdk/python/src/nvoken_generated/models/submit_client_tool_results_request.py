...
class SubmitClientToolResultsRequest(BaseModel):
    """
    SubmitClientToolResultsRequest
    """ # noqa: E501
    results: Annotated[List[SubmitClientToolResultsRequestResultsInner], Field(min_length=1, max_length=32)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitClientToolResultsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitClientToolResultsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [SubmitClientToolResultsRequestResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
