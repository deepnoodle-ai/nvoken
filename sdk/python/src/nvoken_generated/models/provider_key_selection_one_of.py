...
class ProviderKeySelectionOneOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["provider", "source", "key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderKeySelectionOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderKeySelectionOneOf from a dict"""
        if obj is None:
            return None
