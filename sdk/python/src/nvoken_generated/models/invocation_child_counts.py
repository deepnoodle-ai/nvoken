...
class InvocationChildCounts(BaseModel):
    """
    Direct-child counts; descendants are not folded in recursively.
    """ # noqa: E501
    total: Annotated[int, Field(strict=True, ge=0)]
    open: Annotated[int, Field(strict=True, ge=0)] = Field(description="Direct children in any nonterminal status.")
    failed: Annotated[int, Field(strict=True, ge=0)] = Field(description="Direct children whose status is `failed`.")
    __properties: ClassVar[List[str]] = ["total", "open", "failed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvocationChildCounts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvocationChildCounts from a dict"""
        if obj is None:
            return None
