...
class BudgetBlock(BaseModel):
    ...
    def scope_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['app', 'customer', 'user', 'agent', 'provider_key', 'api_credential', 'session']):
            raise ValueError("must be one of enum values ('app', 'customer', 'user', 'agent', 'provider_key', 'api_credential', 'session')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BudgetBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BudgetBlock from a dict"""
        if obj is None:
            return None
