...
class MessageDeltaEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "session_id", "content_expires_at", "invocation_id", "attempt", "message_id", "content_index", "kind", "delta", "tool_call_id", "name", "emitted_at"]
