...
class ApproveConsoleDeviceAuthorizationRequest(BaseModel):
    """
    ApproveConsoleDeviceAuthorizationRequest
    """ # noqa: E501
    credential_type: StrictStr
    __properties: ClassVar[List[str]] = ["credential_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApproveConsoleDeviceAuthorizationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApproveConsoleDeviceAuthorizationRequest from a dict"""
        if obj is None:
            return None
