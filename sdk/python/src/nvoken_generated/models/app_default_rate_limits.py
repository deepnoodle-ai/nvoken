...
class AppDefaultRateLimits(BaseModel):
    ...
    """ # noqa: E501
    max_concurrent_turns: Annotated[int, Field(strict=True, ge=1)]
    max_admissions_per_minute: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["max_concurrent_turns", "max_admissions_per_minute"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max_concurrent_turns": obj.get("max_concurrent_turns"),
