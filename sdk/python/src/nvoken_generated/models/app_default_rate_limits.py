...
class AppDefaultRateLimits(BaseModel):
    """
    The one App-wide admission contract shared by machine and future client-token callers. Both positive values are required. They are authoritative configuration but unenforced until PRD 065.
    """ # noqa: E501
