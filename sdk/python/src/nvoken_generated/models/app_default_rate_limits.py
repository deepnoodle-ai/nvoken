...
class AppDefaultRateLimits(BaseModel):
    """
    The one App-wide admission contract shared by machine and browser callers. Both positive values are required and enforced at admission.
    """ # noqa: E501
    max_concurrent_invocations: Annotated[int, Field(strict=True, ge=1)]
    max_admissions_per_minute: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["max_concurrent_invocations", "max_admissions_per_minute"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppDefaultRateLimits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppDefaultRateLimits from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "max_concurrent_invocations": obj.get("max_concurrent_invocations"),
