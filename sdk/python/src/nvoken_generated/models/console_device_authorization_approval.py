...
class ConsoleDeviceAuthorizationApproval(BaseModel):
    """
    ...
    app_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    credential_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "label", "app_name", "credential_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConsoleDeviceAuthorizationApproval from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConsoleDeviceAuthorizationApproval from a dict"""
        if obj is None:
            return None
