...
class CurrentIdentityAuthentication(BaseModel):
    ...
    definition_revision: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Browser grants only.")
    ...
    __properties: ClassVar[List[str]] = ["credential_id", "app_id", "org_id", "type", "agent_key", "agent_id", "definition_revision", "tenant_key", "session_id", "method"]
