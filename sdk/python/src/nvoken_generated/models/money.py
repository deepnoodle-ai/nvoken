...
class Money(BaseModel):
    ...
    Money
    """ # noqa: E501
    amount: Annotated[str, Field(strict=True)] = Field(description="Exact decimal amount with six fractional digits.")
    currency: StrictStr
    ...
    def amount_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^-?[0-9]+\.[0-9]{6}$", value):
            raise ValueError(r"must validate the regular expression /^-?[0-9]+\.[0-9]{6}$/")
        return value
