...
class AdmissionReasonCount(BaseModel):
    """
    AdmissionReasonCount
    """ # noqa: E501
    error_code: StrictStr
    count: StrictInt
    __properties: ClassVar[List[str]] = ["error_code", "count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdmissionReasonCount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdmissionReasonCount from a dict"""
        if obj is None:
            return None
