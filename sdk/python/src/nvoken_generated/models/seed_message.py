...
class SeedMessage(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SeedMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SeedMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "role": obj.get("role"),
            "content": SeedMessageContent.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
