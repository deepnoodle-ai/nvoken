...
class MCPListToolsRequest(BaseModel):
    ...
    """ # noqa: E501
    server: MCPServer
    headers: Optional[Dict[str, Annotated[str, Field(min_length=1, strict=True)]]] = Field(default=None, description="Optional secret headers used only for this discovery request.")
    __properties: ClassVar[List[str]] = ["server", "headers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MCPListToolsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MCPListToolsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "server": MCPServer.from_dict(obj["server"]) if obj.get("server") is not None else None,
