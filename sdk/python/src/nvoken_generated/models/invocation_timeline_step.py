...
class InvocationTimelineStep(BaseModel):
    """
    ...
    call_kind: Optional[StrictStr] = None
    ...
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['lifecycle', 'model_call', 'tool_call', 'nudge']):
            raise ValueError("must be one of enum values ('lifecycle', 'model_call', 'tool_call', 'nudge')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvocationTimelineStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvocationTimelineStep from a dict"""
        if obj is None:
            return None
