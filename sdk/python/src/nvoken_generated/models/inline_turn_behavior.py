...
class InlineTurnBehavior(BaseModel):
    """
    InlineTurnBehavior
    """ # noqa: E501
    kind: StrictStr
    behavior: BehaviorInput
    __properties: ClassVar[List[str]] = ["kind", "behavior"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InlineTurnBehavior from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InlineTurnBehavior from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind"),
            "behavior": BehaviorInput.from_dict(obj["behavior"]) if obj.get("behavior") is not None else None
        })
        return _obj
