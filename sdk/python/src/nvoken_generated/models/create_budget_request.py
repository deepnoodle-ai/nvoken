...
class CreateBudgetRequest(BaseModel):
    ...
    credential_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Opaque identifier with the public `cred_` prefix. Treat the body as opaque.")
