...
class ModelCallRecord(BaseModel):
    ...
    turn_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Opaque identifier with the public `turn_` prefix. Treat the body as opaque.")
