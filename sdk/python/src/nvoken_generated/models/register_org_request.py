...
class RegisterOrgRequest(BaseModel):
    ...
    external_ref: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="Optional unique identity-provider Org identifier. Reusing it returns the existing Org unchanged. ")
    __properties: ClassVar[List[str]] = ["display_name", "external_ref"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegisterOrgRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegisterOrgRequest from a dict"""
        if obj is None:
            return None
