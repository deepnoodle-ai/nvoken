...
from nvoken_generated.models.browser_invocation_failure import BrowserInvocationFailure
...
class BrowserInvocationChange(BaseModel):
    """
    One lifecycle step of one turn, in the browser projection. It carries the same lifecycle detail as the browser Invocation projection, and nothing the browser projection withholds.
    """ # noqa: E501
    ...
    stop_reason: Optional[InvocationStopReason] = Field(default=None, description="Why the turn stopped. Present once it has stopped.")
    ...
    error: Optional[BrowserInvocationFailure]
    structured_output: Optional[Dict[str, Any]]
    occurred_at: datetime
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["invocation_id", "revision", "status", "stop_reason", "pending_tool_calls", "tool_calls", "through_message_sequence", "error", "structured_output", "occurred_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserInvocationChange from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserInvocationChange from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "error": BrowserInvocationFailure.from_dict(obj["error"]) if obj.get("error") is not None else None,
