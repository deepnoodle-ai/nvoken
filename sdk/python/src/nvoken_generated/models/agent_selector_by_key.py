...
class AgentSelectorByKey(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["owner_kind", "agent_key", "revision"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSelectorByKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSelectorByKey from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "revision": AgentRevisionSelector.from_dict(obj["revision"]) if obj.get("revision") is not None else None
        })
        return _obj
