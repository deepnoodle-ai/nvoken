...
class ProviderKeySelectionOneOf1(BaseModel):
    """
    ...
    def source_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['app_byok', 'tenant_byok', 'platform']):
            raise ValueError("must be one of enum values ('app_byok', 'tenant_byok', 'platform')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderKeySelectionOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderKeySelectionOneOf1 from a dict"""
        if obj is None:
            return None
