...
class ModelInputCapabilities(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelInputCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelInputCapabilities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "media": ModelMediaCapabilities.from_dict(obj["media"]) if obj.get("media") is not None else None
        })
        return _obj
