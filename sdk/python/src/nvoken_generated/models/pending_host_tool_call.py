...
class PendingHostToolCall(BaseModel):
    """
    PendingHostToolCall
    """ # noqa: E501
    ...
    name: StrictStr
    input: Dict[str, Any] = Field(description="The arguments the model produced for this call, as a JSON object whose shape is the `input_schema` you declared for the tool named above. nvoken does not narrow it further, because only your tool declaration knows what belongs there. ")
    deadline_at: Optional[datetime] = Field(description="The Invocation's explicit waiting deadline, or null when external waiting is unbounded. ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "input", "deadline_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PendingHostToolCall from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PendingHostToolCall from a dict"""
        if obj is None:
            return None
