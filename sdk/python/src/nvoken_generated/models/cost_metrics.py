...
class CostMetrics(BaseModel):
    ...
    priced_model_calls: Annotated[int, Field(strict=True, ge=0)]
    unpriced_model_calls: Annotated[int, Field(strict=True, ge=0)]
    uncertain_model_calls: Annotated[int, Field(strict=True, ge=0)]
    unbounded_uncertain_model_calls: Annotated[int, Field(strict=True, ge=0)]
    max_cost_at_risk: Money
    __properties: ClassVar[List[str]] = ["model_cost", "cost_coverage", "priced_model_calls", "unpriced_model_calls", "uncertain_model_calls", "unbounded_uncertain_model_calls", "max_cost_at_risk"]

    @field_validator('cost_coverage')
    def cost_coverage_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['complete', 'partial', 'none', 'not_applicable']):
            raise ValueError("must be one of enum values ('complete', 'partial', 'none', 'not_applicable')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priced_model_calls": obj.get("priced_model_calls"),
            "unpriced_model_calls": obj.get("unpriced_model_calls"),
            "uncertain_model_calls": obj.get("uncertain_model_calls"),
            "unbounded_uncertain_model_calls": obj.get("unbounded_uncertain_model_calls"),
