...
class AnonymousTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    visitor_token: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Previously returned visitor token; omit on a first visit.")
    __properties: ClassVar[List[str]] = ["visitor_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnonymousTokenRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnonymousTokenRequest from a dict"""
        if obj is None:
            return None
