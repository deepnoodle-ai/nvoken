...
class SessionForkLineage(BaseModel):
    """
    The source Session and inclusive source message of a fork. These IDs remain as lineage after the source Session is erased.
    """ # noqa: E501
    session: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Opaque identifier with the public `sess_` prefix. Treat the body as opaque.")
    message: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Opaque identifier with the public `msg_` prefix. Treat the body as opaque.")
    __properties: ClassVar[List[str]] = ["session", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SessionForkLineage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SessionForkLineage from a dict"""
        if obj is None:
            return None
