...
class SessionForkLineage(BaseModel):
    ...
    """ # noqa: E501
    session: Annotated[str, Field(strict=True)] = Field(description="UUIDv7 with the public `sesn_` prefix.")
    message: Annotated[str, Field(strict=True)] = Field(description="UUIDv7 with the public `smsg_` prefix.")
