...
class DocumentInputBlock(BaseModel):
    """
    ...
    title: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="Optional filename supplied to providers that require one. Omission uses the adapter default and does not change acceptance. ")
    __properties: ClassVar[List[str]] = ["type", "source", "title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocumentInputBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocumentInputBlock from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "source": DocumentInputSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "title": obj.get("title")
        })
        return _obj
