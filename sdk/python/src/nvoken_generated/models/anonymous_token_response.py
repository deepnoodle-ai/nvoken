...
class AnonymousTokenResponse(BaseModel):
    ...
    conversation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Canonical conversation for this visitor, or null before its first turn. Anonymous Turns that omit Conversation selectors resume this Conversation automatically. ")
