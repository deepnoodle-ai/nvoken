...
class AnonymousTokenResponse(BaseModel):
    ...
    visitor_token: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Renewable continuity bearer accepted only by this route.")
    ...
    __properties: ClassVar[List[str]] = ["access_token", "access_token_expires_at", "visitor_token", "visitor_token_expires_at", "session_id"]
