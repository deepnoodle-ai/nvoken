...
from nvoken_generated.models.browser_invocation_change import BrowserInvocationChange
from nvoken_generated.models.browser_session_message import BrowserSessionMessage
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class BrowserTranscriptSnapshot(BaseModel):
    """
    BrowserTranscriptSnapshot
    """ # noqa: E501
    messages: List[BrowserSessionMessage]
    invocation_changes: List[BrowserInvocationChange]
    has_more: StrictBool
    resume_cursor: Annotated[str, Field(min_length=1, strict=True)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserTranscriptSnapshot from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserTranscriptSnapshot from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "messages": [BrowserSessionMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "invocation_changes": [BrowserInvocationChange.from_dict(_item) for _item in obj["invocation_changes"]] if obj.get("invocation_changes") is not None else None,
