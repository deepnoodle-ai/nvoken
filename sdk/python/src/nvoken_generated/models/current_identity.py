...
class CurrentIdentity(BaseModel):
    """
    Who nvoken thinks you are. `method` says how you authenticated. A machine API key carries `credential_id` and `type`; a short-lived console presentation may carry `org_id`; a browser grant carries its fixed App, Agent, tenant, Definition revision, and optional Session bindings.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CurrentIdentity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CurrentIdentity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "authentication": CurrentIdentityAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None
        })
