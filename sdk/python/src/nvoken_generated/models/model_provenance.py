...
class ModelProvenance(BaseModel):
    ...
    credential_source: Optional[Any]
    __properties: ClassVar[List[str]] = ["provider", "requested_model", "served_model", "credential_source"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if credential_source (nullable) is None
        # and model_fields_set contains the field
        if self.credential_source is None and "credential_source" in self.model_fields_set:
            _dict['credential_source'] = None
