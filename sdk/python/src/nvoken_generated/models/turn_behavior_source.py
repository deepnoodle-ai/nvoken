...
TURNBEHAVIORSOURCE_ONE_OF_SCHEMAS = ["InlineTurnBehaviorSource", "StoredTurnBehaviorSource"]

class TurnBehaviorSource(BaseModel):
    """
    TurnBehaviorSource
    """
    # data type: StoredTurnBehaviorSource
    oneof_schema_1_validator: Optional[StoredTurnBehaviorSource] = None
    # data type: InlineTurnBehaviorSource
    oneof_schema_2_validator: Optional[InlineTurnBehaviorSource] = None
    actual_instance: Optional[Union[InlineTurnBehaviorSource, StoredTurnBehaviorSource]] = None
    one_of_schemas: Set[str] = { "InlineTurnBehaviorSource", "StoredTurnBehaviorSource" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = TurnBehaviorSource.model_construct()
        error_messages = []
        match = 0
        # validate data type: StoredTurnBehaviorSource
        if not isinstance(v, StoredTurnBehaviorSource):
            error_messages.append(f"Error! Input type `{type(v)}` is not `StoredTurnBehaviorSource`")
        else:
            match += 1
        # validate data type: InlineTurnBehaviorSource
        if not isinstance(v, InlineTurnBehaviorSource):
            error_messages.append(f"Error! Input type `{type(v)}` is not `InlineTurnBehaviorSource`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in TurnBehaviorSource with oneOf schemas: InlineTurnBehaviorSource, StoredTurnBehaviorSource. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in TurnBehaviorSource with oneOf schemas: InlineTurnBehaviorSource, StoredTurnBehaviorSource. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into StoredTurnBehaviorSource
        try:
            instance.actual_instance = StoredTurnBehaviorSource.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into InlineTurnBehaviorSource
        try:
            instance.actual_instance = InlineTurnBehaviorSource.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into TurnBehaviorSource with oneOf schemas: InlineTurnBehaviorSource, StoredTurnBehaviorSource. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into TurnBehaviorSource with oneOf schemas: InlineTurnBehaviorSource, StoredTurnBehaviorSource. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], InlineTurnBehaviorSource, StoredTurnBehaviorSource]]:
