...
class NewTurnConversation(BaseModel):
    """
    NewTurnConversation
    """ # noqa: E501
    mode: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["mode", "owner", "conversation_key", "retention", "compaction", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewTurnConversation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewTurnConversation from a dict"""
        if obj is None:
            return None
