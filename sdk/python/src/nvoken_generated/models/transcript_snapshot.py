...
class TranscriptSnapshot(BaseModel):
    ...
    has_more: StrictBool
    resume_cursor: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Your resume position. Store it and send it back as `cursor` to continue where you left off.")
