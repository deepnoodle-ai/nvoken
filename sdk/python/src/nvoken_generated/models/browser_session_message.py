...
class BrowserSessionMessage(BaseModel):
    """
    ...
    invocation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Opaque identifier with the public `inv_` prefix. Treat the body as opaque.")
    sequence: Annotated[int, Field(strict=True, ge=1)]
    role: SessionMessageRole
    content: Annotated[List[SessionContentBlock], Field(min_length=1)]
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "session_id", "invocation_id", "sequence", "role", "content", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserSessionMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserSessionMessage from a dict"""
        if obj is None:
            return None
