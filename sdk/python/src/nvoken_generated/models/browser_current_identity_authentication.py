...
class BrowserCurrentIdentityAuthentication(BaseModel):
    """
    ...
    method: StrictStr
    assurance: StrictStr
    __properties: ClassVar[List[str]] = ["app_id", "tenant_key", "agent_key", "agent_definition_id", "agent_definition_revision", "session_id", "operations", "method", "assurance"]

    @field_validator('method')
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['client_token', 'anonymous_token']):
            raise ValueError("must be one of enum values ('client_token', 'anonymous_token')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserCurrentIdentityAuthentication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserCurrentIdentityAuthentication from a dict"""
        if obj is None:
            return None
