...
class SessionMessage(BaseModel):
    ...
    user_key: Optional[StrictStr] = Field(default=None, description="Per-turn host end-user attribution. Copied rows preserve it; seeded history may omit it. ")
    ...
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "session_id", "content_expires_at", "agent_id", "invocation_id", "user_key", "sequence", "role", "content", "origin", "copied_from_message_id", "phase", "created_at"]
