...
class BrowserStandaloneOnlyAccess(BaseModel):
    """
    ...
    def scope_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['standalone_only']):
            raise ValueError("must be one of enum values ('standalone_only')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserStandaloneOnlyAccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserStandaloneOnlyAccess from a dict"""
        if obj is None:
            return None
