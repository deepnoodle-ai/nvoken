...
class StreamResyncEvent(BaseModel):
    ...
    invocation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="The Invocation whose previews are void, or null for every Invocation in the Session. ")
