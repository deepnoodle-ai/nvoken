...
class StreamResyncEvent(BaseModel):
    ...
    invocation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="The Invocation whose previews are void. Absent means every Invocation in the Session: an absent field is scope, where a null identifier would be scope wearing an identifier's name. ")
    reason: StreamResyncReason
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "session_id", "content_expires_at", "invocation_id", "reason"]
