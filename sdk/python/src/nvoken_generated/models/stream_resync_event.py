...
class StreamResyncEvent(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    turn_id: Optional[StrictStr] = Field(default=None, description="The Turn whose previews are void. On a Turn stream it is always present and names that Turn. On a Conversation stream it is present when one Turn's previews are void and absent when every preview in the Conversation is: an absent field is scope, where a null identifier would be scope wearing an identifier's name. ")
    reason: StreamResyncReason
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "turn_id", "reason"]
