...
class AgentDefinitionOverrides(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["model", "sampling", "reasoning", "tool_choice", "limits", "output_schema"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentDefinitionOverrides from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentDefinitionOverrides from a dict"""
        if obj is None:
            return None
