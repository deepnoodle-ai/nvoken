...
class BrowserTranscriptUpdateEvent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "session_id", "messages", "invocation_changes", "resume_cursor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserTranscriptUpdateEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserTranscriptUpdateEvent from a dict"""
        if obj is None:
            return None
