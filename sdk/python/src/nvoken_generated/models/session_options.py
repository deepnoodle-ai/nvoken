...
class SessionOptions(BaseModel):
    ...
    max_estimated_cost_usd: Optional[Union[Annotated[float, Field(multiple_of=0.0000010, strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]]] = Field(default=None, description="Lifetime estimated-list-price cap across model calls committed to this Session. This is a Session setting, not a Budget resource. ")
    ...
    __properties: ClassVar[List[str]] = ["compaction", "retention", "max_estimated_cost_usd", "metadata"]
