...
class TurnWebhookContext(BaseModel):
    """
    TurnWebhookContext
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["schema_version", "delivery_id", "event", "sequence", "turn_id", "conversation_id", "memory_space_id", "content_expires_at", "behavior_source", "tenant_key", "user_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TurnWebhookContext from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TurnWebhookContext from a dict"""
        if obj is None:
            return None
