...
class InvocationResult(BaseModel):
    ...
    output_text: Optional[StrictStr] = Field(description="The assistant's text from this turn, joined together in order with nothing between the pieces. This is the convenience field for \"what did the agent say?\"  Non-null only when the turn completed and produced at least one piece of text. Failed and cancelled turns leave it null even if some text was produced, so read the messages directly if you need those. ")
