...
class ClientTranscriptSnapshot(BaseModel):
    """
    ClientTranscriptSnapshot
    """ # noqa: E501
    messages: List[ClientSessionMessage]
    invocation_changes: List[ClientInvocationChange]
    has_more: StrictBool
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientTranscriptSnapshot from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientTranscriptSnapshot from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "messages": [ClientSessionMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "invocation_changes": [ClientInvocationChange.from_dict(_item) for _item in obj["invocation_changes"]] if obj.get("invocation_changes") is not None else None,
