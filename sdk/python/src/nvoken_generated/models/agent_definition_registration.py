...
class AgentDefinitionRegistration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["agent_definition_id", "agent_definition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentDefinitionRegistration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentDefinitionRegistration from a dict"""
        if obj is None:
            return None
