...
class ForkConversationRequest(BaseModel):
    ...
    """ # noqa: E501
    from_message_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Public source message included as the final message in the copied prefix.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ForkConversationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ForkConversationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "from_message_id": obj.get("from_message_id"),
