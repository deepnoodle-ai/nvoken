...
class TenantCredits(BaseModel):
    ...
    TenantCredits
    """ # noqa: E501
    funded: StrictBool = Field(description="Whether a credit account exists at all. False means nothing was ever allocated, which reads as zero everywhere else here. ")
    allocated: Money
    used: Money
    held: Money
    available: Money
    __properties: ClassVar[List[str]] = ["funded", "allocated", "used", "held", "available"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TenantCredits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TenantCredits from a dict"""
        if obj is None:
            return None
