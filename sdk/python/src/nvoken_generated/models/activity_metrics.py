...
class ActivityMetrics(BaseModel):
    ...
    ActivityMetrics
    """ # noqa: E501
    turns: Annotated[int, Field(strict=True, ge=0)]
    completed_turns: Annotated[int, Field(strict=True, ge=0)]
    incomplete_turns: Annotated[int, Field(strict=True, ge=0)]
    failed_turns: Annotated[int, Field(strict=True, ge=0)]
    cancelled_turns: Annotated[int, Field(strict=True, ge=0)]
    open_turns: Annotated[int, Field(strict=True, ge=0)]
    ...
    unattributed_turns: Annotated[int, Field(strict=True, ge=0)]
    active_tenants: Annotated[int, Field(strict=True, ge=0)]
    active_agents: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["turns", "completed_turns", "incomplete_turns", "failed_turns", "cancelled_turns", "open_turns", "active_users", "unattributed_turns", "active_tenants", "active_agents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incomplete_turns": obj.get("incomplete_turns"),
            "failed_turns": obj.get("failed_turns"),
            "cancelled_turns": obj.get("cancelled_turns"),
            "open_turns": obj.get("open_turns"),
            "active_users": obj.get("active_users"),
            "unattributed_turns": obj.get("unattributed_turns"),
