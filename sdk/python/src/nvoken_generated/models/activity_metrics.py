...
class ActivityMetrics(BaseModel):
    ...
    ActivityMetrics
    """ # noqa: E501
    invocations: Annotated[int, Field(strict=True, ge=0)]
    completed_invocations: Annotated[int, Field(strict=True, ge=0)]
    incomplete_invocations: Annotated[int, Field(strict=True, ge=0)]
    failed_invocations: Annotated[int, Field(strict=True, ge=0)]
    cancelled_invocations: Annotated[int, Field(strict=True, ge=0)]
    open_invocations: Annotated[int, Field(strict=True, ge=0)]
    active_users: Annotated[int, Field(strict=True, ge=0)] = Field(description="Exact distinct non-null user identities over this row's window.")
    unattributed_invocations: Annotated[int, Field(strict=True, ge=0)]
    active_tenants: Annotated[int, Field(strict=True, ge=0)]
    active_agents: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["invocations", "completed_invocations", "incomplete_invocations", "failed_invocations", "cancelled_invocations", "open_invocations", "active_users", "unattributed_invocations", "active_tenants", "active_agents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "completed_invocations": obj.get("completed_invocations"),
            "incomplete_invocations": obj.get("incomplete_invocations"),
            "failed_invocations": obj.get("failed_invocations"),
            "cancelled_invocations": obj.get("cancelled_invocations"),
            "open_invocations": obj.get("open_invocations"),
            "active_users": obj.get("active_users"),
            "unattributed_invocations": obj.get("unattributed_invocations"),
            "active_tenants": obj.get("active_tenants"),
