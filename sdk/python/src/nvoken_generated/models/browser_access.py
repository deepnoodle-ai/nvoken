...
class BrowserAccess(BaseModel):
    ...
    invocation_webhook: BrowserInvocationWebhook
    limits: BrowserRateLimits
    __properties: ClassVar[List[str]] = ["allowed_origins", "invocation_webhook", "limits"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of invocation_webhook
        if self.invocation_webhook:
            _dict['invocation_webhook'] = self.invocation_webhook.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invocation_webhook": BrowserInvocationWebhook.from_dict(obj["invocation_webhook"]) if obj.get("invocation_webhook") is not None else None,
