...
class StructuredOutputProvenance(BaseModel):
    """
    Immutable proof that output equals the accepted reserved durable ToolCall request under the admitted schema digest.
    """ # noqa: E501
    source: StrictStr
    tool_call_id: Optional[Annotated[str, Field(strict=True)]] = None
