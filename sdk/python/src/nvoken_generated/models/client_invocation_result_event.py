...
class ClientInvocationResultEvent(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientInvocationResultEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientInvocationResultEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "result": ClientInvocationResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
