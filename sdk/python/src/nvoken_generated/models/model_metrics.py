...
class ModelMetrics(BaseModel):
    ...
    reported_model_calls: Annotated[int, Field(strict=True, ge=0)]
    failed_model_calls: Annotated[int, Field(strict=True, ge=0)]
    runtime_steps: Annotated[int, Field(strict=True, ge=0)] = Field(description="Model results durably committed to an Invocation transcript.")
    generation_calls: Annotated[int, Field(strict=True, ge=0)]
    compaction_calls: Annotated[int, Field(strict=True, ge=0)]
    direct_calls: Annotated[int, Field(strict=True, ge=0)]
    ...
    __properties: ClassVar[List[str]] = ["model_calls", "reported_model_calls", "failed_model_calls", "runtime_steps", "generation_calls", "compaction_calls", "direct_calls", "input_tokens", "output_tokens", "cache_creation_input_tokens", "cache_read_input_tokens", "reasoning_tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reported_model_calls": obj.get("reported_model_calls"),
            "failed_model_calls": obj.get("failed_model_calls"),
            "runtime_steps": obj.get("runtime_steps"),
            "generation_calls": obj.get("generation_calls"),
            "compaction_calls": obj.get("compaction_calls"),
            "direct_calls": obj.get("direct_calls"),
