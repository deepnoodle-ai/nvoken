...
class UserMemorySpaceSelector(BaseModel):
    """
    UserMemorySpaceSelector
    """ # noqa: E501
    scope: StrictStr
    user_key: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    namespace: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    __properties: ClassVar[List[str]] = ["scope", "user_key", "namespace"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserMemorySpaceSelector from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserMemorySpaceSelector from a dict"""
        if obj is None:
            return None
