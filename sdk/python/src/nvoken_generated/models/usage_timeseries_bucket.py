...
class UsageTimeseriesBucket(BaseModel):
    ...
    start_at: datetime
    end_at: datetime
    series_key: Optional[StrictStr] = None
    metrics: UsageMetrics
    __properties: ClassVar[List[str]] = ["start_at", "end_at", "series_key", "metrics"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsageTimeseriesBucket from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsageTimeseriesBucket from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metrics": UsageMetrics.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None
        })
        return _obj
