...
class MemorySpace(BaseModel):
    ...
    retention_ttl_seconds: Optional[Annotated[int, Field(strict=True, ge=1)]]
    expires_at: Optional[datetime] = Field(description="Immediate content-authority boundary when non-null and reached.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemorySpace from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if retention_ttl_seconds (nullable) is None
        # and model_fields_set contains the field
        if self.retention_ttl_seconds is None and "retention_ttl_seconds" in self.model_fields_set:
            _dict['retention_ttl_seconds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemorySpace from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "retention_ttl_seconds": obj.get("retention_ttl_seconds"),
