...
class InlineTurnBehaviorSource(BaseModel):
    """
    InlineTurnBehaviorSource
    """ # noqa: E501
    kind: StrictStr
    digest: Annotated[str, Field(strict=True)]
    __properties: ClassVar[List[str]] = ["kind", "digest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InlineTurnBehaviorSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InlineTurnBehaviorSource from a dict"""
        if obj is None:
            return None
