...
class ForkSessionOptions(BaseModel):
    """
    Creation-only options for a forked child. The child never inherits the source Session's compaction policy, retention, metadata, or authorization context — a fork is a creation moment, so supply what the child is bound to rather than letting it carry over.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["pinned_revision", "retention", "authorization_context"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ForkSessionOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ForkSessionOptions from a dict"""
        if obj is None:
            return None
