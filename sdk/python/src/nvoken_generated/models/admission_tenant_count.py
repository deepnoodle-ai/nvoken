...
class AdmissionTenantCount(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenant_key", "refusals", "last_refused_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdmissionTenantCount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdmissionTenantCount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "last_refused_at": obj.get("last_refused_at")
        })
        return _obj
