...
class AppRegistration(BaseModel):
    ...
    """ # noqa: E501
    app: App
    signing_keys: Annotated[List[AppSigningKeySecret], Field(min_length=2, max_length=2)] = Field(description="One callback key and one webhook key.")
    __properties: ClassVar[List[str]] = ["app", "signing_keys"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppRegistration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.signing_keys:
            ...
            _dict['signing_keys'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppRegistration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "signing_keys": [AppSigningKeySecret.from_dict(_item) for _item in obj["signing_keys"]] if obj.get("signing_keys") is not None else None
        })
        return _obj
