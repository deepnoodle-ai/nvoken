...
class InvocationTimeline(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["invocation_id", "session_id", "content_expires_at", "app_id", "tenant_key", "user_key", "agent_id", "accepted_at", "ended_at", "status", "stop_reason", "failure_code", "attempt_count", "active_execution_ms", "waiting_execution_ms", "erased_at", "steps"]
