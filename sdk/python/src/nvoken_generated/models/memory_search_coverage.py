...
class MemorySearchCoverage(BaseModel):
    ...
    """ # noqa: E501
    indexed_entries: Annotated[int, Field(strict=True, ge=0)]
    total_entries: Annotated[int, Field(strict=True, ge=0)]
    complete: StrictBool
    semantic_available: StrictBool
    __properties: ClassVar[List[str]] = ["indexed_entries", "total_entries", "complete", "semantic_available"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemorySearchCoverage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemorySearchCoverage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "indexed_entries": obj.get("indexed_entries"),
            "total_entries": obj.get("total_entries"),
            "complete": obj.get("complete"),
            "semantic_available": obj.get("semantic_available")
        })
        return _obj
