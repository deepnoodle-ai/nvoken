...
class BrowserRateLimits(BaseModel):
    """
    Browser-specific ceilings enforced at Invocation admission.
    """ # noqa: E501
    max_concurrent_invocations_per_tenant: Annotated[int, Field(strict=True, ge=1)]
    max_concurrent_invocations_per_user: Annotated[int, Field(strict=True, ge=1)]
    max_admissions_per_user_per_minute: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["max_concurrent_invocations_per_tenant", "max_concurrent_invocations_per_user", "max_admissions_per_user_per_minute"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserRateLimits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserRateLimits from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "max_admissions_per_user_per_minute": obj.get("max_admissions_per_user_per_minute")
        })
        return _obj
