...
class BrowserRateLimits(BaseModel):
    ...
    """ # noqa: E501
    max_concurrent_turns_per_tenant: Annotated[int, Field(strict=True, ge=1)]
    max_concurrent_turns_per_user: Annotated[int, Field(strict=True, ge=1)]
    max_admissions_per_user_per_minute: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["max_concurrent_turns_per_tenant", "max_concurrent_turns_per_user", "max_admissions_per_user_per_minute"]
