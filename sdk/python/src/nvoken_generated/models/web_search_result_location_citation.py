...
class WebSearchResultLocationCitation(BaseModel):
    """
    ...
    url: StrictStr
    title: StrictStr
    encrypted_index: Optional[StrictStr] = None
    cited_text: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "url", "title", "encrypted_index", "cited_text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSearchResultLocationCitation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSearchResultLocationCitation from a dict"""
        if obj is None:
            return None
