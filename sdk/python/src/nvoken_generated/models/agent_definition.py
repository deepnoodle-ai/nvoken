...
class AgentDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instructions", "model", "sampling", "reasoning", "tool_choice", "limits", "output_schema", "tools", "mcp_servers", "provider_tools", "client_interface"]
