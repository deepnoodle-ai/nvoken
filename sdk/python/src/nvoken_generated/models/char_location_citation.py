...
class CharLocationCitation(BaseModel):
    """
    A location inside one indexed input document.
    """ # noqa: E501
    type: StrictStr
    cited_text: Optional[StrictStr] = None
    document_index: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    document_title: Optional[StrictStr] = None
    start_char_index: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    end_char_index: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    __properties: ClassVar[List[str]] = ["type", "cited_text", "document_index", "document_title", "start_char_index", "end_char_index"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CharLocationCitation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CharLocationCitation from a dict"""
        if obj is None:
            return None
