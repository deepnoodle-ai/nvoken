...
class TenantAgentOwner(BaseModel):
    """
    TenantAgentOwner
    """ # noqa: E501
    kind: StrictStr
    tenant_key: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    __properties: ClassVar[List[str]] = ["kind", "tenant_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TenantAgentOwner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TenantAgentOwner from a dict"""
        if obj is None:
            return None
