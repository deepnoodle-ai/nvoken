...
class RotateProviderKeyRequest(BaseModel):
    ...
    overlap_seconds: Optional[Annotated[int, Field(le=3600, strict=True, ge=0)]] = 0
    idempotency_key: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    __properties: ClassVar[List[str]] = ["key", "expires_at", "overlap_seconds", "idempotency_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RotateProviderKeyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RotateProviderKeyRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "overlap_seconds": obj.get("overlap_seconds") if obj.get("overlap_seconds") is not None else 0,
