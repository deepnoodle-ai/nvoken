...
class UsageTimeseries(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["start_at", "end_at", "interval", "timezone", "group_by", "totals", "buckets"]
    ...
    def group_by_validate_enum(cls, value):
        ...
        if value not in set(['tenant_key', 'agent_id', 'model', 'tool_name', 'authentication_method']):
            raise ValueError("must be one of enum values ('tenant_key', 'agent_id', 'model', 'tool_name', 'authentication_method')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsageTimeseries from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsageTimeseries from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "totals": UsageMetrics.from_dict(obj["totals"]) if obj.get("totals") is not None else None,
            "buckets": [UsageTimeseriesBucket.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None
        })
        return _obj
