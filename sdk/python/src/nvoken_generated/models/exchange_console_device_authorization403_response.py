...
EXCHANGECONSOLEDEVICEAUTHORIZATION403RESPONSE_ONE_OF_SCHEMAS = ["ConsoleDeviceAuthorizationExchangeState", "ErrorResponse"]

class ExchangeConsoleDeviceAuthorization403Response(BaseModel):
    """
    ExchangeConsoleDeviceAuthorization403Response
    """
    # data type: ConsoleDeviceAuthorizationExchangeState
    oneof_schema_1_validator: Optional[ConsoleDeviceAuthorizationExchangeState] = None
    # data type: ErrorResponse
    oneof_schema_2_validator: Optional[ErrorResponse] = None
    actual_instance: Optional[Union[ConsoleDeviceAuthorizationExchangeState, ErrorResponse]] = None
    one_of_schemas: Set[str] = { "ConsoleDeviceAuthorizationExchangeState", "ErrorResponse" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ExchangeConsoleDeviceAuthorization403Response.model_construct()
        error_messages = []
        match = 0
        # validate data type: ConsoleDeviceAuthorizationExchangeState
        if not isinstance(v, ConsoleDeviceAuthorizationExchangeState):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ConsoleDeviceAuthorizationExchangeState`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ExchangeConsoleDeviceAuthorization403Response with oneOf schemas: ConsoleDeviceAuthorizationExchangeState, ErrorResponse. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ExchangeConsoleDeviceAuthorization403Response with oneOf schemas: ConsoleDeviceAuthorizationExchangeState, ErrorResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into ConsoleDeviceAuthorizationExchangeState
        try:
            instance.actual_instance = ConsoleDeviceAuthorizationExchangeState.from_json(json_str)
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ExchangeConsoleDeviceAuthorization403Response with oneOf schemas: ConsoleDeviceAuthorizationExchangeState, ErrorResponse. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ExchangeConsoleDeviceAuthorization403Response with oneOf schemas: ConsoleDeviceAuthorizationExchangeState, ErrorResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ConsoleDeviceAuthorizationExchangeState, ErrorResponse]]:
