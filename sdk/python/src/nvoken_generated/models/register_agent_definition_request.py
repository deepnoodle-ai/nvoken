...
class RegisterAgentDefinitionRequest(BaseModel):
    """
    One Agent Definition accepted by registration or nested under `agent_definition` during Invocation creation. The model string shorthand is accepted on write; the resolved Agent Definition returns object form.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegisterAgentDefinitionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegisterAgentDefinitionRequest from a dict"""
        if obj is None:
            return None
