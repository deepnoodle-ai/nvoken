...
class ModelMediaCapabilities(BaseModel):
    """
    ModelMediaCapabilities
    """ # noqa: E501
    image: ModelMediaKindCapabilities
    document: ModelMediaKindCapabilities
    __properties: ClassVar[List[str]] = ["image", "document"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelMediaCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelMediaCapabilities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "image": ModelMediaKindCapabilities.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "document": ModelMediaKindCapabilities.from_dict(obj["document"]) if obj.get("document") is not None else None
        })
        return _obj
