...
class RotateProviderCredentialRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["credential", "expires_at", "overlap_seconds", "idempotency_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RotateProviderCredentialRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RotateProviderCredentialRequest from a dict"""
        if obj is None:
            return None
