...
class App(BaseModel):
    ...
    external_ref: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(description="Opaque owner reference used to ground console issuer tokens. One reference may own many apps. ")
    ...
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "name", "external_ref", "display_name", "created_at"]
