...
class InvocationSessionOptions(BaseModel):
    """
    InvocationSessionOptions
    """ # noqa: E501
    pinned_revision: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    on_conflict: Optional[StrictStr] = Field(default='refuse', description="With `continue_or_create`, `join` accepts the stored conversation policies; `refuse` reports mismatches. ")
    __properties: ClassVar[List[str]] = ["pinned_revision", "on_conflict"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvocationSessionOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvocationSessionOptions from a dict"""
        if obj is None:
            return None
