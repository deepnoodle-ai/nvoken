...
class ModelUsage(BaseModel):
    ...
    iterations: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Model requests represented by this aggregate. Older retained evidence may omit it.")
    estimated_cost: Optional[ModelCost] = None
    __properties: ClassVar[List[str]] = ["input_tokens", "output_tokens", "cache_creation_input_tokens", "cache_read_input_tokens", "reasoning_tokens", "iterations", "estimated_cost"]
