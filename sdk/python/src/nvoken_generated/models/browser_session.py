...
class BrowserSession(BaseModel):
    ...
    active_invocation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Opaque identifier with the public `inv_` prefix. Treat the body as opaque.")
    active_invocation_status: Optional[StrictStr]
    created_at: datetime
    updated_at: datetime
    pending_tool_calls: Optional[List[PendingHostToolCall]] = None
    __properties: ClassVar[List[str]] = ["id", "active_invocation_id", "active_invocation_status", "created_at", "updated_at", "pending_tool_calls"]
