...
class MemoryList(BaseModel):
    ...
    search_coverage: MemorySearchCoverage
    has_more: StrictBool
    next_cursor: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["items", "search_coverage", "has_more", "next_cursor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemoryList from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.items:
            ...
            _dict['items'] = _items
        # override the default output from pydantic by calling `to_dict()` of search_coverage
        if self.search_coverage:
            _dict['search_coverage'] = self.search_coverage.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemoryList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [MemorySearchResult.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "search_coverage": MemorySearchCoverage.from_dict(obj["search_coverage"]) if obj.get("search_coverage") is not None else None,
