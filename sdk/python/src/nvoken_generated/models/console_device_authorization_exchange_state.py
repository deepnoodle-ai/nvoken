...
class ConsoleDeviceAuthorizationExchangeState(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['authorization_pending', 'slow_down', 'access_denied', 'expired_token']):
            raise ValueError("must be one of enum values ('authorization_pending', 'slow_down', 'access_denied', 'expired_token')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConsoleDeviceAuthorizationExchangeState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConsoleDeviceAuthorizationExchangeState from a dict"""
        if obj is None:
            return None
