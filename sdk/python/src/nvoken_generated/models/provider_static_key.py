...
class ProviderStaticKey(BaseModel):
    """
    ProviderStaticKey
    """ # noqa: E501
    api_key: Annotated[str, Field(min_length=1, strict=True, max_length=65536)] = Field(description="Encrypted before persistence and never returned.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderStaticKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderStaticKey from a dict"""
        if obj is None:
            return None
