...
from nvoken_generated.models.browser_invocation_accepted_event import BrowserInvocationAcceptedEvent
from nvoken_generated.models.browser_invocation_result_event import BrowserInvocationResultEvent
from nvoken_generated.models.browser_invocation_update_event import BrowserInvocationUpdateEvent
...
BROWSERINVOCATIONSTREAMEVENT_ONE_OF_SCHEMAS = ["BrowserInvocationAcceptedEvent", "BrowserInvocationResultEvent", "BrowserInvocationUpdateEvent", "OutputTextDeltaEvent", "StreamEndEvent", "StreamResyncEvent", "ThinkingDeltaEvent"]

class BrowserInvocationStreamEvent(BaseModel):
    """
    Browser Invocation stream event. Switch on `type`. Host-only fields are never emitted. New frame types may appear here over time, and existing ones may gain fields.
    """
    # data type: BrowserInvocationAcceptedEvent
    oneof_schema_1_validator: Optional[BrowserInvocationAcceptedEvent] = None
    ...
    # data type: BrowserInvocationUpdateEvent
    oneof_schema_4_validator: Optional[BrowserInvocationUpdateEvent] = None
    # data type: BrowserInvocationResultEvent
    oneof_schema_5_validator: Optional[BrowserInvocationResultEvent] = None
    ...
    actual_instance: Optional[Union[BrowserInvocationAcceptedEvent, BrowserInvocationResultEvent, BrowserInvocationUpdateEvent, OutputTextDeltaEvent, StreamEndEvent, StreamResyncEvent, ThinkingDeltaEvent]] = None
    one_of_schemas: Set[str] = { "BrowserInvocationAcceptedEvent", "BrowserInvocationResultEvent", "BrowserInvocationUpdateEvent", "OutputTextDeltaEvent", "StreamEndEvent", "StreamResyncEvent", "ThinkingDeltaEvent" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = BrowserInvocationStreamEvent.model_construct()
        error_messages = []
        match = 0
        # validate data type: BrowserInvocationAcceptedEvent
        if not isinstance(v, BrowserInvocationAcceptedEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BrowserInvocationAcceptedEvent`")
        else:
            match += 1
        ...
        if not isinstance(v, ThinkingDeltaEvent):
            ...
            match += 1
        # validate data type: BrowserInvocationUpdateEvent
        if not isinstance(v, BrowserInvocationUpdateEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BrowserInvocationUpdateEvent`")
        else:
            match += 1
        # validate data type: BrowserInvocationResultEvent
        if not isinstance(v, BrowserInvocationResultEvent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BrowserInvocationResultEvent`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in BrowserInvocationStreamEvent with oneOf schemas: BrowserInvocationAcceptedEvent, BrowserInvocationResultEvent, BrowserInvocationUpdateEvent, OutputTextDeltaEvent, StreamEndEvent, StreamResyncEvent, ThinkingDeltaEvent. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in BrowserInvocationStreamEvent with oneOf schemas: BrowserInvocationAcceptedEvent, BrowserInvocationResultEvent, BrowserInvocationUpdateEvent, OutputTextDeltaEvent, StreamEndEvent, StreamResyncEvent, ThinkingDeltaEvent. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into BrowserInvocationAcceptedEvent
        try:
            instance.actual_instance = BrowserInvocationAcceptedEvent.from_json(json_str)
            match += 1
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into BrowserInvocationUpdateEvent
        try:
            instance.actual_instance = BrowserInvocationUpdateEvent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BrowserInvocationResultEvent
        try:
            instance.actual_instance = BrowserInvocationResultEvent.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into BrowserInvocationStreamEvent with oneOf schemas: BrowserInvocationAcceptedEvent, BrowserInvocationResultEvent, BrowserInvocationUpdateEvent, OutputTextDeltaEvent, StreamEndEvent, StreamResyncEvent, ThinkingDeltaEvent. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BrowserInvocationAcceptedEvent, BrowserInvocationResultEvent, BrowserInvocationUpdateEvent, OutputTextDeltaEvent, StreamEndEvent, StreamResyncEvent, ThinkingDeltaEvent]]:
