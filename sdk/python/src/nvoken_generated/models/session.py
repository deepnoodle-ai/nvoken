...
class Session(BaseModel):
    ...
    user_key: Optional[StrictStr] = Field(default=None, description="Host-owned end-user label recorded when this Session was opened. Filtering only; not an isolation boundary. ")
