...
class StoredTurnBehaviorSource(BaseModel):
    """
    ...
    agent_revision_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Opaque AgentRevision identifier with the public `arev_` prefix. Treat the body as opaque.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StoredTurnBehaviorSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StoredTurnBehaviorSource from a dict"""
        if obj is None:
            return None
