...
class TurnLog(BaseModel):
    ...
    trace_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Lowercase W3C trace ID. Holding this value does not grant access.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TurnLog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TurnLog from a dict"""
        if obj is None:
            return None
