...
class MachineConcurrencyLimits(BaseModel):
    ...
    """ # noqa: E501
    max_concurrent_turns_per_tenant: Annotated[int, Field(strict=True, ge=1)] = Field(description="Maximum nonterminal Turns in the resolved tenant.")
    max_concurrent_turns_per_user: Annotated[int, Field(strict=True, ge=1)] = Field(description="Maximum nonterminal Turns for one user_key in the resolved tenant. Machine admissions without user_key are governed only by the tenant and App-wide ceilings. ")
    __properties: ClassVar[List[str]] = ["max_concurrent_turns_per_tenant", "max_concurrent_turns_per_user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "max_concurrent_turns_per_tenant": obj.get("max_concurrent_turns_per_tenant"),
            "max_concurrent_turns_per_user": obj.get("max_concurrent_turns_per_user")
        })
        return _obj
