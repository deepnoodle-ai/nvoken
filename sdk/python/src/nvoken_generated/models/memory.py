...
class Memory(BaseModel):
    ...
    Memory
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Opaque durable-memory identifier with the public `mem_` prefix.")
    ...
    key: Annotated[str, Field(min_length=1, strict=True, max_length=256)]
    kind: MemoryKind
    content: Annotated[str, Field(min_length=1, strict=True, max_length=16384)]
    summary: Optional[Annotated[str, Field(strict=True, max_length=140)]] = None
    metadata: Optional[Dict[str, Any]] = None
    importance: Annotated[int, Field(le=100, strict=True, ge=0)]
    pinned: StrictBool
    ...
    __properties: ClassVar[List[str]] = ["id", "agent_id", "tenant_key", "user_key", "key", "kind", "content", "summary", "metadata", "importance", "pinned", "version", "last_accessed_at", "created_at", "updated_at"]
