...
class Turn(BaseModel):
    ...
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Opaque identifier with the public `turn_` prefix. Treat the body as opaque.")
    ...
    conversation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="Null for a standalone Turn.")
