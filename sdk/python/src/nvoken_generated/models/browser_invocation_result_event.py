...
class BrowserInvocationResultEvent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "session_id", "invocation_id", "result"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['invocation.result']):
            raise ValueError("must be one of enum values ('invocation.result')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserInvocationResultEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserInvocationResultEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "result": BrowserInvocationResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
