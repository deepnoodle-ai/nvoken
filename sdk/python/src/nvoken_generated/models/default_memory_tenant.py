...
class DefaultMemoryTenant(BaseModel):
    """
    DefaultMemoryTenant
    """ # noqa: E501
    default_scope: StrictStr
    namespace: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = None
    __properties: ClassVar[List[str]] = ["default_scope", "namespace"]

    @field_validator('default_scope')
    def default_scope_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultMemoryTenant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultMemoryTenant from a dict"""
        if obj is None:
            return None
