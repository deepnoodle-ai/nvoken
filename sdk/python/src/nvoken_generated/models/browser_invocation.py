...
class BrowserInvocation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "session_id", "agent_definition_id", "agent_definition_revision", "deduplicated", "status", "stop_reason", "attempt", "error", "structured_output", "active_execution_ms", "deadline_at", "created_at", "updated_at", "ended_at", "pending_tool_calls", "tool_calls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserInvocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserInvocation from a dict"""
        if obj is None:
            return None
