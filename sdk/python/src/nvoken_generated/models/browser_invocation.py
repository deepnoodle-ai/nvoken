...
class BrowserInvocation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "session_id", "agent_definition_id", "agent_definition_revision", "deduplicated", "status", "stop_reason", "attempt", "error", "structured_output", "active_execution_ms", "deadline_at", "created_at", "updated_at", "ended_at", "tool_calls"]
