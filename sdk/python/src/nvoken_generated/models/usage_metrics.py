...
class UsageMetrics(BaseModel):
    ...
    tools: ToolMetrics
    cost: CostMetrics
    __properties: ClassVar[List[str]] = ["activity", "model", "tools", "cost"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": ModelMetrics.from_dict(obj["model"]) if obj.get("model") is not None else None,
            "tools": ToolMetrics.from_dict(obj["tools"]) if obj.get("tools") is not None else None,
            "cost": CostMetrics.from_dict(obj["cost"]) if obj.get("cost") is not None else None
        })
        return _obj
