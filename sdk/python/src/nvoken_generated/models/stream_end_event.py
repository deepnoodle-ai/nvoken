...
class StreamEndEvent(BaseModel):
    ...
    invocation_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="The Invocation this connection was following, or null on a Session stream. ")
    reason: StreamEndReason
    resume_cursor: Annotated[str, Field(min_length=1, strict=True)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "session_id", "invocation_id", "reason", "resume_cursor"]
