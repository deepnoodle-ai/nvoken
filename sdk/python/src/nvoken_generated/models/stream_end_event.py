...
class StreamEndEvent(BaseModel):
    ...
    reason: StrictStr = Field(description="`rotate` means the server is cycling the connection — reconnect with your last `resume_cursor`. `terminal` means there is nothing more coming: the turn finished, or for a Session stream, nothing is running any more. ")
