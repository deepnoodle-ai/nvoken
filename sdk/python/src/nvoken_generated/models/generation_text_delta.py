...
class GenerationTextDelta(BaseModel):
    """
    GenerationTextDelta
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["content_index", "type", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerationTextDelta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerationTextDelta from a dict"""
        if obj is None:
            return None
