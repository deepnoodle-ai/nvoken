...
class ModelReasoningEffortCapabilities(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["supported", "values", "with_temperature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelReasoningEffortCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelReasoningEffortCapabilities from a dict"""
        if obj is None:
            return None
