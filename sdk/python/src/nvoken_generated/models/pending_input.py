...
class PendingInput(BaseModel):
    ...
    PendingInput
    """ # noqa: E501
    id: Annotated[str, Field(strict=True)] = Field(description="UUIDv7 with the public `npin_` prefix.")
    ...
    drained_message_sequence: Optional[StrictInt] = Field(default=None, description="Transcript sequence the content was promoted into. Present only on a drained input, and the receipt that the model saw it. ")
    settled_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "invocation_id", "status", "content", "idempotency_key", "created_at", "drained_at", "drained_message_sequence", "settled_at"]
    ...
    def id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^npin_[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$", value):
            raise ValueError(r"must validate the regular expression /^npin_[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PendingInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PendingInput from a dict"""
        if obj is None:
            return None
