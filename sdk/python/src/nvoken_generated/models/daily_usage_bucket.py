...
class DailyUsageBucket(BaseModel):
    ...
    tenant_key: Optional[StrictStr] = Field(default=None, description="Host tenant group when `group_by=tenant_key`; omitted otherwise.")
    ...
    estimated_cost_usd: Union[StrictFloat, StrictInt] = Field(description="Summed list-price estimate in USD; zero when every call in the bucket was unpriced.")
    __properties: ClassVar[List[str]] = ["day", "app_id", "tenant_key", "provider", "model", "invocations", "model_calls", "input_tokens", "output_tokens", "cache_creation_input_tokens", "cache_read_input_tokens", "reasoning_tokens", "estimated_cost_usd"]
