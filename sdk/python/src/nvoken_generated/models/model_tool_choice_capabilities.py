...
class ModelToolChoiceCapabilities(BaseModel):
    """
    ModelToolChoiceCapabilities
    """ # noqa: E501
    modes: Annotated[List[ModelToolChoiceMode], Field(min_length=1)]
    with_reasoning: Annotated[List[ModelToolChoiceMode], Field(min_length=1)] = Field(description="Modes that remain exact when explicit reasoning is active.")
    __properties: ClassVar[List[str]] = ["modes", "with_reasoning"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelToolChoiceCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelToolChoiceCapabilities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "modes": obj.get("modes"),
            "with_reasoning": obj.get("with_reasoning")
        })
        return _obj
