...
class BrowserInvocationUpdateEvent(BaseModel):
    """
    ...
    new_messages: List[BrowserSessionMessage]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserInvocationUpdateEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserInvocationUpdateEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "invocation": BrowserInvocation.from_dict(obj["invocation"]) if obj.get("invocation") is not None else None,
            "new_messages": [BrowserSessionMessage.from_dict(_item) for _item in obj["new_messages"]] if obj.get("new_messages") is not None else None
        })
