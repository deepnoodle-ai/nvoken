...
class Reasoning(BaseModel):
    ...
    budget_tokens: Optional[Annotated[int, Field(strict=True, ge=1024)]] = Field(default=None, description="Provider reasoning target, not a separate Turn hard budget. Requires an explicit, larger limits.max_output_tokens and exact support in the selected model descriptor. ")
