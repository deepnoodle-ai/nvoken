...
class ServerToolUseBlock(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The provider's own ID for a tool it ran itself, such as web search. This is not a ToolCall ID: you never send a result for it, and it never appears in your pending tool calls. It is here so you can show the user what the model looked up. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServerToolUseBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServerToolUseBlock from a dict"""
        if obj is None:
            return None
