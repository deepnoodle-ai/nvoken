...
class CreateCredentialRequest(BaseModel):
    ...
    app_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Target App for an app-less Operator provisioning an app credential. Omit to issue another app-less credential. An app-bound Operator may omit this field or repeat its own App ID, but cannot name a different App. ")
    ...
    __properties: ClassVar[List[str]] = ["name", "profile", "app_id", "tenant_key", "session_id", "operations", "expires_at"]
