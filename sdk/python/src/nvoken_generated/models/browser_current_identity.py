...
from nvoken_generated.models.browser_current_identity_authentication import BrowserCurrentIdentityAuthentication
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class BrowserCurrentIdentity(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserCurrentIdentity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserCurrentIdentity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "authentication": BrowserCurrentIdentityAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None
        })
