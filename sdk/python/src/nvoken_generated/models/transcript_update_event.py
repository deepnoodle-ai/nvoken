...
class TranscriptUpdateEvent(BaseModel):
    ...
    has_more: StrictBool = Field(description="Whether saved rows past `cursor` were already known when this page was cut, so the next `transcript.update` follows without waiting for new work. `false` means you are caught up as of this frame. ")
    ...
    __properties: ClassVar[List[str]] = ["type", "messages", "turn_changes", "has_more", "cursor"]
