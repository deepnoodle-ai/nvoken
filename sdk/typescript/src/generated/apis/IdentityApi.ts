...
import {
    ...
    CurrentIdentityResponseFromJSON,
    CurrentIdentityResponseToJSON,
} from '../models/CurrentIdentityResponse.js';
import {
    type ErrorResponse,
...
export class IdentityApi extends runtime.BaseAPI {
     ...
     */
    async getCurrentIdentityRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrentIdentityResponse>> {
        const requestOptions = await this.getCurrentIdentityRequestOpts();
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CurrentIdentityResponseFromJSON(jsonValue));
    }

    /**
     * Explain the authenticated caller
     */
    async getCurrentIdentity(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrentIdentityResponse> {
