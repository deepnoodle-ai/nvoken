...
export class TurnsApi extends runtime.BaseAPI {
     ...
     */
    async streamTurnRaw(requestParameters: StreamTurnRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StreamEvent>> {
     ...
     * Follow one Turn over Server-Sent Events
     */
    async streamTurn(requestParameters: StreamTurnRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StreamEvent> {
