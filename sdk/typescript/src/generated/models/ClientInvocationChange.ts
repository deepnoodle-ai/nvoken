 ...
 *
 * @export
 * @interface ClientInvocationChange
 */
export interface ClientInvocationChange {
    /**
     * Opaque identifier with the public `inv_` prefix. Treat the body as opaque.
     * @type {string}
     * @memberof ClientInvocationChange
     */
    invocationId: string;
    /**
     *
...
/**
 * Check if a given object implements the ClientInvocationChange interface.
 */
export function instanceOfClientInvocationChange(value: object): value is ClientInvocationChange {
...
export function ClientInvocationChangeFromJSON(json: any): ClientInvocationChange {
    return ClientInvocationChangeFromJSONTyped(json, false);
}

export function ClientInvocationChangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationChange {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientInvocationChangeToJSON(json: any): ClientInvocationChange {
    return ClientInvocationChangeToJSONTyped(json, false);
}

export function ClientInvocationChangeToJSONTyped(value?: ClientInvocationChange | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
