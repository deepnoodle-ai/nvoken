...
export function instanceOfReasoningEffort(value: any): boolean {
    for (const key in ReasoningEffort) {
        if (Object.prototype.hasOwnProperty.call(ReasoningEffort, key)) {
            if (ReasoningEffort[key as keyof typeof ReasoningEffort] === value) {
                return true;
            }
        }
    }
...
export function ReasoningEffortFromJSON(json: any): ReasoningEffort {
    return ReasoningEffortFromJSONTyped(json, false);
}

export function ReasoningEffortFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReasoningEffort {
    return json as ReasoningEffort;
}

export function ReasoningEffortToJSON(value?: ReasoningEffort | null): any {
    return value as any;
}

export function ReasoningEffortToJSONTyped(value: any, ignoreDiscriminator: boolean): ReasoningEffort {
