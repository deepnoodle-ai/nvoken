 ...
 * @export
 */
export const ConsoleDeviceAuthorizationStatus = {
    Pending: 'pending',
    Approved: 'approved',
    Denied: 'denied'
} as const;
export type ConsoleDeviceAuthorizationStatus = typeof ConsoleDeviceAuthorizationStatus[keyof typeof ConsoleDeviceAuthorizationStatus];


export function instanceOfConsoleDeviceAuthorizationStatus(value: any): boolean {
    for (const key in ConsoleDeviceAuthorizationStatus) {
        if (Object.prototype.hasOwnProperty.call(ConsoleDeviceAuthorizationStatus, key)) {
            if (ConsoleDeviceAuthorizationStatus[key as keyof typeof ConsoleDeviceAuthorizationStatus] === value) {
                return true;
            }
        }
    }
...
export function ConsoleDeviceAuthorizationStatusFromJSON(json: any): ConsoleDeviceAuthorizationStatus {
    return ConsoleDeviceAuthorizationStatusFromJSONTyped(json, false);
}

export function ConsoleDeviceAuthorizationStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsoleDeviceAuthorizationStatus {
    return json as ConsoleDeviceAuthorizationStatus;
}

export function ConsoleDeviceAuthorizationStatusToJSON(value?: ConsoleDeviceAuthorizationStatus | null): any {
    return value as any;
}

export function ConsoleDeviceAuthorizationStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): ConsoleDeviceAuthorizationStatus {
    return value as ConsoleDeviceAuthorizationStatus;
}
