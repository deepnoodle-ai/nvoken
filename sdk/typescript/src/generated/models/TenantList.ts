...
/**
 * Check if a given object implements the TenantList interface.
 */
export function instanceOfTenantList(value: object): value is TenantList {
...
export function TenantListToJSON(json: any): TenantList {
    return TenantListToJSONTyped(json, false);
}

export function TenantListToJSONTyped(value?: TenantList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
