...
import type { ClientTranscriptStreamEvent } from './ClientTranscriptStreamEvent.js';
import {
    ClientTranscriptStreamEventFromJSON,
    ClientTranscriptStreamEventFromJSONTyped,
    ClientTranscriptStreamEventToJSON,
} from './ClientTranscriptStreamEvent.js';
 ...
 * @export
 */
export type TranscriptStreamResponse = ClientTranscriptStreamEvent | TranscriptStreamEvent;
...
export function TranscriptStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscriptStreamResponse {
    ...
    if (false) {
        return ClientTranscriptStreamEventFromJSONTyped(json, true);
    }
    if (true) {
...
export function TranscriptStreamResponseToJSONTyped(value?: TranscriptStreamResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return ClientTranscriptStreamEventToJSON(value as ClientTranscriptStreamEvent);
    }
    if (true) {
