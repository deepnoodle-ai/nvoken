...
import type { BrowserTranscriptStreamEvent } from './BrowserTranscriptStreamEvent.js';
import {
    BrowserTranscriptStreamEventFromJSON,
    BrowserTranscriptStreamEventFromJSONTyped,
    BrowserTranscriptStreamEventToJSON,
} from './BrowserTranscriptStreamEvent.js';
import type { TranscriptStreamEvent } from './TranscriptStreamEvent.js';
import {
    TranscriptStreamEventFromJSON,
    TranscriptStreamEventFromJSONTyped,
    TranscriptStreamEventToJSON,
} from './TranscriptStreamEvent.js';
 ...
 * @export
 */
export type TranscriptStreamResponse = BrowserTranscriptStreamEvent | TranscriptStreamEvent;

export function TranscriptStreamResponseFromJSON(json: any): TranscriptStreamResponse {
    return TranscriptStreamResponseFromJSONTyped(json, false);
}

export function TranscriptStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscriptStreamResponse {
    if (json == null) {
        return json;
    }
    ...
    if (false) {
        return BrowserTranscriptStreamEventFromJSONTyped(json, true);
    }
    if (true) {
        return TranscriptStreamEventFromJSONTyped(json, true);
    }
    return {} as any;
}

export function TranscriptStreamResponseToJSON(json: any): any {
    return TranscriptStreamResponseToJSONTyped(json, false);
}

export function TranscriptStreamResponseToJSONTyped(value?: TranscriptStreamResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (false) {
        return BrowserTranscriptStreamEventToJSON(value as BrowserTranscriptStreamEvent);
    }
    if (true) {
        return TranscriptStreamEventToJSON(value as TranscriptStreamEvent);
    }
    return {};
}
