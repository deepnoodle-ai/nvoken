 ...
 *
 * @export
 * @interface CreateConsoleDeviceAuthorizationRequest
 */
export interface CreateConsoleDeviceAuthorizationRequest {
    /**
     *
     * @type {string}
     * @memberof CreateConsoleDeviceAuthorizationRequest
     */
    label: string;
}

/**
 * Check if a given object implements the CreateConsoleDeviceAuthorizationRequest interface.
 */
export function instanceOfCreateConsoleDeviceAuthorizationRequest(value: object): value is CreateConsoleDeviceAuthorizationRequest {
    if (!('label' in value) || value['label'] === undefined) return false;
    return true;
}

export function CreateConsoleDeviceAuthorizationRequestFromJSON(json: any): CreateConsoleDeviceAuthorizationRequest {
    return CreateConsoleDeviceAuthorizationRequestFromJSONTyped(json, false);
}

export function CreateConsoleDeviceAuthorizationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateConsoleDeviceAuthorizationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateConsoleDeviceAuthorizationRequestToJSON(json: any): CreateConsoleDeviceAuthorizationRequest {
    return CreateConsoleDeviceAuthorizationRequestToJSONTyped(json, false);
}

export function CreateConsoleDeviceAuthorizationRequestToJSONTyped(value?: CreateConsoleDeviceAuthorizationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
