...
import type { MemoryContextMode } from './MemoryContextMode.js';
import {
    MemoryContextModeFromJSON,
    MemoryContextModeFromJSONTyped,
    MemoryContextModeToJSON,
    MemoryContextModeToJSONTyped,
} from './MemoryContextMode.js';
...
/**
 * Check if a given object implements the MemoryContextConfig interface.
 */
export function instanceOfMemoryContextConfig(value: object): value is MemoryContextConfig {
    return true;
}

export function MemoryContextConfigFromJSON(json: any): MemoryContextConfig {
    return MemoryContextConfigFromJSONTyped(json, false);
}

export function MemoryContextConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemoryContextConfig {
    if (json == null) {
        return json;
    }
    return {

        'mode': json['mode'] == null ? undefined : MemoryContextModeFromJSON(json['mode']),
        'maxBytes': json['max_bytes'] == null ? undefined : json['max_bytes'],
    };
}

export function MemoryContextConfigToJSON(json: any): MemoryContextConfig {
    return MemoryContextConfigToJSONTyped(json, false);
}

export function MemoryContextConfigToJSONTyped(value?: MemoryContextConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'mode': MemoryContextModeToJSON(value['mode']),
