 ...
 * @export
 */
export type AgentRevisionSelector = number | string;

export function AgentRevisionSelectorFromJSON(json: any): AgentRevisionSelector {
    return AgentRevisionSelectorFromJSONTyped(json, false);
}

export function AgentRevisionSelectorFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentRevisionSelector {
    if (json == null) {
        return json;
    }
    if (typeof json === 'string' && (json === 'current')) {
        return json;
    }
...
export function AgentRevisionSelectorToJSON(json: any): any {
    return AgentRevisionSelectorToJSONTyped(json, false);
}

export function AgentRevisionSelectorToJSONTyped(value?: AgentRevisionSelector | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
