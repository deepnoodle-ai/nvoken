...
/**
 * Public transcript content without Agent/user identity, runtime phase, copy origin, or host provenance.
 * @export
...
export interface BrowserSessionMessage {
     ...
     * @type {string}
     * @memberof BrowserSessionMessage
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the BrowserSessionMessage interface.
 */
export function instanceOfBrowserSessionMessage(value: object): value is BrowserSessionMessage {
...
export function BrowserSessionMessageFromJSON(json: any): BrowserSessionMessage {
    return BrowserSessionMessageFromJSONTyped(json, false);
}

export function BrowserSessionMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserSessionMessage {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserSessionMessageToJSON(json: any): BrowserSessionMessage {
    return BrowserSessionMessageToJSONTyped(json, false);
}

export function BrowserSessionMessageToJSONTyped(value?: BrowserSessionMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
