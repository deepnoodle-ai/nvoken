...
import type { AgentOwnerKind } from './AgentOwnerKind.js';
import {
    AgentOwnerKindFromJSON,
    AgentOwnerKindFromJSONTyped,
    AgentOwnerKindToJSON,
    AgentOwnerKindToJSONTyped,
} from './AgentOwnerKind.js';
import type { AgentRevisionSelector } from './AgentRevisionSelector.js';
import {
    AgentRevisionSelectorFromJSON,
    AgentRevisionSelectorFromJSONTyped,
    AgentRevisionSelectorToJSON,
    AgentRevisionSelectorToJSONTyped,
} from './AgentRevisionSelector.js';

/**
 * Tenant and user owner coordinates come from this Turn's request scope.
 * @export
 * @interface AgentSelectorByKey
 */
export interface AgentSelectorByKey {
    /**
     *
     * @type {AgentOwnerKind}
     * @memberof AgentSelectorByKey
     */
...
/**
 * Check if a given object implements the AgentSelectorByKey interface.
 */
export function instanceOfAgentSelectorByKey(value: object): value is AgentSelectorByKey {
    if (!('ownerKind' in value) || value['ownerKind'] === undefined) return false;
    if (!('agentKey' in value) || value['agentKey'] === undefined) return false;
    if (!('revision' in value) || value['revision'] === undefined) return false;
    return true;
}

export function AgentSelectorByKeyFromJSON(json: any): AgentSelectorByKey {
    return AgentSelectorByKeyFromJSONTyped(json, false);
}

export function AgentSelectorByKeyFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentSelectorByKey {
    if (json == null) {
        return json;
    }
    return {

        'ownerKind': AgentOwnerKindFromJSON(json['owner_kind']),
        'agentKey': json['agent_key'],
        'revision': AgentRevisionSelectorFromJSON(json['revision']),
    };
}

export function AgentSelectorByKeyToJSON(json: any): AgentSelectorByKey {
    return AgentSelectorByKeyToJSONTyped(json, false);
}

export function AgentSelectorByKeyToJSONTyped(value?: AgentSelectorByKey | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'owner_kind': AgentOwnerKindToJSON(value['ownerKind']),
        'agent_key': value['agentKey'],
        'revision': AgentRevisionSelectorToJSON(value['revision']),
    };
}
