...
export function instanceOfBudgetScope(value: any): boolean {
    for (const key in BudgetScope) {
        if (Object.prototype.hasOwnProperty.call(BudgetScope, key)) {
            if (BudgetScope[key as keyof typeof BudgetScope] === value) {
                return true;
            }
        }
    }
...
export function BudgetScopeFromJSON(json: any): BudgetScope {
    return BudgetScopeFromJSONTyped(json, false);
}

export function BudgetScopeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BudgetScope {
    return json as BudgetScope;
}

export function BudgetScopeToJSON(value?: BudgetScope | null): any {
    return value as any;
}

export function BudgetScopeToJSONTyped(value: any, ignoreDiscriminator: boolean): BudgetScope {
