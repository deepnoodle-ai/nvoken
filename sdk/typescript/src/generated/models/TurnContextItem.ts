...
export interface TurnContextItem {
     ...
     *
     * @type {TurnContextItemTierEnum}
     * @memberof TurnContextItem
     */
    tier: TurnContextItemTierEnum;
    /**
 ...
 * @export
 */
export const TurnContextItemTierEnum = {
    Contextual: 'contextual',
    Operator: 'operator'
} as const;
export type TurnContextItemTierEnum = typeof TurnContextItemTierEnum[keyof typeof TurnContextItemTierEnum];


/**
 * Check if a given object implements the TurnContextItem interface.
 */
export function instanceOfTurnContextItem(value: object): value is TurnContextItem {
...
export function TurnContextItemFromJSON(json: any): TurnContextItem {
    return TurnContextItemFromJSONTyped(json, false);
}

export function TurnContextItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnContextItem {
    if (json == null) {
        return json;
    }
    return {
...
export function TurnContextItemToJSON(json: any): TurnContextItem {
    return TurnContextItemToJSONTyped(json, false);
}

export function TurnContextItemToJSONTyped(value?: TurnContextItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
