 ...
 *
 * @export
 * @interface InlineTurnBehaviorSource
 */
export interface InlineTurnBehaviorSource {
    /**
     *
     * @type {InlineTurnBehaviorSourceKindEnum}
     * @memberof InlineTurnBehaviorSource
     */
    kind: InlineTurnBehaviorSourceKindEnum;
    /**
     *
     * @type {string}
     * @memberof InlineTurnBehaviorSource
 ...
 * @export
 */
export const InlineTurnBehaviorSourceKindEnum = {
    Inline: 'inline'
} as const;
export type InlineTurnBehaviorSourceKindEnum = typeof InlineTurnBehaviorSourceKindEnum[keyof typeof InlineTurnBehaviorSourceKindEnum];


/**
 * Check if a given object implements the InlineTurnBehaviorSource interface.
 */
export function instanceOfInlineTurnBehaviorSource(value: object): value is InlineTurnBehaviorSource {
    if (!('kind' in value) || value['kind'] === undefined) return false;
    if (!('digest' in value) || value['digest'] === undefined) return false;
    return true;
}

export function InlineTurnBehaviorSourceFromJSON(json: any): InlineTurnBehaviorSource {
    return InlineTurnBehaviorSourceFromJSONTyped(json, false);
}

export function InlineTurnBehaviorSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineTurnBehaviorSource {
    if (json == null) {
        return json;
    }
    return {
...
export function InlineTurnBehaviorSourceToJSON(json: any): InlineTurnBehaviorSource {
    return InlineTurnBehaviorSourceToJSONTyped(json, false);
}

export function InlineTurnBehaviorSourceToJSONTyped(value?: InlineTurnBehaviorSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
