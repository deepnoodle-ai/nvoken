...
import type { ClientInvocationAcceptedEvent } from './ClientInvocationAcceptedEvent.js';
import {
    instanceOfClientInvocationAcceptedEvent,
    ClientInvocationAcceptedEventFromJSON,
    ClientInvocationAcceptedEventFromJSONTyped,
    ClientInvocationAcceptedEventToJSON,
} from './ClientInvocationAcceptedEvent.js';
import type { ClientInvocationResultEvent } from './ClientInvocationResultEvent.js';
import {
    instanceOfClientInvocationResultEvent,
    ClientInvocationResultEventFromJSON,
    ClientInvocationResultEventFromJSONTyped,
    ClientInvocationResultEventToJSON,
} from './ClientInvocationResultEvent.js';
import type { ClientInvocationUpdateEvent } from './ClientInvocationUpdateEvent.js';
import {
    instanceOfClientInvocationUpdateEvent,
    ClientInvocationUpdateEventFromJSON,
    ClientInvocationUpdateEventFromJSONTyped,
    ClientInvocationUpdateEventToJSON,
} from './ClientInvocationUpdateEvent.js';
...
/**
 * @type ClientInvocationStreamEvent
 * Browser Invocation stream event. Thinking previews and host-only fields are never emitted.
 * @export
 */
export type ClientInvocationStreamEvent = ClientInvocationAcceptedEvent | ClientInvocationResultEvent | ClientInvocationUpdateEvent | OutputTextDeltaEvent | StreamEndEvent | StreamResyncEvent;

export function ClientInvocationStreamEventFromJSON(json: any): ClientInvocationStreamEvent {
    return ClientInvocationStreamEventFromJSONTyped(json, false);
}

export function ClientInvocationStreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationStreamEvent {
    if (json == null) {
        return json;
    }
    ...
    if (instanceOfClientInvocationAcceptedEvent(json)) {
        return ClientInvocationAcceptedEventFromJSONTyped(json, true);
    }
    if (instanceOfClientInvocationResultEvent(json)) {
        return ClientInvocationResultEventFromJSONTyped(json, true);
    }
    if (instanceOfClientInvocationUpdateEvent(json)) {
        return ClientInvocationUpdateEventFromJSONTyped(json, true);
    }
...
export function ClientInvocationStreamEventToJSON(json: any): any {
    return ClientInvocationStreamEventToJSONTyped(json, false);
}

export function ClientInvocationStreamEventToJSONTyped(value?: ClientInvocationStreamEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfClientInvocationAcceptedEvent(value)) {
        return ClientInvocationAcceptedEventToJSON(value as ClientInvocationAcceptedEvent);
    }
    if (instanceOfClientInvocationResultEvent(value)) {
        return ClientInvocationResultEventToJSON(value as ClientInvocationResultEvent);
    }
    if (instanceOfClientInvocationUpdateEvent(value)) {
        return ClientInvocationUpdateEventToJSON(value as ClientInvocationUpdateEvent);
    }
