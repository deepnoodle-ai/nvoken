...
import {
    SessionCompactionFromJSON,
    SessionCompactionFromJSONTyped,
    SessionCompactionToJSON,
    SessionCompactionToJSONTyped,
} from './SessionCompaction.js';

/**
 *
 * @export
 * @interface SessionCompactionList
 */
export interface SessionCompactionList {
    /**
     *
     * @type {Array<SessionCompaction>}
     * @memberof SessionCompactionList
     */
    items: Array<SessionCompaction>;
    /**
     *
     * @type {boolean}
     * @memberof SessionCompactionList
...
/**
 * Check if a given object implements the SessionCompactionList interface.
 */
export function instanceOfSessionCompactionList(value: object): value is SessionCompactionList {
...
export function SessionCompactionListFromJSON(json: any): SessionCompactionList {
    return SessionCompactionListFromJSONTyped(json, false);
}

export function SessionCompactionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionCompactionList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(SessionCompactionFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function SessionCompactionListToJSON(json: any): SessionCompactionList {
    return SessionCompactionListToJSONTyped(json, false);
}

export function SessionCompactionListToJSONTyped(value?: SessionCompactionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(SessionCompactionToJSON)),
