...
/**
 * Exact durable budget that refused or paused work.
 * @export
...
export interface BudgetBlock {
     ...
     * @type {string}
     * @memberof BudgetBlock
     */
    id: string;
    /**
     *
     * @type {BudgetBlockScopeEnum}
     * @memberof BudgetBlock
     */
    scope: BudgetBlockScopeEnum;
}
 ...
 * @export
 */
export const BudgetBlockScopeEnum = {
    App: 'app',
    Customer: 'customer',
    User: 'user',
    Agent: 'agent',
...
export type BudgetBlockScopeEnum = typeof BudgetBlockScopeEnum[keyof typeof BudgetBlockScopeEnum];


/**
 * Check if a given object implements the BudgetBlock interface.
 */
export function instanceOfBudgetBlock(value: object): value is BudgetBlock {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('scope' in value) || value['scope'] === undefined) return false;
    return true;
}

export function BudgetBlockFromJSON(json: any): BudgetBlock {
    return BudgetBlockFromJSONTyped(json, false);
}

export function BudgetBlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): BudgetBlock {
    if (json == null) {
        return json;
    }
    return {
...
export function BudgetBlockToJSON(json: any): BudgetBlock {
    return BudgetBlockToJSONTyped(json, false);
}

export function BudgetBlockToJSONTyped(value?: BudgetBlock | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
