...
/**
 * Check if a given object implements the ConversationMessageList interface.
 */
export function instanceOfConversationMessageList(value: object): value is ConversationMessageList {
...
export function ConversationMessageListFromJSON(json: any): ConversationMessageList {
    return ConversationMessageListFromJSONTyped(json, false);
}

export function ConversationMessageListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationMessageList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ConversationMessageFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function ConversationMessageListToJSON(json: any): ConversationMessageList {
    return ConversationMessageListToJSONTyped(json, false);
}

export function ConversationMessageListToJSONTyped(value?: ConversationMessageList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ConversationMessageToJSON)),
