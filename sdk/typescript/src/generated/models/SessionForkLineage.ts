...
/**
 * Check if a given object implements the SessionForkLineage interface.
 */
export function instanceOfSessionForkLineage(value: object): value is SessionForkLineage {
    if (!('session' in value) || value['session'] === undefined) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function SessionForkLineageFromJSON(json: any): SessionForkLineage {
    return SessionForkLineageFromJSONTyped(json, false);
}

export function SessionForkLineageFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionForkLineage {
    if (json == null) {
        return json;
    }
    return {
...
export function SessionForkLineageToJSON(json: any): SessionForkLineage {
    return SessionForkLineageToJSONTyped(json, false);
}

export function SessionForkLineageToJSONTyped(value?: SessionForkLineage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
