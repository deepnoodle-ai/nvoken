...
import type { AgentSelectorByID } from './AgentSelectorByID.js';
import {
    instanceOfAgentSelectorByID,
    AgentSelectorByIDFromJSON,
    AgentSelectorByIDFromJSONTyped,
    AgentSelectorByIDToJSON,
} from './AgentSelectorByID.js';
import type { AgentSelectorByKey } from './AgentSelectorByKey.js';
import {
    instanceOfAgentSelectorByKey,
    AgentSelectorByKeyFromJSON,
    AgentSelectorByKeyFromJSONTyped,
    AgentSelectorByKeyToJSON,
} from './AgentSelectorByKey.js';
 ...
 * @export
 */
export type AgentSelector = AgentSelectorByID | AgentSelectorByKey;

export function AgentSelectorFromJSON(json: any): AgentSelector {
    return AgentSelectorFromJSONTyped(json, false);
}

export function AgentSelectorFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentSelector {
    if (json == null) {
        return json;
    }
    ...
    if (instanceOfAgentSelectorByID(json)) {
        return AgentSelectorByIDFromJSONTyped(json, true);
    }
    if (instanceOfAgentSelectorByKey(json)) {
        return AgentSelectorByKeyFromJSONTyped(json, true);
    }
    return {} as any;
}

export function AgentSelectorToJSON(json: any): any {
    return AgentSelectorToJSONTyped(json, false);
}

export function AgentSelectorToJSONTyped(value?: AgentSelector | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfAgentSelectorByID(value)) {
        return AgentSelectorByIDToJSON(value as AgentSelectorByID);
    }
    if (instanceOfAgentSelectorByKey(value)) {
        return AgentSelectorByKeyToJSON(value as AgentSelectorByKey);
    }
    return {};
}
