 ...
 * @export
 * @interface TurnChildCounts
 */
export interface TurnChildCounts {
    /**
     *
     * @type {number}
     * @memberof TurnChildCounts
     */
    total: number;
    /**
...
/**
 * Check if a given object implements the TurnChildCounts interface.
 */
export function instanceOfTurnChildCounts(value: object): value is TurnChildCounts {
...
export function TurnChildCountsFromJSON(json: any): TurnChildCounts {
    return TurnChildCountsFromJSONTyped(json, false);
}

export function TurnChildCountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnChildCounts {
    if (json == null) {
        return json;
    }
    return {
...
export function TurnChildCountsToJSON(json: any): TurnChildCounts {
    return TurnChildCountsToJSONTyped(json, false);
}

export function TurnChildCountsToJSONTyped(value?: TurnChildCounts | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
