...
import type { TenantMemorySpaceSelector } from './TenantMemorySpaceSelector.js';
import {
    instanceOfTenantMemorySpaceSelector,
    TenantMemorySpaceSelectorFromJSON,
    TenantMemorySpaceSelectorFromJSONTyped,
    TenantMemorySpaceSelectorToJSON,
} from './TenantMemorySpaceSelector.js';
import type { UserMemorySpaceSelector } from './UserMemorySpaceSelector.js';
import {
    instanceOfUserMemorySpaceSelector,
    UserMemorySpaceSelectorFromJSON,
    UserMemorySpaceSelectorFromJSONTyped,
    UserMemorySpaceSelectorToJSON,
} from './UserMemorySpaceSelector.js';

/**
 * @type MemorySpaceSelector
 *
 * @export
 */
export type MemorySpaceSelector = { scope: 'tenant' } & TenantMemorySpaceSelector | { scope: 'user' } & UserMemorySpaceSelector;

export function MemorySpaceSelectorFromJSON(json: any): MemorySpaceSelector {
    return MemorySpaceSelectorFromJSONTyped(json, false);
}

export function MemorySpaceSelectorFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemorySpaceSelector {
    if (json == null) {
        return json;
    }
    switch (json['scope']) {
        case 'tenant':
            return Object.assign({}, TenantMemorySpaceSelectorFromJSONTyped(json, true), { scope: 'tenant' } as const);
        case 'user':
            return Object.assign({}, UserMemorySpaceSelectorFromJSONTyped(json, true), { scope: 'user' } as const);
        default:
            return json;
    }
}

export function MemorySpaceSelectorToJSON(json: any): any {
    return MemorySpaceSelectorToJSONTyped(json, false);
}

export function MemorySpaceSelectorToJSONTyped(value?: MemorySpaceSelector | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['scope']) {
        case 'tenant':
            return Object.assign({}, TenantMemorySpaceSelectorToJSON(value), { scope: 'tenant' } as const);
        case 'user':
            return Object.assign({}, UserMemorySpaceSelectorToJSON(value), { scope: 'user' } as const);
        default:
            return value;
    }
}
