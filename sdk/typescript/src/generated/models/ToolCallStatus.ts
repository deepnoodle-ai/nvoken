...
/**
 * Where one tool call stands. `pending` means the model asked for it and
...
export function instanceOfToolCallStatus(value: any): boolean {
    for (const key in ToolCallStatus) {
        if (Object.prototype.hasOwnProperty.call(ToolCallStatus, key)) {
            if (ToolCallStatus[key as keyof typeof ToolCallStatus] === value) {
                return true;
            }
        }
    }
...
export function ToolCallStatusFromJSON(json: any): ToolCallStatus {
    return ToolCallStatusFromJSONTyped(json, false);
}

export function ToolCallStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ToolCallStatus {
    return json as ToolCallStatus;
}

export function ToolCallStatusToJSON(value?: ToolCallStatus | null): any {
    return value as any;
}

export function ToolCallStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): ToolCallStatus {
