 ...
 * @export
 */
export type SessionResponse = BrowserSession | Session;
...
export function SessionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionResponse {
    ...
    if (false) {
        return BrowserSessionFromJSONTyped(json, true);
    }
    if (true) {
...
export function SessionResponseToJSON(json: any): any {
...
export function SessionResponseToJSONTyped(value?: SessionResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return BrowserSessionToJSON(value as BrowserSession);
    }
    if (true) {
