...
/**
 * Check if a given object implements the OrgList interface.
 */
export function instanceOfOrgList(value: object): value is OrgList {
    if (!('items' in value) || value['items'] === undefined) return false;
    return true;
}

export function OrgListFromJSON(json: any): OrgList {
    return OrgListFromJSONTyped(json, false);
}

export function OrgListFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrgList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(OrgFromJSON)),
    };
}

export function OrgListToJSON(json: any): OrgList {
    return OrgListToJSONTyped(json, false);
}

export function OrgListToJSONTyped(value?: OrgList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(OrgToJSON)),
    };
}
