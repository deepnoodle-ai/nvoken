 ...
 *
 * @export
 * @interface DeliveryInlineSource
 */
export interface DeliveryInlineSource {
    /**
     *
     * @type {DeliveryInlineSourceKindEnum}
     * @memberof DeliveryInlineSource
     */
    kind: DeliveryInlineSourceKindEnum;
    /**
     *
     * @type {string}
     * @memberof DeliveryInlineSource
 ...
 * @export
 */
export const DeliveryInlineSourceKindEnum = {
    Inline: 'inline'
} as const;
export type DeliveryInlineSourceKindEnum = typeof DeliveryInlineSourceKindEnum[keyof typeof DeliveryInlineSourceKindEnum];


/**
 * Check if a given object implements the DeliveryInlineSource interface.
 */
export function instanceOfDeliveryInlineSource(value: object): value is DeliveryInlineSource {
    if (!('kind' in value) || value['kind'] === undefined) return false;
    if (!('digest' in value) || value['digest'] === undefined) return false;
    return true;
}

export function DeliveryInlineSourceFromJSON(json: any): DeliveryInlineSource {
    return DeliveryInlineSourceFromJSONTyped(json, false);
}

export function DeliveryInlineSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeliveryInlineSource {
    if (json == null) {
        return json;
    }
    return {
...
export function DeliveryInlineSourceToJSON(json: any): DeliveryInlineSource {
    return DeliveryInlineSourceToJSONTyped(json, false);
}

export function DeliveryInlineSourceToJSONTyped(value?: DeliveryInlineSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
