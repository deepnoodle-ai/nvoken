 ...
 * @export
 */
export const ModelCallFactStatus = {
    Prepared: 'prepared',
    Started: 'started',
    Settled: 'settled',
...
export type ModelCallFactStatus = typeof ModelCallFactStatus[keyof typeof ModelCallFactStatus];


export function instanceOfModelCallFactStatus(value: any): boolean {
    for (const key in ModelCallFactStatus) {
        if (Object.prototype.hasOwnProperty.call(ModelCallFactStatus, key)) {
            if (ModelCallFactStatus[key as keyof typeof ModelCallFactStatus] === value) {
                return true;
            }
        }
    }
...
export function ModelCallFactStatusFromJSON(json: any): ModelCallFactStatus {
    return ModelCallFactStatusFromJSONTyped(json, false);
}

export function ModelCallFactStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCallFactStatus {
    return json as ModelCallFactStatus;
}

export function ModelCallFactStatusToJSON(value?: ModelCallFactStatus | null): any {
    return value as any;
}

export function ModelCallFactStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): ModelCallFactStatus {
    return value as ModelCallFactStatus;
}
