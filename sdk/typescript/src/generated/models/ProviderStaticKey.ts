 ...
 *
 * @export
 * @interface ProviderStaticKey
 */
export interface ProviderStaticKey {
    /**
     * Encrypted before persistence and never returned.
     * @type {string}
     * @memberof ProviderStaticKey
     */
    apiKey: string;
}

/**
 * Check if a given object implements the ProviderStaticKey interface.
 */
export function instanceOfProviderStaticKey(value: object): value is ProviderStaticKey {
    if (!('apiKey' in value) || value['apiKey'] === undefined) return false;
    return true;
}

export function ProviderStaticKeyFromJSON(json: any): ProviderStaticKey {
    return ProviderStaticKeyFromJSONTyped(json, false);
}

export function ProviderStaticKeyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProviderStaticKey {
    if (json == null) {
        return json;
    }
    return {
...
export function ProviderStaticKeyToJSON(json: any): ProviderStaticKey {
    return ProviderStaticKeyToJSONTyped(json, false);
}

export function ProviderStaticKeyToJSONTyped(value?: ProviderStaticKey | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
