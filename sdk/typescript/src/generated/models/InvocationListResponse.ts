...
import type { ClientInvocationList } from './ClientInvocationList.js';
import {
    ClientInvocationListFromJSON,
    ClientInvocationListFromJSONTyped,
    ClientInvocationListToJSON,
} from './ClientInvocationList.js';
 ...
 * @export
 */
export type InvocationListResponse = ClientInvocationList | InvocationList;
...
export function InvocationListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationListResponse {
    ...
    if (false) {
        return ClientInvocationListFromJSONTyped(json, true);
    }
    if (true) {
...
export function InvocationListResponseToJSONTyped(value?: InvocationListResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return ClientInvocationListToJSON(value as ClientInvocationList);
    }
    if (true) {
