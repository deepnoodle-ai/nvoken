...
import type { BrowserInvocationList } from './BrowserInvocationList.js';
import {
    BrowserInvocationListFromJSON,
    BrowserInvocationListFromJSONTyped,
    BrowserInvocationListToJSON,
} from './BrowserInvocationList.js';
import type { InvocationList } from './InvocationList.js';
import {
    InvocationListFromJSON,
    InvocationListFromJSONTyped,
    InvocationListToJSON,
} from './InvocationList.js';
 ...
 * @export
 */
export type InvocationListResponse = BrowserInvocationList | InvocationList;

export function InvocationListResponseFromJSON(json: any): InvocationListResponse {
    return InvocationListResponseFromJSONTyped(json, false);
}

export function InvocationListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationListResponse {
    if (json == null) {
        return json;
    }
    ...
    if (false) {
        return BrowserInvocationListFromJSONTyped(json, true);
    }
    if (true) {
        return InvocationListFromJSONTyped(json, true);
    }
    return {} as any;
}

export function InvocationListResponseToJSON(json: any): any {
    return InvocationListResponseToJSONTyped(json, false);
}

export function InvocationListResponseToJSONTyped(value?: InvocationListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (false) {
        return BrowserInvocationListToJSON(value as BrowserInvocationList);
    }
    if (true) {
        return InvocationListToJSON(value as InvocationList);
    }
    return {};
}
