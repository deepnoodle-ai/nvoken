 ...
 *
 * @export
 * @interface TenantTurnMemory
 */
export interface TenantTurnMemory {
    /**
     *
     * @type {TenantTurnMemoryScopeEnum}
     * @memberof TenantTurnMemory
     */
    scope: TenantTurnMemoryScopeEnum;
    /**
     *
     * @type {string}
     * @memberof TenantTurnMemory
 ...
 * @export
 */
export const TenantTurnMemoryScopeEnum = {
    Tenant: 'tenant'
} as const;
export type TenantTurnMemoryScopeEnum = typeof TenantTurnMemoryScopeEnum[keyof typeof TenantTurnMemoryScopeEnum];


/**
 * Check if a given object implements the TenantTurnMemory interface.
 */
export function instanceOfTenantTurnMemory(value: object): value is TenantTurnMemory {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    return true;
}

export function TenantTurnMemoryFromJSON(json: any): TenantTurnMemory {
    return TenantTurnMemoryFromJSONTyped(json, false);
}

export function TenantTurnMemoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): TenantTurnMemory {
    if (json == null) {
        return json;
    }
    return {
...
export function TenantTurnMemoryToJSON(json: any): TenantTurnMemory {
    return TenantTurnMemoryToJSONTyped(json, false);
}

export function TenantTurnMemoryToJSONTyped(value?: TenantTurnMemory | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
