...
export function instanceOfTenant(value: object): value is Tenant {
    ...
    if (!('lastInvocationAt' in value) || value['lastInvocationAt'] === undefined) return false;
...
export function TenantFromJSONTyped(json: any, ignoreDiscriminator: boolean): Tenant {
    ...
    return {
        ...
        'lastInvocationAt': (json['last_invocation_at'] == null ? null : new Date(json['last_invocation_at'])),
...
export function TenantToJSONTyped(value?: Tenant | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'last_invocation_at': value['lastInvocationAt'] == null ? value['lastInvocationAt'] : value['lastInvocationAt'].toISOString(),
