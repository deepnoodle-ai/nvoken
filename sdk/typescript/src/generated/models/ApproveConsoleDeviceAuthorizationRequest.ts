 ...
 *
 * @export
 * @interface ApproveConsoleDeviceAuthorizationRequest
 */
export interface ApproveConsoleDeviceAuthorizationRequest {
    /**
     *
     * @type {ApproveConsoleDeviceAuthorizationRequestCredentialTypeEnum}
     * @memberof ApproveConsoleDeviceAuthorizationRequest
     */
    credentialType: ApproveConsoleDeviceAuthorizationRequestCredentialTypeEnum;
}
 ...
 * @export
 */
export const ApproveConsoleDeviceAuthorizationRequestCredentialTypeEnum = {
    App: 'app',
    AppReadOnly: 'app_read_only'
} as const;
export type ApproveConsoleDeviceAuthorizationRequestCredentialTypeEnum = typeof ApproveConsoleDeviceAuthorizationRequestCredentialTypeEnum[keyof typeof ApproveConsoleDeviceAuthorizationRequestCredentialTypeEnum];


/**
 * Check if a given object implements the ApproveConsoleDeviceAuthorizationRequest interface.
 */
export function instanceOfApproveConsoleDeviceAuthorizationRequest(value: object): value is ApproveConsoleDeviceAuthorizationRequest {
    if (!('credentialType' in value) || value['credentialType'] === undefined) return false;
    return true;
}

export function ApproveConsoleDeviceAuthorizationRequestFromJSON(json: any): ApproveConsoleDeviceAuthorizationRequest {
    return ApproveConsoleDeviceAuthorizationRequestFromJSONTyped(json, false);
}

export function ApproveConsoleDeviceAuthorizationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApproveConsoleDeviceAuthorizationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ApproveConsoleDeviceAuthorizationRequestToJSON(json: any): ApproveConsoleDeviceAuthorizationRequest {
    return ApproveConsoleDeviceAuthorizationRequestToJSONTyped(json, false);
}

export function ApproveConsoleDeviceAuthorizationRequestToJSONTyped(value?: ApproveConsoleDeviceAuthorizationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
