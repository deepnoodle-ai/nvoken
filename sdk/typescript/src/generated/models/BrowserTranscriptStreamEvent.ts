...
import type { BrowserTranscriptUpdateEvent } from './BrowserTranscriptUpdateEvent.js';
import {
    instanceOfBrowserTranscriptUpdateEvent,
    BrowserTranscriptUpdateEventFromJSON,
    BrowserTranscriptUpdateEventFromJSONTyped,
    BrowserTranscriptUpdateEventToJSON,
} from './BrowserTranscriptUpdateEvent.js';
...
/**
 * @type BrowserTranscriptStreamEvent
 * Browser stream event. Switch on `type`. Host-only transcript fields are
 * never emitted. New frame types may appear here over time, and existing
 * ones may gain fields.
 *
 * @export
 */
export type BrowserTranscriptStreamEvent = { type: 'output_text.delta' } & OutputTextDeltaEvent | { type: 'stream.end' } & StreamEndEvent | { type: 'stream.resync' } & StreamResyncEvent | { type: 'thinking.delta' } & ThinkingDeltaEvent | { type: 'transcript.update' } & BrowserTranscriptUpdateEvent;

export function BrowserTranscriptStreamEventFromJSON(json: any): BrowserTranscriptStreamEvent {
    return BrowserTranscriptStreamEventFromJSONTyped(json, false);
}

export function BrowserTranscriptStreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserTranscriptStreamEvent {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
        ...
        case 'transcript.update':
            return Object.assign({}, BrowserTranscriptUpdateEventFromJSONTyped(json, true), { type: 'transcript.update' } as const);
        default:
            return json;
    }
}

export function BrowserTranscriptStreamEventToJSON(json: any): any {
    return BrowserTranscriptStreamEventToJSONTyped(json, false);
}

export function BrowserTranscriptStreamEventToJSONTyped(value?: BrowserTranscriptStreamEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        ...
        case 'transcript.update':
            return Object.assign({}, BrowserTranscriptUpdateEventToJSON(value), { type: 'transcript.update' } as const);
        default:
            return value;
    }
}
