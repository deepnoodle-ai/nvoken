...
/**
 * Check if a given object implements the ToolMetrics interface.
 */
export function instanceOfToolMetrics(value: object): value is ToolMetrics {
    if (!('toolCalls' in value) || value['toolCalls'] === undefined) return false;
    if (!('completedToolCalls' in value) || value['completedToolCalls'] === undefined) return false;
    if (!('failedToolCalls' in value) || value['failedToolCalls'] === undefined) return false;
    if (!('cancelledToolCalls' in value) || value['cancelledToolCalls'] === undefined) return false;
    return true;
}

export function ToolMetricsFromJSON(json: any): ToolMetrics {
    return ToolMetricsFromJSONTyped(json, false);
}

export function ToolMetricsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ToolMetrics {
    if (json == null) {
        return json;
    }
    return {
        ...
        'completedToolCalls': json['completed_tool_calls'],
        'failedToolCalls': json['failed_tool_calls'],
        'cancelledToolCalls': json['cancelled_tool_calls'],
    };
}

export function ToolMetricsToJSON(json: any): ToolMetrics {
    return ToolMetricsToJSONTyped(json, false);
}

export function ToolMetricsToJSONTyped(value?: ToolMetrics | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'completed_tool_calls': value['completedToolCalls'],
        'failed_tool_calls': value['failedToolCalls'],
        'cancelled_tool_calls': value['cancelledToolCalls'],
    };
}
