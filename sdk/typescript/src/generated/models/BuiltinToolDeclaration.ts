 ...
 *
 * @export
 * @interface BuiltinToolDeclaration
 */
export interface BuiltinToolDeclaration {
    /**
     * Fixed runtime-owned public-web fetch capability.
     * @type {BuiltinToolDeclarationNameEnum}
     * @memberof BuiltinToolDeclaration
     */
    name: BuiltinToolDeclarationNameEnum;
    /**
     *
     * @type {BuiltinToolDeclarationModeEnum}
     * @memberof BuiltinToolDeclaration
     */
    mode: BuiltinToolDeclarationModeEnum;
}
 ...
 * @export
 */
export const BuiltinToolDeclarationNameEnum = {
    NameNvokenFetch: 'nvoken_fetch'
} as const;
export type BuiltinToolDeclarationNameEnum = typeof BuiltinToolDeclarationNameEnum[keyof typeof BuiltinToolDeclarationNameEnum];

/**
 * @export
 */
export const BuiltinToolDeclarationModeEnum = {
    ModeBuiltin: 'builtin'
} as const;
export type BuiltinToolDeclarationModeEnum = typeof BuiltinToolDeclarationModeEnum[keyof typeof BuiltinToolDeclarationModeEnum];


/**
 * Check if a given object implements the BuiltinToolDeclaration interface.
 */
export function instanceOfBuiltinToolDeclaration(value: object): value is BuiltinToolDeclaration {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('mode' in value) || value['mode'] === undefined) return false;
    return true;
}

export function BuiltinToolDeclarationFromJSON(json: any): BuiltinToolDeclaration {
    return BuiltinToolDeclarationFromJSONTyped(json, false);
}

export function BuiltinToolDeclarationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BuiltinToolDeclaration {
    if (json == null) {
        return json;
    }
    return {
...
export function BuiltinToolDeclarationToJSON(json: any): BuiltinToolDeclaration {
    return BuiltinToolDeclarationToJSONTyped(json, false);
}

export function BuiltinToolDeclarationToJSONTyped(value?: BuiltinToolDeclaration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
