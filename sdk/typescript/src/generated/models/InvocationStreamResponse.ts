...
import type { BrowserInvocationStreamEvent } from './BrowserInvocationStreamEvent.js';
import {
    BrowserInvocationStreamEventFromJSON,
    BrowserInvocationStreamEventFromJSONTyped,
    BrowserInvocationStreamEventToJSON,
} from './BrowserInvocationStreamEvent.js';
import type { InvocationStreamEvent } from './InvocationStreamEvent.js';
import {
    InvocationStreamEventFromJSON,
    InvocationStreamEventFromJSONTyped,
    InvocationStreamEventToJSON,
} from './InvocationStreamEvent.js';
 ...
 * @export
 */
export type InvocationStreamResponse = BrowserInvocationStreamEvent | InvocationStreamEvent;

export function InvocationStreamResponseFromJSON(json: any): InvocationStreamResponse {
    return InvocationStreamResponseFromJSONTyped(json, false);
}

export function InvocationStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationStreamResponse {
    if (json == null) {
        return json;
    }
    ...
    if (false) {
        return BrowserInvocationStreamEventFromJSONTyped(json, true);
    }
    if (true) {
        return InvocationStreamEventFromJSONTyped(json, true);
    }
    return {} as any;
}

export function InvocationStreamResponseToJSON(json: any): any {
    return InvocationStreamResponseToJSONTyped(json, false);
}

export function InvocationStreamResponseToJSONTyped(value?: InvocationStreamResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (false) {
        return BrowserInvocationStreamEventToJSON(value as BrowserInvocationStreamEvent);
    }
    if (true) {
        return InvocationStreamEventToJSON(value as InvocationStreamEvent);
    }
    return {};
}
