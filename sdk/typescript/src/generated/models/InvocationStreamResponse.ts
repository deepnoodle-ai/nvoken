...
import type { ClientInvocationStreamEvent } from './ClientInvocationStreamEvent.js';
import {
    ClientInvocationStreamEventFromJSON,
    ClientInvocationStreamEventFromJSONTyped,
    ClientInvocationStreamEventToJSON,
} from './ClientInvocationStreamEvent.js';
 ...
 * @export
 */
export type InvocationStreamResponse = ClientInvocationStreamEvent | InvocationStreamEvent;
...
export function InvocationStreamResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationStreamResponse {
    ...
    if (false) {
        return ClientInvocationStreamEventFromJSONTyped(json, true);
    }
    if (true) {
...
export function InvocationStreamResponseToJSONTyped(value?: InvocationStreamResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return ClientInvocationStreamEventToJSON(value as ClientInvocationStreamEvent);
    }
    if (true) {
