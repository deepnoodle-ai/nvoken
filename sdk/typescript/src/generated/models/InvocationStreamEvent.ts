 ...
 * Typed event from one Invocation stream. Switch on `type`. A minimal
 ...
 * @export
 */
export type InvocationStreamEvent = { type: 'invocation.accepted' } & InvocationAcceptedEvent | { type: 'invocation.result' } & InvocationResultEvent | { type: 'invocation.update' } & InvocationUpdateEvent | { type: 'output_text.delta' } & OutputTextDeltaEvent | { type: 'stream.end' } & StreamEndEvent | { type: 'stream.resync' } & StreamResyncEvent | { type: 'thinking.delta' } & ThinkingDeltaEvent;
...
export function InvocationStreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationStreamEvent {
    ...
    switch (json['type']) {
        case 'invocation.accepted':
            return Object.assign({}, InvocationAcceptedEventFromJSONTyped(json, true), { type: 'invocation.accepted' } as const);
        case 'invocation.result':
            return Object.assign({}, InvocationResultEventFromJSONTyped(json, true), { type: 'invocation.result' } as const);
        case 'invocation.update':
            return Object.assign({}, InvocationUpdateEventFromJSONTyped(json, true), { type: 'invocation.update' } as const);
...
export function InvocationStreamEventToJSONTyped(value?: InvocationStreamEvent | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['type']) {
        case 'invocation.accepted':
            return Object.assign({}, InvocationAcceptedEventToJSON(value), { type: 'invocation.accepted' } as const);
        case 'invocation.result':
            return Object.assign({}, InvocationResultEventToJSON(value), { type: 'invocation.result' } as const);
        case 'invocation.update':
            return Object.assign({}, InvocationUpdateEventToJSON(value), { type: 'invocation.update' } as const);
        case 'output_text.delta':
