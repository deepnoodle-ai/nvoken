...
import type { CharLocationCitation } from './CharLocationCitation.js';
import {
    instanceOfCharLocationCitation,
    CharLocationCitationFromJSON,
    CharLocationCitationFromJSONTyped,
    CharLocationCitationToJSON,
} from './CharLocationCitation.js';
import type { URLCitation } from './URLCitation.js';
import {
    instanceOfURLCitation,
    URLCitationFromJSON,
    URLCitationFromJSONTyped,
    URLCitationToJSON,
} from './URLCitation.js';
import type { WebSearchResultLocationCitation } from './WebSearchResultLocationCitation.js';
import {
    instanceOfWebSearchResultLocationCitation,
    WebSearchResultLocationCitationFromJSON,
    WebSearchResultLocationCitationFromJSONTyped,
    WebSearchResultLocationCitationToJSON,
} from './WebSearchResultLocationCitation.js';
 ...
 * @export
 */
export type Citation = { type: 'char_location' } & CharLocationCitation | { type: 'url_citation' } & URLCitation | { type: 'web_search_result_location' } & WebSearchResultLocationCitation;
...
export function CitationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Citation {
    ...
    switch (json['type']) {
        case 'char_location':
            return Object.assign({}, CharLocationCitationFromJSONTyped(json, true), { type: 'char_location' } as const);
        case 'url_citation':
            return Object.assign({}, URLCitationFromJSONTyped(json, true), { type: 'url_citation' } as const);
        case 'web_search_result_location':
            return Object.assign({}, WebSearchResultLocationCitationFromJSONTyped(json, true), { type: 'web_search_result_location' } as const);
        default:
            return json;
    }
}

export function CitationToJSON(json: any): any {
...
export function CitationToJSONTyped(value?: Citation | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['type']) {
        case 'char_location':
            return Object.assign({}, CharLocationCitationToJSON(value), { type: 'char_location' } as const);
        case 'url_citation':
            return Object.assign({}, URLCitationToJSON(value), { type: 'url_citation' } as const);
        case 'web_search_result_location':
            return Object.assign({}, WebSearchResultLocationCitationToJSON(value), { type: 'web_search_result_location' } as const);
        default:
            return value;
    }
}
