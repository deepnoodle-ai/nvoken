...
import {
    ClientSessionFromJSON,
    ClientSessionFromJSONTyped,
    ClientSessionToJSON,
    ClientSessionToJSONTyped,
...
export interface ClientSessionList {
     ...
     * @memberof ClientSessionList
     */
    items: Array<ClientSession>;
    /**
     *
     * @type {boolean}
     * @memberof ClientSessionList
...
/**
 * Check if a given object implements the ClientSessionList interface.
 */
export function instanceOfClientSessionList(value: object): value is ClientSessionList {
...
export function ClientSessionListFromJSON(json: any): ClientSessionList {
    return ClientSessionListFromJSONTyped(json, false);
}

export function ClientSessionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientSessionList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ClientSessionFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function ClientSessionListToJSON(json: any): ClientSessionList {
    return ClientSessionListToJSONTyped(json, false);
}

export function ClientSessionListToJSONTyped(value?: ClientSessionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ClientSessionToJSON)),
