 ...
 *
 * @export
 * @interface InvocationTimelineStep
 */
export interface InvocationTimelineStep {
    /**
     *
     * @type {InvocationTimelineStepKindEnum}
     * @memberof InvocationTimelineStep
     */
    kind: InvocationTimelineStepKindEnum;
    /**
     *
     * @type {string}
     * @memberof InvocationTimelineStep
 ...
 * @export
 */
export const InvocationTimelineStepKindEnum = {
    Lifecycle: 'lifecycle',
    ModelCall: 'model_call',
    ToolCall: 'tool_call',
    Nudge: 'nudge'
} as const;
export type InvocationTimelineStepKindEnum = typeof InvocationTimelineStepKindEnum[keyof typeof InvocationTimelineStepKindEnum];


/**
 * Check if a given object implements the InvocationTimelineStep interface.
 */
export function instanceOfInvocationTimelineStep(value: object): value is InvocationTimelineStep {
...
export function InvocationTimelineStepFromJSON(json: any): InvocationTimelineStep {
    return InvocationTimelineStepFromJSONTyped(json, false);
}

export function InvocationTimelineStepFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationTimelineStep {
    if (json == null) {
        return json;
    }
    return {
...
export function InvocationTimelineStepToJSON(json: any): InvocationTimelineStep {
    return InvocationTimelineStepToJSONTyped(json, false);
}

export function InvocationTimelineStepToJSONTyped(value?: InvocationTimelineStep | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
