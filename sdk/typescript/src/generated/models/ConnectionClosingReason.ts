...
/**
 * Why this connection is closing. `rotate` means the server is cycling the connection, so reconnect now
 ...
 * @export
 */
export const ConnectionClosingReason = {
    ReasonRotate: 'rotate',
    ReasonIdle: 'idle',
    ReasonSlowConsumer: 'slow_consumer'
} as const;
export type ConnectionClosingReason = typeof ConnectionClosingReason[keyof typeof ConnectionClosingReason];


export function instanceOfConnectionClosingReason(value: any): boolean {
    for (const key in ConnectionClosingReason) {
        if (Object.prototype.hasOwnProperty.call(ConnectionClosingReason, key)) {
            if (ConnectionClosingReason[key as keyof typeof ConnectionClosingReason] === value) {
                return true;
            }
        }
    }
...
export function ConnectionClosingReasonFromJSON(json: any): ConnectionClosingReason {
    return ConnectionClosingReasonFromJSONTyped(json, false);
}

export function ConnectionClosingReasonFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectionClosingReason {
    return json as ConnectionClosingReason;
}

export function ConnectionClosingReasonToJSON(value?: ConnectionClosingReason | null): any {
    return value as any;
}

export function ConnectionClosingReasonToJSONTyped(value: any, ignoreDiscriminator: boolean): ConnectionClosingReason {
    return value as ConnectionClosingReason;
}
