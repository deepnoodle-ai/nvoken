...
/**
 * Check if a given object implements the ClientSessionMessage interface.
 */
export function instanceOfClientSessionMessage(value: object): value is ClientSessionMessage {
...
export function ClientSessionMessageFromJSON(json: any): ClientSessionMessage {
    return ClientSessionMessageFromJSONTyped(json, false);
}

export function ClientSessionMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientSessionMessage {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientSessionMessageToJSON(json: any): ClientSessionMessage {
    return ClientSessionMessageToJSONTyped(json, false);
}

export function ClientSessionMessageToJSONTyped(value?: ClientSessionMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
