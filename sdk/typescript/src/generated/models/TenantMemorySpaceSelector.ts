 ...
 *
 * @export
 * @interface TenantMemorySpaceSelector
 */
export interface TenantMemorySpaceSelector {
    /**
     *
     * @type {TenantMemorySpaceSelectorScopeEnum}
     * @memberof TenantMemorySpaceSelector
     */
    scope: TenantMemorySpaceSelectorScopeEnum;
    /**
     *
     * @type {string}
     * @memberof TenantMemorySpaceSelector
 ...
 * @export
 */
export const TenantMemorySpaceSelectorScopeEnum = {
    Tenant: 'tenant'
} as const;
export type TenantMemorySpaceSelectorScopeEnum = typeof TenantMemorySpaceSelectorScopeEnum[keyof typeof TenantMemorySpaceSelectorScopeEnum];


/**
 * Check if a given object implements the TenantMemorySpaceSelector interface.
 */
export function instanceOfTenantMemorySpaceSelector(value: object): value is TenantMemorySpaceSelector {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    if (!('namespace' in value) || value['namespace'] === undefined) return false;
    return true;
}

export function TenantMemorySpaceSelectorFromJSON(json: any): TenantMemorySpaceSelector {
    return TenantMemorySpaceSelectorFromJSONTyped(json, false);
}

export function TenantMemorySpaceSelectorFromJSONTyped(json: any, ignoreDiscriminator: boolean): TenantMemorySpaceSelector {
    if (json == null) {
        return json;
    }
    return {
...
export function TenantMemorySpaceSelectorToJSON(json: any): TenantMemorySpaceSelector {
    return TenantMemorySpaceSelectorToJSONTyped(json, false);
}

export function TenantMemorySpaceSelectorToJSONTyped(value?: TenantMemorySpaceSelector | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
