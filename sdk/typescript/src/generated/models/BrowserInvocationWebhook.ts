 ...
 *
 * @export
 * @interface BrowserInvocationWebhook
 */
export interface BrowserInvocationWebhook {
    /**
     * Guarded absolute HTTPS Invocation webhook endpoint.
     * @type {string}
     * @memberof BrowserInvocationWebhook
     */
    url: string;
    /**
     * Must include invocation.waiting and invocation.ended. Omission
     * selects every current Invocation webhook event.
     *
...
/**
 * Check if a given object implements the BrowserInvocationWebhook interface.
 */
export function instanceOfBrowserInvocationWebhook(value: object): value is BrowserInvocationWebhook {
    if (!('url' in value) || value['url'] === undefined) return false;
    return true;
}

export function BrowserInvocationWebhookFromJSON(json: any): BrowserInvocationWebhook {
    return BrowserInvocationWebhookFromJSONTyped(json, false);
}

export function BrowserInvocationWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationWebhook {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserInvocationWebhookToJSON(json: any): BrowserInvocationWebhook {
    return BrowserInvocationWebhookToJSONTyped(json, false);
}

export function BrowserInvocationWebhookToJSONTyped(value?: BrowserInvocationWebhook | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
