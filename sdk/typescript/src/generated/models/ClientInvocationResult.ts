 ...
 *
 * @export
 * @interface ClientInvocationResult
 */
export interface ClientInvocationResult {
    /**
     *
     * @type {ClientInvocation}
     * @memberof ClientInvocationResult
     */
...
/**
 * Check if a given object implements the ClientInvocationResult interface.
 */
export function instanceOfClientInvocationResult(value: object): value is ClientInvocationResult {
...
export function ClientInvocationResultFromJSON(json: any): ClientInvocationResult {
    return ClientInvocationResultFromJSONTyped(json, false);
}

export function ClientInvocationResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationResult {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientInvocationResultToJSON(json: any): ClientInvocationResult {
    return ClientInvocationResultToJSONTyped(json, false);
}

export function ClientInvocationResultToJSONTyped(value?: ClientInvocationResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
