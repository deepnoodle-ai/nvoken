...
/**
 * Check if a given object implements the BudgetList interface.
 */
export function instanceOfBudgetList(value: object): value is BudgetList {
    if (!('items' in value) || value['items'] === undefined) return false;
    if (!('nextCursor' in value) || value['nextCursor'] === undefined) return false;
    return true;
}

export function BudgetListFromJSON(json: any): BudgetList {
    return BudgetListFromJSONTyped(json, false);
}

export function BudgetListFromJSONTyped(json: any, ignoreDiscriminator: boolean): BudgetList {
    if (json == null) {
        return json;
    }
    return {
...
export function BudgetListToJSON(json: any): BudgetList {
    return BudgetListToJSONTyped(json, false);
}

export function BudgetListToJSONTyped(value?: BudgetList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
