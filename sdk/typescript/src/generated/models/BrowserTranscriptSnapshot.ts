 ...
 *
 * @export
 * @interface BrowserTranscriptSnapshot
 */
export interface BrowserTranscriptSnapshot {
    /**
     *
     * @type {Array<BrowserSessionMessage>}
     * @memberof BrowserTranscriptSnapshot
     */
...
/**
 * Check if a given object implements the BrowserTranscriptSnapshot interface.
 */
export function instanceOfBrowserTranscriptSnapshot(value: object): value is BrowserTranscriptSnapshot {
...
export function BrowserTranscriptSnapshotFromJSON(json: any): BrowserTranscriptSnapshot {
    return BrowserTranscriptSnapshotFromJSONTyped(json, false);
}

export function BrowserTranscriptSnapshotFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserTranscriptSnapshot {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserTranscriptSnapshotToJSON(json: any): BrowserTranscriptSnapshot {
    return BrowserTranscriptSnapshotToJSONTyped(json, false);
}

export function BrowserTranscriptSnapshotToJSONTyped(value?: BrowserTranscriptSnapshot | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
