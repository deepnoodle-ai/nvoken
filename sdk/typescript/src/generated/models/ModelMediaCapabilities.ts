...
import type { ModelMediaKindCapabilities } from './ModelMediaKindCapabilities.js';
import {
    ModelMediaKindCapabilitiesFromJSON,
    ModelMediaKindCapabilitiesFromJSONTyped,
    ModelMediaKindCapabilitiesToJSON,
    ModelMediaKindCapabilitiesToJSONTyped,
} from './ModelMediaKindCapabilities.js';

/**
 *
 * @export
 * @interface ModelMediaCapabilities
 */
export interface ModelMediaCapabilities {
    /**
     *
     * @type {ModelMediaKindCapabilities}
     * @memberof ModelMediaCapabilities
     */
    image: ModelMediaKindCapabilities;
    /**
     *
     * @type {ModelMediaKindCapabilities}
     * @memberof ModelMediaCapabilities
     */
    document: ModelMediaKindCapabilities;
}

/**
 * Check if a given object implements the ModelMediaCapabilities interface.
 */
export function instanceOfModelMediaCapabilities(value: object): value is ModelMediaCapabilities {
    if (!('image' in value) || value['image'] === undefined) return false;
    if (!('document' in value) || value['document'] === undefined) return false;
    return true;
}

export function ModelMediaCapabilitiesFromJSON(json: any): ModelMediaCapabilities {
    return ModelMediaCapabilitiesFromJSONTyped(json, false);
}

export function ModelMediaCapabilitiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelMediaCapabilities {
    if (json == null) {
        return json;
    }
    return {

        'image': ModelMediaKindCapabilitiesFromJSON(json['image']),
        'document': ModelMediaKindCapabilitiesFromJSON(json['document']),
    };
}

export function ModelMediaCapabilitiesToJSON(json: any): ModelMediaCapabilities {
    return ModelMediaCapabilitiesToJSONTyped(json, false);
}

export function ModelMediaCapabilitiesToJSONTyped(value?: ModelMediaCapabilities | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'image': ModelMediaKindCapabilitiesToJSON(value['image']),
        'document': ModelMediaKindCapabilitiesToJSON(value['document']),
    };
}
