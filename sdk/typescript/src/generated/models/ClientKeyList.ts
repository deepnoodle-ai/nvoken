...
import type { ClientKey } from './ClientKey.js';
import {
    ClientKeyFromJSON,
    ClientKeyFromJSONTyped,
    ClientKeyToJSON,
    ClientKeyToJSONTyped,
} from './ClientKey.js';

/**
 *
 * @export
 * @interface ClientKeyList
 */
export interface ClientKeyList {
    /**
     *
     * @type {Array<ClientKey>}
     * @memberof ClientKeyList
     */
    items: Array<ClientKey>;
}

/**
 * Check if a given object implements the ClientKeyList interface.
 */
export function instanceOfClientKeyList(value: object): value is ClientKeyList {
    if (!('items' in value) || value['items'] === undefined) return false;
    return true;
}

export function ClientKeyListFromJSON(json: any): ClientKeyList {
    return ClientKeyListFromJSONTyped(json, false);
}

export function ClientKeyListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientKeyList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ClientKeyFromJSON)),
    };
}

export function ClientKeyListToJSON(json: any): ClientKeyList {
    return ClientKeyListToJSONTyped(json, false);
}

export function ClientKeyListToJSONTyped(value?: ClientKeyList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ClientKeyToJSON)),
    };
}
