 ...
 *
 * @export
 * @interface ModelMediaKindCapabilities
 */
export interface ModelMediaKindCapabilities {
    /**
     *
     * @type {boolean}
     * @memberof ModelMediaKindCapabilities
     */
    supported: boolean;
    /**
     * The exact media types this model accepts. An empty list means it does
...
/**
 * Check if a given object implements the ModelMediaKindCapabilities interface.
 */
export function instanceOfModelMediaKindCapabilities(value: object): value is ModelMediaKindCapabilities {
...
export function ModelMediaKindCapabilitiesFromJSON(json: any): ModelMediaKindCapabilities {
    return ModelMediaKindCapabilitiesFromJSONTyped(json, false);
}

export function ModelMediaKindCapabilitiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelMediaKindCapabilities {
    if (json == null) {
        return json;
    }
    return {
        ...
        'mediaTypes': new Set(json['media_types']),
    };
}

export function ModelMediaKindCapabilitiesToJSON(json: any): ModelMediaKindCapabilities {
    return ModelMediaKindCapabilitiesToJSONTyped(json, false);
}

export function ModelMediaKindCapabilitiesToJSONTyped(value?: ModelMediaKindCapabilities | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'media_types': Array.from(value['mediaTypes'] as Set<any>),
    };
}
