...
/**
 * Check if a given object implements the BrowserInvocation interface.
 */
export function instanceOfBrowserInvocation(value: object): value is BrowserInvocation {
...
export function BrowserInvocationFromJSON(json: any): BrowserInvocation {
    return BrowserInvocationFromJSONTyped(json, false);
}

export function BrowserInvocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocation {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserInvocationToJSON(json: any): BrowserInvocation {
    return BrowserInvocationToJSONTyped(json, false);
}

export function BrowserInvocationToJSONTyped(value?: BrowserInvocation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
