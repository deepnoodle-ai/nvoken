...
export interface AnonymousTokenRequest {
    /**
     * Previously returned visitor token; omit on a first visit.
     * @type {string}
     * @memberof AnonymousTokenRequest
     */
    visitorToken?: string;
}

/**
 * Check if a given object implements the AnonymousTokenRequest interface.
 */
export function instanceOfAnonymousTokenRequest(value: object): value is AnonymousTokenRequest {
    return true;
}

export function AnonymousTokenRequestFromJSON(json: any): AnonymousTokenRequest {
    return AnonymousTokenRequestFromJSONTyped(json, false);
}

export function AnonymousTokenRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AnonymousTokenRequest {
    if (json == null) {
        return json;
    }
    return {

        'visitorToken': json['visitor_token'] == null ? undefined : json['visitor_token'],
    };
}

export function AnonymousTokenRequestToJSON(json: any): AnonymousTokenRequest {
    return AnonymousTokenRequestToJSONTyped(json, false);
}

export function AnonymousTokenRequestToJSONTyped(value?: AnonymousTokenRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
