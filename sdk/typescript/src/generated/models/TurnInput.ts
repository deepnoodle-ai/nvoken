 ...
 * @export
 */
export type TurnInput = Array<InputBlock> | string;

export function TurnInputFromJSON(json: any): TurnInput {
    return TurnInputFromJSONTyped(json, false);
}

export function TurnInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnInput {
    if (json == null) {
        return json;
    }
...
export function TurnInputToJSON(json: any): any {
    return TurnInputToJSONTyped(json, false);
}

export function TurnInputToJSONTyped(value?: TurnInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
