 ...
 *
 * @export
 * @interface AdmissionTenantCount
 */
export interface AdmissionTenantCount {
    /**
     *
     * @type {string}
     * @memberof AdmissionTenantCount
     */
    tenantKey: string;
    /**
     *
...
/**
 * Check if a given object implements the AdmissionTenantCount interface.
 */
export function instanceOfAdmissionTenantCount(value: object): value is AdmissionTenantCount {
    if (!('tenantKey' in value) || value['tenantKey'] === undefined) return false;
    if (!('refusals' in value) || value['refusals'] === undefined) return false;
    if (!('lastRefusedAt' in value) || value['lastRefusedAt'] === undefined) return false;
    return true;
}

export function AdmissionTenantCountFromJSON(json: any): AdmissionTenantCount {
    return AdmissionTenantCountFromJSONTyped(json, false);
}

export function AdmissionTenantCountFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdmissionTenantCount {
    if (json == null) {
        return json;
    }
    return {
        ...
        'lastRefusedAt': (new Date(json['last_refused_at'])),
    };
}

export function AdmissionTenantCountToJSON(json: any): AdmissionTenantCount {
    return AdmissionTenantCountToJSONTyped(json, false);
}

export function AdmissionTenantCountToJSONTyped(value?: AdmissionTenantCount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'last_refused_at': value['lastRefusedAt'].toISOString(),
    };
}
