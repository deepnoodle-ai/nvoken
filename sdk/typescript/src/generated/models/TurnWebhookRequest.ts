...
import type { TurnWebhookContext } from './TurnWebhookContext.js';
import {
    TurnWebhookContextFromJSON,
    TurnWebhookContextFromJSONTyped,
    TurnWebhookContextToJSON,
    TurnWebhookContextToJSONTyped,
} from './TurnWebhookContext.js';
import type { TurnWebhookSubject } from './TurnWebhookSubject.js';
import {
    TurnWebhookSubjectFromJSON,
    TurnWebhookSubjectFromJSONTyped,
    TurnWebhookSubjectToJSON,
    TurnWebhookSubjectToJSONTyped,
} from './TurnWebhookSubject.js';

/**
 *
 * @export
 * @interface TurnWebhookRequest
 */
export interface TurnWebhookRequest {
    /**
     *
     * @type {TurnWebhookContext}
     * @memberof TurnWebhookRequest
     */
    nvoken: TurnWebhookContext;
    /**
     *
     * @type {TurnWebhookSubject}
     * @memberof TurnWebhookRequest
     */
    turn: TurnWebhookSubject;
}

/**
 * Check if a given object implements the TurnWebhookRequest interface.
 */
export function instanceOfTurnWebhookRequest(value: object): value is TurnWebhookRequest {
    if (!('nvoken' in value) || value['nvoken'] === undefined) return false;
    if (!('turn' in value) || value['turn'] === undefined) return false;
    return true;
}

export function TurnWebhookRequestFromJSON(json: any): TurnWebhookRequest {
    return TurnWebhookRequestFromJSONTyped(json, false);
}

export function TurnWebhookRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnWebhookRequest {
    if (json == null) {
        return json;
    }
    return {

        'nvoken': TurnWebhookContextFromJSON(json['nvoken']),
        'turn': TurnWebhookSubjectFromJSON(json['turn']),
    };
}

export function TurnWebhookRequestToJSON(json: any): TurnWebhookRequest {
    return TurnWebhookRequestToJSONTyped(json, false);
}

export function TurnWebhookRequestToJSONTyped(value?: TurnWebhookRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'nvoken': TurnWebhookContextToJSON(value['nvoken']),
        'turn': TurnWebhookSubjectToJSON(value['turn']),
    };
}
