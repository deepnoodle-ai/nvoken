 ...
 * @export
 */
export type CompactionPolicyTriggerTokens = number | string;

export function CompactionPolicyTriggerTokensFromJSON(json: any): CompactionPolicyTriggerTokens {
    return CompactionPolicyTriggerTokensFromJSONTyped(json, false);
}

export function CompactionPolicyTriggerTokensFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompactionPolicyTriggerTokens {
    if (json == null) {
        return json;
    }
...
export function CompactionPolicyTriggerTokensToJSON(json: any): any {
    return CompactionPolicyTriggerTokensToJSONTyped(json, false);
}

export function CompactionPolicyTriggerTokensToJSONTyped(value?: CompactionPolicyTriggerTokens | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
