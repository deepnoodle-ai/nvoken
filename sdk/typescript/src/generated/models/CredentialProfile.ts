...
/**
 * Fixed authorization profile. Runtime is meaningful for App-bound
...
export function instanceOfCredentialProfile(value: any): boolean {
    for (const key in CredentialProfile) {
        if (Object.prototype.hasOwnProperty.call(CredentialProfile, key)) {
            if (CredentialProfile[key as keyof typeof CredentialProfile] === value) {
                return true;
            }
        }
    }
...
export function CredentialProfileFromJSON(json: any): CredentialProfile {
    return CredentialProfileFromJSONTyped(json, false);
}

export function CredentialProfileFromJSONTyped(json: any, ignoreDiscriminator: boolean): CredentialProfile {
    return json as CredentialProfile;
}

export function CredentialProfileToJSON(value?: CredentialProfile | null): any {
    return value as any;
}

export function CredentialProfileToJSONTyped(value: any, ignoreDiscriminator: boolean): CredentialProfile {
