 ...
 * @export
 */
export const PendingInputStatus = {
    Pending: 'pending',
    Drained: 'drained',
    Expired: 'expired',
    Cancelled: 'cancelled'
} as const;
export type PendingInputStatus = typeof PendingInputStatus[keyof typeof PendingInputStatus];


export function instanceOfPendingInputStatus(value: any): boolean {
    for (const key in PendingInputStatus) {
        if (Object.prototype.hasOwnProperty.call(PendingInputStatus, key)) {
            if (PendingInputStatus[key as keyof typeof PendingInputStatus] === value) {
                return true;
            }
        }
    }
...
export function PendingInputStatusFromJSON(json: any): PendingInputStatus {
    return PendingInputStatusFromJSONTyped(json, false);
}

export function PendingInputStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): PendingInputStatus {
    return json as PendingInputStatus;
}

export function PendingInputStatusToJSON(value?: PendingInputStatus | null): any {
    return value as any;
}

export function PendingInputStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): PendingInputStatus {
    return value as PendingInputStatus;
}
