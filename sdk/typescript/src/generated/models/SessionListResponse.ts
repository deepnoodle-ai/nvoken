...
import type { ClientSessionList } from './ClientSessionList.js';
import {
    ClientSessionListFromJSON,
    ClientSessionListFromJSONTyped,
    ClientSessionListToJSON,
} from './ClientSessionList.js';
 ...
 * @export
 */
export type SessionListResponse = ClientSessionList | SessionList;
...
export function SessionListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionListResponse {
    ...
    if (false) {
        return ClientSessionListFromJSONTyped(json, true);
    }
    if (true) {
...
export function SessionListResponseToJSONTyped(value?: SessionListResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return ClientSessionListToJSON(value as ClientSessionList);
    }
    if (true) {
