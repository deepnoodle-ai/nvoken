...
import type { BrowserSessionList } from './BrowserSessionList.js';
import {
    BrowserSessionListFromJSON,
    BrowserSessionListFromJSONTyped,
    BrowserSessionListToJSON,
} from './BrowserSessionList.js';
import type { SessionList } from './SessionList.js';
import {
    SessionListFromJSON,
    SessionListFromJSONTyped,
    SessionListToJSON,
} from './SessionList.js';
 ...
 * @export
 */
export type SessionListResponse = BrowserSessionList | SessionList;
...
export function SessionListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionListResponse {
    ...
    if (false) {
        return BrowserSessionListFromJSONTyped(json, true);
    }
    if (true) {
        return SessionListFromJSONTyped(json, true);
    }
    return {} as any;
}

export function SessionListResponseToJSON(json: any): any {
...
export function SessionListResponseToJSONTyped(value?: SessionListResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return BrowserSessionListToJSON(value as BrowserSessionList);
    }
    if (true) {
        return SessionListToJSON(value as SessionList);
    }
    return {};
}
