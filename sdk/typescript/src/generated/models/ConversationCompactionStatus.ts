 ...
 * @export
 */
export const ConversationCompactionStatus = {
    Pending: 'pending',
    Running: 'running',
    Completed: 'completed',
    Failed: 'failed'
} as const;
export type ConversationCompactionStatus = typeof ConversationCompactionStatus[keyof typeof ConversationCompactionStatus];


export function instanceOfConversationCompactionStatus(value: any): boolean {
    for (const key in ConversationCompactionStatus) {
        if (Object.prototype.hasOwnProperty.call(ConversationCompactionStatus, key)) {
            if (ConversationCompactionStatus[key as keyof typeof ConversationCompactionStatus] === value) {
                return true;
            }
        }
    }
...
export function ConversationCompactionStatusFromJSON(json: any): ConversationCompactionStatus {
    return ConversationCompactionStatusFromJSONTyped(json, false);
}

export function ConversationCompactionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationCompactionStatus {
    return json as ConversationCompactionStatus;
}

export function ConversationCompactionStatusToJSON(value?: ConversationCompactionStatus | null): any {
    return value as any;
}

export function ConversationCompactionStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): ConversationCompactionStatus {
    return value as ConversationCompactionStatus;
}
