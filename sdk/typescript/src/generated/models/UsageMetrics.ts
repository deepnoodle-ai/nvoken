...
import type { ModelMetrics } from './ModelMetrics.js';
import {
...
import type { ToolMetrics } from './ToolMetrics.js';
import {
    ToolMetricsFromJSON,
    ToolMetricsFromJSONTyped,
    ToolMetricsToJSON,
    ToolMetricsToJSONTyped,
} from './ToolMetrics.js';
import type { ActivityMetrics } from './ActivityMetrics.js';
import {
    ActivityMetricsFromJSON,
    ActivityMetricsFromJSONTyped,
    ActivityMetricsToJSON,
    ActivityMetricsToJSONTyped,
} from './ActivityMetrics.js';
import type { CostMetrics } from './CostMetrics.js';
import {
    CostMetricsFromJSON,
    CostMetricsFromJSONTyped,
    CostMetricsToJSON,
    CostMetricsToJSONTyped,
} from './CostMetrics.js';
...
export function UsageMetricsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageMetrics {
    ...
    return {
        ...
        'activity': ActivityMetricsFromJSON(json['activity']),
        'model': ModelMetricsFromJSON(json['model']),
        'tools': ToolMetricsFromJSON(json['tools']),
        'cost': CostMetricsFromJSON(json['cost']),
    };
}
...
export function UsageMetricsToJSONTyped(value?: UsageMetrics | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'activity': ActivityMetricsToJSON(value['activity']),
        'model': ModelMetricsToJSON(value['model']),
        'tools': ToolMetricsToJSON(value['tools']),
        'cost': CostMetricsToJSON(value['cost']),
    };
}
