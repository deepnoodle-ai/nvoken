...
import type { ModelMediaCapabilities } from './ModelMediaCapabilities.js';
import {
    ModelMediaCapabilitiesFromJSON,
    ModelMediaCapabilitiesFromJSONTyped,
    ModelMediaCapabilitiesToJSON,
    ModelMediaCapabilitiesToJSONTyped,
} from './ModelMediaCapabilities.js';
...
export interface ModelInputCapabilities {
     ...
     * @memberof ModelInputCapabilities
     */
    media: ModelMediaCapabilities;
}

/**
 * Check if a given object implements the ModelInputCapabilities interface.
 */
export function instanceOfModelInputCapabilities(value: object): value is ModelInputCapabilities {
    if (!('media' in value) || value['media'] === undefined) return false;
    return true;
}

export function ModelInputCapabilitiesFromJSON(json: any): ModelInputCapabilities {
    return ModelInputCapabilitiesFromJSONTyped(json, false);
}

export function ModelInputCapabilitiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelInputCapabilities {
    if (json == null) {
        return json;
    }
    return {

        'media': ModelMediaCapabilitiesFromJSON(json['media']),
    };
}

export function ModelInputCapabilitiesToJSON(json: any): ModelInputCapabilities {
    return ModelInputCapabilitiesToJSONTyped(json, false);
}

export function ModelInputCapabilitiesToJSONTyped(value?: ModelInputCapabilities | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'media': ModelMediaCapabilitiesToJSON(value['media']),
    };
}
