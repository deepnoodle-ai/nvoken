 ...
 *
 * @export
 * @interface BrowserInvocationFailure
 */
export interface BrowserInvocationFailure {
    /**
     *
     * @type {string}
     * @memberof BrowserInvocationFailure
     */
    code: string;
    /**
     *
...
/**
 * Check if a given object implements the BrowserInvocationFailure interface.
 */
export function instanceOfBrowserInvocationFailure(value: object): value is BrowserInvocationFailure {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function BrowserInvocationFailureFromJSON(json: any): BrowserInvocationFailure {
    return BrowserInvocationFailureFromJSONTyped(json, false);
}

export function BrowserInvocationFailureFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationFailure {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserInvocationFailureToJSON(json: any): BrowserInvocationFailure {
    return BrowserInvocationFailureToJSONTyped(json, false);
}

export function BrowserInvocationFailureToJSONTyped(value?: BrowserInvocationFailure | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
