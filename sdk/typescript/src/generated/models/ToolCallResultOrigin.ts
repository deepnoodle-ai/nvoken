...
/**
 * The component that committed the result. `callback` is an inline
 * callback response; `host` includes settlement through `tool-results`.
 *
 * @export
 */
export const ToolCallResultOrigin = {
    Builtin: 'builtin',
    Callback: 'callback',
    Host: 'host',
    Mcp: 'mcp',
...
export type ToolCallResultOrigin = typeof ToolCallResultOrigin[keyof typeof ToolCallResultOrigin];


export function instanceOfToolCallResultOrigin(value: any): boolean {
    for (const key in ToolCallResultOrigin) {
        if (Object.prototype.hasOwnProperty.call(ToolCallResultOrigin, key)) {
            if (ToolCallResultOrigin[key as keyof typeof ToolCallResultOrigin] === value) {
                return true;
            }
        }
    }
...
export function ToolCallResultOriginFromJSON(json: any): ToolCallResultOrigin {
    return ToolCallResultOriginFromJSONTyped(json, false);
}

export function ToolCallResultOriginFromJSONTyped(json: any, ignoreDiscriminator: boolean): ToolCallResultOrigin {
    return json as ToolCallResultOrigin;
}

export function ToolCallResultOriginToJSON(value?: ToolCallResultOrigin | null): any {
    return value as any;
}

export function ToolCallResultOriginToJSONTyped(value: any, ignoreDiscriminator: boolean): ToolCallResultOrigin {
    return value as ToolCallResultOrigin;
}
