...
/**
 * Whether nvoken refuses a turn whose tenant has no available credits.
 *
...
export type CreditPolicy = typeof CreditPolicy[keyof typeof CreditPolicy];


export function instanceOfCreditPolicy(value: any): boolean {
    for (const key in CreditPolicy) {
        if (Object.prototype.hasOwnProperty.call(CreditPolicy, key)) {
            if (CreditPolicy[key as keyof typeof CreditPolicy] === value) {
                return true;
            }
        }
    }
...
export function CreditPolicyFromJSON(json: any): CreditPolicy {
    return CreditPolicyFromJSONTyped(json, false);
}

export function CreditPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditPolicy {
    return json as CreditPolicy;
}

export function CreditPolicyToJSON(value?: CreditPolicy | null): any {
    return value as any;
}

export function CreditPolicyToJSONTyped(value: any, ignoreDiscriminator: boolean): CreditPolicy {
    return value as CreditPolicy;
}
