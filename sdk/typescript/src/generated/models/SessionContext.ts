...
export interface SessionContext {
    /**
     * Roughly how many tokens the model will see on the next turn: the
    ...
    /**
     * Cataloged context window for `model`, or null when the selected
    ...
    /**
     * Model whose context window applies: the Session compaction model
...
/**
 * Check if a given object implements the SessionContext interface.
 */
export function instanceOfSessionContext(value: object): value is SessionContext {
    if (!('estimatedTokens' in value) || value['estimatedTokens'] === undefined) return false;
    if (!('contextWindowTokens' in value) || value['contextWindowTokens'] === undefined) return false;
    if (!('model' in value) || value['model'] === undefined) return false;
    return true;
}

export function SessionContextFromJSON(json: any): SessionContext {
    return SessionContextFromJSONTyped(json, false);
}

export function SessionContextFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionContext {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contextWindowTokens': json['context_window_tokens'],
        'model': ModelFromJSON(json['model']),
    };
}

export function SessionContextToJSON(json: any): SessionContext {
    return SessionContextToJSONTyped(json, false);
}

export function SessionContextToJSONTyped(value?: SessionContext | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
