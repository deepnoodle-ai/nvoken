 ...
 *
 * @export
 * @interface ClientSessionMessageList
 */
export interface ClientSessionMessageList {
    /**
     *
     * @type {Array<ClientSessionMessage>}
     * @memberof ClientSessionMessageList
     */
    items: Array<ClientSessionMessage>;
    /**
     *
     * @type {boolean}
     * @memberof ClientSessionMessageList
...
/**
 * Check if a given object implements the ClientSessionMessageList interface.
 */
export function instanceOfClientSessionMessageList(value: object): value is ClientSessionMessageList {
...
export function ClientSessionMessageListFromJSON(json: any): ClientSessionMessageList {
    return ClientSessionMessageListFromJSONTyped(json, false);
}

export function ClientSessionMessageListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientSessionMessageList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ClientSessionMessageFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function ClientSessionMessageListToJSON(json: any): ClientSessionMessageList {
    return ClientSessionMessageListToJSONTyped(json, false);
}

export function ClientSessionMessageListToJSONTyped(value?: ClientSessionMessageList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ClientSessionMessageToJSON)),
