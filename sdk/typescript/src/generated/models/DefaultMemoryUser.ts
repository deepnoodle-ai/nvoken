 ...
 *
 * @export
 * @interface DefaultMemoryUser
 */
export interface DefaultMemoryUser {
    /**
     *
     * @type {DefaultMemoryUserDefaultScopeEnum}
     * @memberof DefaultMemoryUser
     */
    defaultScope: DefaultMemoryUserDefaultScopeEnum;
    /**
     *
     * @type {string}
     * @memberof DefaultMemoryUser
 ...
 * @export
 */
export const DefaultMemoryUserDefaultScopeEnum = {
    User: 'user'
} as const;
export type DefaultMemoryUserDefaultScopeEnum = typeof DefaultMemoryUserDefaultScopeEnum[keyof typeof DefaultMemoryUserDefaultScopeEnum];


/**
 * Check if a given object implements the DefaultMemoryUser interface.
 */
export function instanceOfDefaultMemoryUser(value: object): value is DefaultMemoryUser {
    if (!('defaultScope' in value) || value['defaultScope'] === undefined) return false;
    return true;
}

export function DefaultMemoryUserFromJSON(json: any): DefaultMemoryUser {
    return DefaultMemoryUserFromJSONTyped(json, false);
}

export function DefaultMemoryUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefaultMemoryUser {
    if (json == null) {
        return json;
    }
    return {
...
export function DefaultMemoryUserToJSON(json: any): DefaultMemoryUser {
    return DefaultMemoryUserToJSONTyped(json, false);
}

export function DefaultMemoryUserToJSONTyped(value?: DefaultMemoryUser | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
