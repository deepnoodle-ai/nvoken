...
import type { PendingInput } from './PendingInput.js';
import {
    PendingInputFromJSON,
    PendingInputFromJSONTyped,
    PendingInputToJSON,
    PendingInputToJSONTyped,
} from './PendingInput.js';

/**
 *
 * @export
 * @interface PendingInputList
 */
export interface PendingInputList {
    /**
     *
     * @type {Array<PendingInput>}
     * @memberof PendingInputList
     */
    items: Array<PendingInput>;
    /**
     *
     * @type {boolean}
     * @memberof PendingInputList
...
/**
 * Check if a given object implements the PendingInputList interface.
 */
export function instanceOfPendingInputList(value: object): value is PendingInputList {
...
export function PendingInputListFromJSON(json: any): PendingInputList {
    return PendingInputListFromJSONTyped(json, false);
}

export function PendingInputListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PendingInputList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(PendingInputFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function PendingInputListToJSON(json: any): PendingInputList {
    return PendingInputListToJSONTyped(json, false);
}

export function PendingInputListToJSONTyped(value?: PendingInputList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(PendingInputToJSON)),
