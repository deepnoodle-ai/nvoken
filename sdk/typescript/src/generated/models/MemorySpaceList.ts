...
import type { MemorySpace } from './MemorySpace.js';
import {
    MemorySpaceFromJSON,
    MemorySpaceFromJSONTyped,
    MemorySpaceToJSON,
    MemorySpaceToJSONTyped,
} from './MemorySpace.js';

/**
 *
 * @export
 * @interface MemorySpaceList
 */
export interface MemorySpaceList {
    /**
     *
     * @type {Array<MemorySpace>}
     * @memberof MemorySpaceList
     */
    items: Array<MemorySpace>;
    /**
     *
     * @type {boolean}
     * @memberof MemorySpaceList
...
/**
 * Check if a given object implements the MemorySpaceList interface.
 */
export function instanceOfMemorySpaceList(value: object): value is MemorySpaceList {
...
export function MemorySpaceListFromJSON(json: any): MemorySpaceList {
    return MemorySpaceListFromJSONTyped(json, false);
}

export function MemorySpaceListFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemorySpaceList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(MemorySpaceFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function MemorySpaceListToJSON(json: any): MemorySpaceList {
    return MemorySpaceListToJSONTyped(json, false);
}

export function MemorySpaceListToJSONTyped(value?: MemorySpaceList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(MemorySpaceToJSON)),
