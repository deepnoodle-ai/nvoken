...
/**
 * Tells you which assistant message is the actual answer, so you can
...
export function instanceOfMessagePhase(value: any): boolean {
    for (const key in MessagePhase) {
        if (Object.prototype.hasOwnProperty.call(MessagePhase, key)) {
            if (MessagePhase[key as keyof typeof MessagePhase] === value) {
                return true;
            }
        }
    }
...
export function MessagePhaseFromJSON(json: any): MessagePhase {
    return MessagePhaseFromJSONTyped(json, false);
}

export function MessagePhaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MessagePhase {
    return json as MessagePhase;
}

export function MessagePhaseToJSON(value?: MessagePhase | null): any {
    return value as any;
}

export function MessagePhaseToJSONTyped(value: any, ignoreDiscriminator: boolean): MessagePhase {
    return value as MessagePhase;
}
