...
/**
 * What this fragment is part of. `text` is assistant prose,
...
export const MessageDeltaKind = {
    DeltaKindText: 'text',
    DeltaKindThinking: 'thinking',
    DeltaKindToolArguments: 'tool_arguments'
} as const;
export type MessageDeltaKind = typeof MessageDeltaKind[keyof typeof MessageDeltaKind];


export function instanceOfMessageDeltaKind(value: any): boolean {
    for (const key in MessageDeltaKind) {
        if (Object.prototype.hasOwnProperty.call(MessageDeltaKind, key)) {
            if (MessageDeltaKind[key as keyof typeof MessageDeltaKind] === value) {
                return true;
            }
        }
    }
...
export function MessageDeltaKindFromJSON(json: any): MessageDeltaKind {
    return MessageDeltaKindFromJSONTyped(json, false);
}

export function MessageDeltaKindFromJSONTyped(json: any, ignoreDiscriminator: boolean): MessageDeltaKind {
    return json as MessageDeltaKind;
}

export function MessageDeltaKindToJSON(value?: MessageDeltaKind | null): any {
    return value as any;
}

export function MessageDeltaKindToJSONTyped(value: any, ignoreDiscriminator: boolean): MessageDeltaKind {
    return value as MessageDeltaKind;
}
