 ...
 *
 * @export
 * @interface UserTurnMemory
 */
export interface UserTurnMemory {
    /**
     *
     * @type {UserTurnMemoryScopeEnum}
     * @memberof UserTurnMemory
     */
    scope: UserTurnMemoryScopeEnum;
    /**
     *
     * @type {string}
     * @memberof UserTurnMemory
 ...
 * @export
 */
export const UserTurnMemoryScopeEnum = {
    User: 'user'
} as const;
export type UserTurnMemoryScopeEnum = typeof UserTurnMemoryScopeEnum[keyof typeof UserTurnMemoryScopeEnum];


/**
 * Check if a given object implements the UserTurnMemory interface.
 */
export function instanceOfUserTurnMemory(value: object): value is UserTurnMemory {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    return true;
}

export function UserTurnMemoryFromJSON(json: any): UserTurnMemory {
    return UserTurnMemoryFromJSONTyped(json, false);
}

export function UserTurnMemoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserTurnMemory {
    if (json == null) {
        return json;
    }
    return {
...
export function UserTurnMemoryToJSON(json: any): UserTurnMemory {
    return UserTurnMemoryToJSONTyped(json, false);
}

export function UserTurnMemoryToJSONTyped(value?: UserTurnMemory | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
