...
import type { BrowserInvocationChange } from './BrowserInvocationChange.js';
import {
    BrowserInvocationChangeFromJSON,
    BrowserInvocationChangeFromJSONTyped,
    BrowserInvocationChangeToJSON,
    BrowserInvocationChangeToJSONTyped,
} from './BrowserInvocationChange.js';
import type { BrowserSessionMessage } from './BrowserSessionMessage.js';
import {
    BrowserSessionMessageFromJSON,
    BrowserSessionMessageFromJSONTyped,
    BrowserSessionMessageToJSON,
    BrowserSessionMessageToJSONTyped,
} from './BrowserSessionMessage.js';

/**
 *
 * @export
 * @interface BrowserTranscriptUpdateEvent
 */
export interface BrowserTranscriptUpdateEvent {
    /**
     *
     * @type {BrowserTranscriptUpdateEventTypeEnum}
     * @memberof BrowserTranscriptUpdateEvent
     */
    type: BrowserTranscriptUpdateEventTypeEnum;
    /**
    ...
    /**
     *
     * @type {Array<BrowserSessionMessage>}
     * @memberof BrowserTranscriptUpdateEvent
     */
    messages: Array<BrowserSessionMessage>;
    /**
     *
     * @type {Array<BrowserInvocationChange>}
     * @memberof BrowserTranscriptUpdateEvent
     */
    invocationChanges: Array<BrowserInvocationChange>;
    /**
     *
     * @type {string}
     * @memberof BrowserTranscriptUpdateEvent
 ...
 * @export
 */
export const BrowserTranscriptUpdateEventTypeEnum = {
    TranscriptUpdate: 'transcript.update'
} as const;
export type BrowserTranscriptUpdateEventTypeEnum = typeof BrowserTranscriptUpdateEventTypeEnum[keyof typeof BrowserTranscriptUpdateEventTypeEnum];


/**
 * Check if a given object implements the BrowserTranscriptUpdateEvent interface.
 */
export function instanceOfBrowserTranscriptUpdateEvent(value: object): value is BrowserTranscriptUpdateEvent {
...
export function BrowserTranscriptUpdateEventFromJSON(json: any): BrowserTranscriptUpdateEvent {
    return BrowserTranscriptUpdateEventFromJSONTyped(json, false);
}

export function BrowserTranscriptUpdateEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserTranscriptUpdateEvent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'messages': ((json['messages'] as Array<any>).map(BrowserSessionMessageFromJSON)),
        'invocationChanges': ((json['invocation_changes'] as Array<any>).map(BrowserInvocationChangeFromJSON)),
        'resumeCursor': json['resume_cursor'],
    };
}

export function BrowserTranscriptUpdateEventToJSON(json: any): BrowserTranscriptUpdateEvent {
    return BrowserTranscriptUpdateEventToJSONTyped(json, false);
}

export function BrowserTranscriptUpdateEventToJSONTyped(value?: BrowserTranscriptUpdateEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'messages': ((value['messages'] as Array<any>).map(BrowserSessionMessageToJSON)),
        'invocation_changes': ((value['invocationChanges'] as Array<any>).map(BrowserInvocationChangeToJSON)),
