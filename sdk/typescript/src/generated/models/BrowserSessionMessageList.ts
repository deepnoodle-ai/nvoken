 ...
 *
 * @export
 * @interface BrowserSessionMessageList
 */
export interface BrowserSessionMessageList {
    /**
     *
     * @type {Array<BrowserSessionMessage>}
     * @memberof BrowserSessionMessageList
     */
    items: Array<BrowserSessionMessage>;
    /**
     *
     * @type {boolean}
     * @memberof BrowserSessionMessageList
...
/**
 * Check if a given object implements the BrowserSessionMessageList interface.
 */
export function instanceOfBrowserSessionMessageList(value: object): value is BrowserSessionMessageList {
...
export function BrowserSessionMessageListFromJSON(json: any): BrowserSessionMessageList {
    return BrowserSessionMessageListFromJSONTyped(json, false);
}

export function BrowserSessionMessageListFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserSessionMessageList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(BrowserSessionMessageFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function BrowserSessionMessageListToJSON(json: any): BrowserSessionMessageList {
    return BrowserSessionMessageListToJSONTyped(json, false);
}

export function BrowserSessionMessageListToJSONTyped(value?: BrowserSessionMessageList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(BrowserSessionMessageToJSON)),
