...
/**
 * The only delivery class this HMAC key may sign.
 * @export
 */
export const AppSigningKeyPurpose = {
    Callback: 'callback',
    Webhook: 'webhook'
} as const;
export type AppSigningKeyPurpose = typeof AppSigningKeyPurpose[keyof typeof AppSigningKeyPurpose];


export function instanceOfAppSigningKeyPurpose(value: any): boolean {
    for (const key in AppSigningKeyPurpose) {
        if (Object.prototype.hasOwnProperty.call(AppSigningKeyPurpose, key)) {
            if (AppSigningKeyPurpose[key as keyof typeof AppSigningKeyPurpose] === value) {
                return true;
            }
        }
    }
...
export function AppSigningKeyPurposeFromJSON(json: any): AppSigningKeyPurpose {
    return AppSigningKeyPurposeFromJSONTyped(json, false);
}

export function AppSigningKeyPurposeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppSigningKeyPurpose {
    return json as AppSigningKeyPurpose;
}

export function AppSigningKeyPurposeToJSON(value?: AppSigningKeyPurpose | null): any {
    return value as any;
}

export function AppSigningKeyPurposeToJSONTyped(value: any, ignoreDiscriminator: boolean): AppSigningKeyPurpose {
    return value as AppSigningKeyPurpose;
}
