 ...
 * The JSON value carried by one Session-stream SSE `data:` field. Switch
 ...
 * @export
 */
export type TranscriptStreamEvent = { type: 'output_text.delta' } & OutputTextDeltaEvent | { type: 'stream.end' } & StreamEndEvent | { type: 'stream.resync' } & StreamResyncEvent | { type: 'thinking.delta' } & ThinkingDeltaEvent | { type: 'transcript.update' } & TranscriptUpdateEvent;
