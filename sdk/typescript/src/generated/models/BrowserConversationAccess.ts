...
import type { BrowserExactConversationAccess } from './BrowserExactConversationAccess.js';
import {
    instanceOfBrowserExactConversationAccess,
    BrowserExactConversationAccessFromJSON,
    BrowserExactConversationAccessFromJSONTyped,
    BrowserExactConversationAccessToJSON,
} from './BrowserExactConversationAccess.js';
import type { BrowserStandaloneOnlyAccess } from './BrowserStandaloneOnlyAccess.js';
import {
    instanceOfBrowserStandaloneOnlyAccess,
    BrowserStandaloneOnlyAccessFromJSON,
    BrowserStandaloneOnlyAccessFromJSONTyped,
    BrowserStandaloneOnlyAccessToJSON,
} from './BrowserStandaloneOnlyAccess.js';
import type { BrowserUserConversationsAccess } from './BrowserUserConversationsAccess.js';
import {
    instanceOfBrowserUserConversationsAccess,
    BrowserUserConversationsAccessFromJSON,
    BrowserUserConversationsAccessFromJSONTyped,
    BrowserUserConversationsAccessToJSON,
} from './BrowserUserConversationsAccess.js';
 ...
 * @export
 */
export type BrowserConversationAccess = { scope: 'exact' } & BrowserExactConversationAccess | { scope: 'standalone_only' } & BrowserStandaloneOnlyAccess | { scope: 'user_conversations' } & BrowserUserConversationsAccess;

export function BrowserConversationAccessFromJSON(json: any): BrowserConversationAccess {
    return BrowserConversationAccessFromJSONTyped(json, false);
}

export function BrowserConversationAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserConversationAccess {
    if (json == null) {
        return json;
    }
    switch (json['scope']) {
        case 'exact':
            return Object.assign({}, BrowserExactConversationAccessFromJSONTyped(json, true), { scope: 'exact' } as const);
        case 'standalone_only':
            return Object.assign({}, BrowserStandaloneOnlyAccessFromJSONTyped(json, true), { scope: 'standalone_only' } as const);
        case 'user_conversations':
            return Object.assign({}, BrowserUserConversationsAccessFromJSONTyped(json, true), { scope: 'user_conversations' } as const);
        default:
            return json;
    }
}

export function BrowserConversationAccessToJSON(json: any): any {
    return BrowserConversationAccessToJSONTyped(json, false);
}

export function BrowserConversationAccessToJSONTyped(value?: BrowserConversationAccess | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['scope']) {
        case 'exact':
            return Object.assign({}, BrowserExactConversationAccessToJSON(value), { scope: 'exact' } as const);
        case 'standalone_only':
            return Object.assign({}, BrowserStandaloneOnlyAccessToJSON(value), { scope: 'standalone_only' } as const);
        case 'user_conversations':
            return Object.assign({}, BrowserUserConversationsAccessToJSON(value), { scope: 'user_conversations' } as const);
        default:
            return value;
    }
}
