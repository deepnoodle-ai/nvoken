 ...
 * @export
 */
export type SessionStreamEvent = { type: 'message.delta' } & MessageDeltaEvent | { type: 'stream.end' } & StreamEndEvent | { type: 'stream.resync' } & StreamResyncEvent | { type: 'transcript.update' } & TranscriptUpdateEvent;
