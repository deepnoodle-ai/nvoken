...
import type { ConnectionClosingEvent } from './ConnectionClosingEvent.js';
import {
    instanceOfConnectionClosingEvent,
    ConnectionClosingEventFromJSON,
    ConnectionClosingEventFromJSONTyped,
    ConnectionClosingEventToJSON,
} from './ConnectionClosingEvent.js';
import type { MessageDeltaEvent } from './MessageDeltaEvent.js';
import {
    instanceOfMessageDeltaEvent,
    MessageDeltaEventFromJSON,
    MessageDeltaEventFromJSONTyped,
    MessageDeltaEventToJSON,
} from './MessageDeltaEvent.js';
...
import type { TranscriptUpdateEvent } from './TranscriptUpdateEvent.js';
import {
    instanceOfTranscriptUpdateEvent,
    TranscriptUpdateEventFromJSON,
    TranscriptUpdateEventFromJSONTyped,
    TranscriptUpdateEventToJSON,
} from './TranscriptUpdateEvent.js';

/**
 * @type SessionStreamEvent
 * The JSON value carried by one SSE `data:` field. Switch on `type`.
 ...
 * @export
 */
export type SessionStreamEvent = { type: 'connection.closing' } & ConnectionClosingEvent | { type: 'message.delta' } & MessageDeltaEvent | { type: 'stream.resync' } & StreamResyncEvent | { type: 'transcript.update' } & TranscriptUpdateEvent;

export function SessionStreamEventFromJSON(json: any): SessionStreamEvent {
    return SessionStreamEventFromJSONTyped(json, false);
}

export function SessionStreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionStreamEvent {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
        case 'connection.closing':
            return Object.assign({}, ConnectionClosingEventFromJSONTyped(json, true), { type: 'connection.closing' } as const);
        case 'message.delta':
            return Object.assign({}, MessageDeltaEventFromJSONTyped(json, true), { type: 'message.delta' } as const);
        case 'stream.resync':
            return Object.assign({}, StreamResyncEventFromJSONTyped(json, true), { type: 'stream.resync' } as const);
        case 'transcript.update':
            return Object.assign({}, TranscriptUpdateEventFromJSONTyped(json, true), { type: 'transcript.update' } as const);
        default:
            return json;
    }
}

export function SessionStreamEventToJSON(json: any): any {
    return SessionStreamEventToJSONTyped(json, false);
}

export function SessionStreamEventToJSONTyped(value?: SessionStreamEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        case 'connection.closing':
            return Object.assign({}, ConnectionClosingEventToJSON(value), { type: 'connection.closing' } as const);
        case 'message.delta':
            return Object.assign({}, MessageDeltaEventToJSON(value), { type: 'message.delta' } as const);
        case 'stream.resync':
            return Object.assign({}, StreamResyncEventToJSON(value), { type: 'stream.resync' } as const);
        case 'transcript.update':
            return Object.assign({}, TranscriptUpdateEventToJSON(value), { type: 'transcript.update' } as const);
        default:
            return value;
    }
}
