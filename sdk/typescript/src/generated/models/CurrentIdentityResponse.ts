...
import type { BrowserCurrentIdentity } from './BrowserCurrentIdentity.js';
import {
    BrowserCurrentIdentityFromJSON,
    BrowserCurrentIdentityFromJSONTyped,
    BrowserCurrentIdentityToJSON,
} from './BrowserCurrentIdentity.js';
import type { CurrentIdentity } from './CurrentIdentity.js';
import {
    CurrentIdentityFromJSON,
    CurrentIdentityFromJSONTyped,
    CurrentIdentityToJSON,
} from './CurrentIdentity.js';
 ...
 * @export
 */
export type CurrentIdentityResponse = BrowserCurrentIdentity | CurrentIdentity;

export function CurrentIdentityResponseFromJSON(json: any): CurrentIdentityResponse {
    return CurrentIdentityResponseFromJSONTyped(json, false);
}

export function CurrentIdentityResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrentIdentityResponse {
    if (json == null) {
        return json;
    }
    ...
    if (false) {
        return BrowserCurrentIdentityFromJSONTyped(json, true);
    }
    if (true) {
        return CurrentIdentityFromJSONTyped(json, true);
    }
    return {} as any;
}

export function CurrentIdentityResponseToJSON(json: any): any {
    return CurrentIdentityResponseToJSONTyped(json, false);
}

export function CurrentIdentityResponseToJSONTyped(value?: CurrentIdentityResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (false) {
        return BrowserCurrentIdentityToJSON(value as BrowserCurrentIdentity);
    }
    if (true) {
        return CurrentIdentityToJSON(value as CurrentIdentity);
    }
    return {};
}
