...
import type { ClientCurrentIdentity } from './ClientCurrentIdentity.js';
import {
    ClientCurrentIdentityFromJSON,
    ClientCurrentIdentityFromJSONTyped,
    ClientCurrentIdentityToJSON,
} from './ClientCurrentIdentity.js';
 ...
 * @export
 */
export type CurrentIdentityResponse = ClientCurrentIdentity | CurrentIdentity;
...
export function CurrentIdentityResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrentIdentityResponse {
    ...
    if (false) {
        return ClientCurrentIdentityFromJSONTyped(json, true);
    }
    if (true) {
...
export function CurrentIdentityResponseToJSONTyped(value?: CurrentIdentityResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return ClientCurrentIdentityToJSON(value as ClientCurrentIdentity);
    }
    if (true) {
