 ...
 *
 * @export
 * @interface CreditAllocationList
 */
export interface CreditAllocationList {
    /**
     *
     * @type {Array<CreditAllocation>}
     * @memberof CreditAllocationList
     */
    items: Array<CreditAllocation>;
    /**
     *
     * @type {string}
     * @memberof CreditAllocationList
...
/**
 * Check if a given object implements the CreditAllocationList interface.
 */
export function instanceOfCreditAllocationList(value: object): value is CreditAllocationList {
    if (!('items' in value) || value['items'] === undefined) return false;
    if (!('nextCursor' in value) || value['nextCursor'] === undefined) return false;
    return true;
}

export function CreditAllocationListFromJSON(json: any): CreditAllocationList {
    return CreditAllocationListFromJSONTyped(json, false);
}

export function CreditAllocationListFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditAllocationList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(CreditAllocationFromJSON)),
        'nextCursor': json['next_cursor'],
    };
}

export function CreditAllocationListToJSON(json: any): CreditAllocationList {
    return CreditAllocationListToJSONTyped(json, false);
}

export function CreditAllocationListToJSONTyped(value?: CreditAllocationList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(CreditAllocationToJSON)),
