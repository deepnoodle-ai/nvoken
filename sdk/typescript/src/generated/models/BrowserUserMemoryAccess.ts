 ...
 *
 * @export
 * @interface BrowserUserMemoryAccess
 */
export interface BrowserUserMemoryAccess {
    /**
     *
     * @type {BrowserUserMemoryAccessScopeEnum}
     * @memberof BrowserUserMemoryAccess
     */
    scope: BrowserUserMemoryAccessScopeEnum;
    /**
     *
     * @type {string}
     * @memberof BrowserUserMemoryAccess
 ...
 * @export
 */
export const BrowserUserMemoryAccessScopeEnum = {
    User: 'user'
} as const;
export type BrowserUserMemoryAccessScopeEnum = typeof BrowserUserMemoryAccessScopeEnum[keyof typeof BrowserUserMemoryAccessScopeEnum];


/**
 * Check if a given object implements the BrowserUserMemoryAccess interface.
 */
export function instanceOfBrowserUserMemoryAccess(value: object): value is BrowserUserMemoryAccess {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    if (!('namespace' in value) || value['namespace'] === undefined) return false;
    return true;
}

export function BrowserUserMemoryAccessFromJSON(json: any): BrowserUserMemoryAccess {
    return BrowserUserMemoryAccessFromJSONTyped(json, false);
}

export function BrowserUserMemoryAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserUserMemoryAccess {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserUserMemoryAccessToJSON(json: any): BrowserUserMemoryAccess {
    return BrowserUserMemoryAccessToJSONTyped(json, false);
}

export function BrowserUserMemoryAccessToJSONTyped(value?: BrowserUserMemoryAccess | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
