 ...
 * @export
 */
export const ModelCallKind = {
    Generation: 'generation',
    Compaction: 'compaction',
    Direct: 'direct'
} as const;
export type ModelCallKind = typeof ModelCallKind[keyof typeof ModelCallKind];


export function instanceOfModelCallKind(value: any): boolean {
    for (const key in ModelCallKind) {
        if (Object.prototype.hasOwnProperty.call(ModelCallKind, key)) {
            if (ModelCallKind[key as keyof typeof ModelCallKind] === value) {
                return true;
            }
        }
    }
...
export function ModelCallKindFromJSON(json: any): ModelCallKind {
    return ModelCallKindFromJSONTyped(json, false);
}

export function ModelCallKindFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCallKind {
    return json as ModelCallKind;
}

export function ModelCallKindToJSON(value?: ModelCallKind | null): any {
    return value as any;
}

export function ModelCallKindToJSONTyped(value: any, ignoreDiscriminator: boolean): ModelCallKind {
    return value as ModelCallKind;
}
