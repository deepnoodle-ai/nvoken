 ...
 *
 * @export
 * @interface MemorySearchCoverage
 */
export interface MemorySearchCoverage {
    /**
     *
     * @type {number}
     * @memberof MemorySearchCoverage
     */
...
/**
 * Check if a given object implements the MemorySearchCoverage interface.
 */
export function instanceOfMemorySearchCoverage(value: object): value is MemorySearchCoverage {
    if (!('indexedEntries' in value) || value['indexedEntries'] === undefined) return false;
    ...
    if (!('semanticAvailable' in value) || value['semanticAvailable'] === undefined) return false;
    return true;
}

export function MemorySearchCoverageFromJSON(json: any): MemorySearchCoverage {
    return MemorySearchCoverageFromJSONTyped(json, false);
}

export function MemorySearchCoverageFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemorySearchCoverage {
    if (json == null) {
        return json;
    }
    return {

        'indexedEntries': json['indexed_entries'],
        'totalEntries': json['total_entries'],
        'complete': json['complete'],
        'semanticAvailable': json['semantic_available'],
    };
}

export function MemorySearchCoverageToJSON(json: any): MemorySearchCoverage {
    return MemorySearchCoverageToJSONTyped(json, false);
}

export function MemorySearchCoverageToJSONTyped(value?: MemorySearchCoverage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'indexed_entries': value['indexedEntries'],
        'total_entries': value['totalEntries'],
        'complete': value['complete'],
        'semantic_available': value['semanticAvailable'],
    };
}
