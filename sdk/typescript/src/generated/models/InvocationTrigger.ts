...
/**
 * Immutable causal evidence for a child Invocation. The ToolCall must
 ...
 *
 * @export
 * @interface InvocationTrigger
 */
export interface InvocationTrigger {
    /**
     *
     * @type {InvocationTriggerTypeEnum}
     * @memberof InvocationTrigger
     */
    type: InvocationTriggerTypeEnum;
    /**
 ...
 * @export
 */
export const InvocationTriggerTypeEnum = {
    ToolCall: 'tool_call'
} as const;
export type InvocationTriggerTypeEnum = typeof InvocationTriggerTypeEnum[keyof typeof InvocationTriggerTypeEnum];


/**
 * Check if a given object implements the InvocationTrigger interface.
 */
export function instanceOfInvocationTrigger(value: object): value is InvocationTrigger {
    if (!('type' in value) || value['type'] === undefined) return false;
    if (!('parentInvocationId' in value) || value['parentInvocationId'] === undefined) return false;
    if (!('toolCallId' in value) || value['toolCallId'] === undefined) return false;
    return true;
}

export function InvocationTriggerFromJSON(json: any): InvocationTrigger {
    return InvocationTriggerFromJSONTyped(json, false);
}

export function InvocationTriggerFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationTrigger {
    if (json == null) {
        return json;
    }
    return {
        ...
        'type': json['type'],
        'parentInvocationId': json['parent_invocation_id'],
        'toolCallId': json['tool_call_id'],
    };
}

export function InvocationTriggerToJSON(json: any): InvocationTrigger {
    return InvocationTriggerToJSONTyped(json, false);
}

export function InvocationTriggerToJSONTyped(value?: InvocationTrigger | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'type': value['type'],
        'parent_invocation_id': value['parentInvocationId'],
