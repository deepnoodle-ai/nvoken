...
import type { ClientCurrentIdentityAuthentication } from './ClientCurrentIdentityAuthentication.js';
import {
    ClientCurrentIdentityAuthenticationFromJSON,
    ClientCurrentIdentityAuthenticationFromJSONTyped,
    ClientCurrentIdentityAuthenticationToJSON,
    ClientCurrentIdentityAuthenticationToJSONTyped,
} from './ClientCurrentIdentityAuthentication.js';

/**
 *
 * @export
 * @interface ClientCurrentIdentity
 */
export interface ClientCurrentIdentity {
    /**
     *
     * @type {ClientCurrentIdentityAuthentication}
     * @memberof ClientCurrentIdentity
     */
    authentication: ClientCurrentIdentityAuthentication;
}

/**
 * Check if a given object implements the ClientCurrentIdentity interface.
 */
export function instanceOfClientCurrentIdentity(value: object): value is ClientCurrentIdentity {
    if (!('authentication' in value) || value['authentication'] === undefined) return false;
    return true;
}

export function ClientCurrentIdentityFromJSON(json: any): ClientCurrentIdentity {
    return ClientCurrentIdentityFromJSONTyped(json, false);
}

export function ClientCurrentIdentityFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientCurrentIdentity {
    if (json == null) {
        return json;
    }
    return {

        'authentication': ClientCurrentIdentityAuthenticationFromJSON(json['authentication']),
    };
}

export function ClientCurrentIdentityToJSON(json: any): ClientCurrentIdentity {
    return ClientCurrentIdentityToJSONTyped(json, false);
}

export function ClientCurrentIdentityToJSONTyped(value?: ClientCurrentIdentity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'authentication': ClientCurrentIdentityAuthenticationToJSON(value['authentication']),
    };
}
