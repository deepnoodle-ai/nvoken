 ...
 * @export
 */
export const ConversationOwnerKind = {
    Tenant: 'tenant',
    User: 'user'
} as const;
export type ConversationOwnerKind = typeof ConversationOwnerKind[keyof typeof ConversationOwnerKind];


export function instanceOfConversationOwnerKind(value: any): boolean {
    for (const key in ConversationOwnerKind) {
        if (Object.prototype.hasOwnProperty.call(ConversationOwnerKind, key)) {
            if (ConversationOwnerKind[key as keyof typeof ConversationOwnerKind] === value) {
                return true;
            }
        }
    }
...
export function ConversationOwnerKindFromJSON(json: any): ConversationOwnerKind {
    return ConversationOwnerKindFromJSONTyped(json, false);
}

export function ConversationOwnerKindFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationOwnerKind {
    return json as ConversationOwnerKind;
}

export function ConversationOwnerKindToJSON(value?: ConversationOwnerKind | null): any {
    return value as any;
}

export function ConversationOwnerKindToJSONTyped(value: any, ignoreDiscriminator: boolean): ConversationOwnerKind {
    return value as ConversationOwnerKind;
}
