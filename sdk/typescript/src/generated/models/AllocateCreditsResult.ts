...
import type { CreditAccount } from './CreditAccount.js';
import {
    CreditAccountFromJSON,
    CreditAccountFromJSONTyped,
    CreditAccountToJSON,
    CreditAccountToJSONTyped,
} from './CreditAccount.js';
import type { CreditAllocation } from './CreditAllocation.js';
import {
    CreditAllocationFromJSON,
    CreditAllocationFromJSONTyped,
    CreditAllocationToJSON,
    CreditAllocationToJSONTyped,
} from './CreditAllocation.js';

/**
 *
 * @export
 * @interface AllocateCreditsResult
 */
export interface AllocateCreditsResult {
    /**
     *
     * @type {CreditAllocation}
     * @memberof AllocateCreditsResult
     */
...
/**
 * Check if a given object implements the AllocateCreditsResult interface.
 */
export function instanceOfAllocateCreditsResult(value: object): value is AllocateCreditsResult {
    if (!('allocation' in value) || value['allocation'] === undefined) return false;
    if (!('account' in value) || value['account'] === undefined) return false;
    return true;
}

export function AllocateCreditsResultFromJSON(json: any): AllocateCreditsResult {
    return AllocateCreditsResultFromJSONTyped(json, false);
}

export function AllocateCreditsResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllocateCreditsResult {
    if (json == null) {
        return json;
    }
    return {

        'allocation': CreditAllocationFromJSON(json['allocation']),
        'account': CreditAccountFromJSON(json['account']),
    };
}

export function AllocateCreditsResultToJSON(json: any): AllocateCreditsResult {
    return AllocateCreditsResultToJSONTyped(json, false);
}

export function AllocateCreditsResultToJSONTyped(value?: AllocateCreditsResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'allocation': CreditAllocationToJSON(value['allocation']),
        'account': CreditAccountToJSON(value['account']),
    };
}
