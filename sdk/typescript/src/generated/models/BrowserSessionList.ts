...
import {
    BrowserSessionFromJSON,
    BrowserSessionFromJSONTyped,
    BrowserSessionToJSON,
    BrowserSessionToJSONTyped,
} from './BrowserSession.js';

/**
 *
 * @export
 * @interface BrowserSessionList
 */
export interface BrowserSessionList {
    /**
     *
     * @type {Array<BrowserSession>}
     * @memberof BrowserSessionList
     */
...
/**
 * Check if a given object implements the BrowserSessionList interface.
 */
export function instanceOfBrowserSessionList(value: object): value is BrowserSessionList {
...
export function BrowserSessionListFromJSON(json: any): BrowserSessionList {
    return BrowserSessionListFromJSONTyped(json, false);
}

export function BrowserSessionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserSessionList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(BrowserSessionFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function BrowserSessionListToJSON(json: any): BrowserSessionList {
    return BrowserSessionListToJSONTyped(json, false);
}

export function BrowserSessionListToJSONTyped(value?: BrowserSessionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(BrowserSessionToJSON)),
