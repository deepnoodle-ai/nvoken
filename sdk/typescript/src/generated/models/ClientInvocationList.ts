 ...
 *
 * @export
 * @interface ClientInvocationList
 */
export interface ClientInvocationList {
    /**
     *
     * @type {Array<ClientInvocation>}
     * @memberof ClientInvocationList
     */
    items: Array<ClientInvocation>;
    /**
     *
     * @type {boolean}
     * @memberof ClientInvocationList
...
/**
 * Check if a given object implements the ClientInvocationList interface.
 */
export function instanceOfClientInvocationList(value: object): value is ClientInvocationList {
...
export function ClientInvocationListFromJSON(json: any): ClientInvocationList {
    return ClientInvocationListFromJSONTyped(json, false);
}

export function ClientInvocationListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ClientInvocationFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function ClientInvocationListToJSON(json: any): ClientInvocationList {
    return ClientInvocationListToJSONTyped(json, false);
}

export function ClientInvocationListToJSONTyped(value?: ClientInvocationList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ClientInvocationToJSON)),
