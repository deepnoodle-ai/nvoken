 ...
 *
 * @export
 * @interface CreditAccountList
 */
export interface CreditAccountList {
    /**
     *
     * @type {Array<CreditAccount>}
     * @memberof CreditAccountList
     */
    items: Array<CreditAccount>;
    /**
     *
     * @type {string}
     * @memberof CreditAccountList
...
/**
 * Check if a given object implements the CreditAccountList interface.
 */
export function instanceOfCreditAccountList(value: object): value is CreditAccountList {
    if (!('items' in value) || value['items'] === undefined) return false;
    if (!('nextCursor' in value) || value['nextCursor'] === undefined) return false;
    return true;
}

export function CreditAccountListFromJSON(json: any): CreditAccountList {
    return CreditAccountListFromJSONTyped(json, false);
}

export function CreditAccountListFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditAccountList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(CreditAccountFromJSON)),
        'nextCursor': json['next_cursor'],
    };
}

export function CreditAccountListToJSON(json: any): CreditAccountList {
    return CreditAccountListToJSONTyped(json, false);
}

export function CreditAccountListToJSONTyped(value?: CreditAccountList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(CreditAccountToJSON)),
