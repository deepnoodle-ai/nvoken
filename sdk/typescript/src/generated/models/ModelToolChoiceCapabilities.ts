 ...
 *
 * @export
 * @interface ModelToolChoiceCapabilities
 */
export interface ModelToolChoiceCapabilities {
    /**
     *
     * @type {Set<ModelToolChoiceMode>}
     * @memberof ModelToolChoiceCapabilities
     */
    modes: Set<ModelToolChoiceMode>;
    /**
     * Modes that remain exact when explicit reasoning is active.
     * @type {Set<ModelToolChoiceMode>}
     * @memberof ModelToolChoiceCapabilities
     */
    withReasoning: Set<ModelToolChoiceMode>;
}

/**
 * Check if a given object implements the ModelToolChoiceCapabilities interface.
 */
export function instanceOfModelToolChoiceCapabilities(value: object): value is ModelToolChoiceCapabilities {
    if (!('modes' in value) || value['modes'] === undefined) return false;
    if (!('withReasoning' in value) || value['withReasoning'] === undefined) return false;
    return true;
}

export function ModelToolChoiceCapabilitiesFromJSON(json: any): ModelToolChoiceCapabilities {
    return ModelToolChoiceCapabilitiesFromJSONTyped(json, false);
}

export function ModelToolChoiceCapabilitiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelToolChoiceCapabilities {
    if (json == null) {
        return json;
    }
    return {

        'modes': (new Set((json['modes'] as Array<any>).map(ModelToolChoiceModeFromJSON))),
        'withReasoning': (new Set((json['with_reasoning'] as Array<any>).map(ModelToolChoiceModeFromJSON))),
    };
}

export function ModelToolChoiceCapabilitiesToJSON(json: any): ModelToolChoiceCapabilities {
    return ModelToolChoiceCapabilitiesToJSONTyped(json, false);
}

export function ModelToolChoiceCapabilitiesToJSONTyped(value?: ModelToolChoiceCapabilities | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'modes': (Array.from(value['modes'] as Set<any>).map(ModelToolChoiceModeToJSON)),
        'with_reasoning': (Array.from(value['withReasoning'] as Set<any>).map(ModelToolChoiceModeToJSON)),
    };
}
