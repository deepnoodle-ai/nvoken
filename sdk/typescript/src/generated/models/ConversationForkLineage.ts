...
/**
 * Durable source prefix lineage. It records provenance and does not
 * imply the fork's owner.
 *
 * @export
 * @interface ConversationForkLineage
 */
...
/**
 * Check if a given object implements the ConversationForkLineage interface.
 */
export function instanceOfConversationForkLineage(value: object): value is ConversationForkLineage {
    if (!('conversationId' in value) || value['conversationId'] === undefined) return false;
    if (!('messageId' in value) || value['messageId'] === undefined) return false;
    return true;
}

export function ConversationForkLineageFromJSON(json: any): ConversationForkLineage {
    return ConversationForkLineageFromJSONTyped(json, false);
}

export function ConversationForkLineageFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationForkLineage {
    if (json == null) {
        return json;
    }
    return {
...
export function ConversationForkLineageToJSON(json: any): ConversationForkLineage {
    return ConversationForkLineageToJSONTyped(json, false);
}

export function ConversationForkLineageToJSONTyped(value?: ConversationForkLineage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
