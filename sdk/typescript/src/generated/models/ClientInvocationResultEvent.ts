...
import type { ClientInvocationResult } from './ClientInvocationResult.js';
import {
    ClientInvocationResultFromJSON,
    ClientInvocationResultFromJSONTyped,
    ClientInvocationResultToJSON,
    ClientInvocationResultToJSONTyped,
} from './ClientInvocationResult.js';

/**
 *
 * @export
 * @interface ClientInvocationResultEvent
 */
export interface ClientInvocationResultEvent {
    /**
     *
     * @type {ClientInvocationResultEventTypeEnum}
     * @memberof ClientInvocationResultEvent
     */
    type: ClientInvocationResultEventTypeEnum;
    /**
 ...
 * @export
 */
export const ClientInvocationResultEventTypeEnum = {
    InvocationResult: 'invocation.result'
} as const;
export type ClientInvocationResultEventTypeEnum = typeof ClientInvocationResultEventTypeEnum[keyof typeof ClientInvocationResultEventTypeEnum];


/**
 * Check if a given object implements the ClientInvocationResultEvent interface.
 */
export function instanceOfClientInvocationResultEvent(value: object): value is ClientInvocationResultEvent {
...
export function ClientInvocationResultEventFromJSON(json: any): ClientInvocationResultEvent {
    return ClientInvocationResultEventFromJSONTyped(json, false);
}

export function ClientInvocationResultEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationResultEvent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'result': ClientInvocationResultFromJSON(json['result']),
    };
}

export function ClientInvocationResultEventToJSON(json: any): ClientInvocationResultEvent {
    return ClientInvocationResultEventToJSONTyped(json, false);
}

export function ClientInvocationResultEventToJSONTyped(value?: ClientInvocationResultEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'result': ClientInvocationResultToJSON(value['result']),
    };
}
