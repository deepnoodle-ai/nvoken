...
/**
 * @type UpdateSessionRequestMetadataValue
 *
 * @export
 */
export type UpdateSessionRequestMetadataValue = string;

export function UpdateSessionRequestMetadataValueFromJSON(json: any): UpdateSessionRequestMetadataValue {
    return UpdateSessionRequestMetadataValueFromJSONTyped(json, false);
}

export function UpdateSessionRequestMetadataValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateSessionRequestMetadataValue {
    if (json == null) {
        return json;
    }
...
export function UpdateSessionRequestMetadataValueToJSON(json: any): any {
    return UpdateSessionRequestMetadataValueToJSONTyped(json, false);
}

export function UpdateSessionRequestMetadataValueToJSONTyped(value?: UpdateSessionRequestMetadataValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
