 ...
 * @export
 */
export type InvocationResultResponse = BrowserInvocationResult | InvocationResult;

export function InvocationResultResponseFromJSON(json: any): InvocationResultResponse {
    return InvocationResultResponseFromJSONTyped(json, false);
}

export function InvocationResultResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationResultResponse {
    if (json == null) {
        return json;
    }
    ...
    if (false) {
        return BrowserInvocationResultFromJSONTyped(json, true);
    }
    if (true) {
        return InvocationResultFromJSONTyped(json, true);
    }
    return {} as any;
}

export function InvocationResultResponseToJSON(json: any): any {
    return InvocationResultResponseToJSONTyped(json, false);
}

export function InvocationResultResponseToJSONTyped(value?: InvocationResultResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (false) {
        return BrowserInvocationResultToJSON(value as BrowserInvocationResult);
    }
    if (true) {
        return InvocationResultToJSON(value as InvocationResult);
    }
    return {};
}
