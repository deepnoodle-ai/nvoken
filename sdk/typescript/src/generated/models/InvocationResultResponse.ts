 ...
 * @export
 */
export type InvocationResultResponse = ClientInvocationResult | InvocationResult;
...
export function InvocationResultResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationResultResponse {
    ...
    if (false) {
        return ClientInvocationResultFromJSONTyped(json, true);
    }
    if (true) {
...
export function InvocationResultResponseToJSONTyped(value?: InvocationResultResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return ClientInvocationResultToJSON(value as ClientInvocationResult);
    }
    if (true) {
