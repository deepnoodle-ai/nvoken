...
import type { BrowserSessionMessageList } from './BrowserSessionMessageList.js';
import {
    BrowserSessionMessageListFromJSON,
    BrowserSessionMessageListFromJSONTyped,
    BrowserSessionMessageListToJSON,
} from './BrowserSessionMessageList.js';
 ...
 * @export
 */
export type SessionMessageListResponse = BrowserSessionMessageList | SessionMessageList;
...
export function SessionMessageListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionMessageListResponse {
    ...
    if (false) {
        return BrowserSessionMessageListFromJSONTyped(json, true);
    }
    if (true) {
...
export function SessionMessageListResponseToJSONTyped(value?: SessionMessageListResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return BrowserSessionMessageListToJSON(value as BrowserSessionMessageList);
    }
    if (true) {
