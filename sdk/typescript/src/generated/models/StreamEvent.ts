...
/**
 * @type StreamEvent
 * The JSON value carried by one SSE `data:` field, on the Turn and the
 ...
 * @export
 */
export type StreamEvent = { type: 'connection.closing' } & ConnectionClosingEvent | { type: 'message.delta' } & MessageDeltaEvent | { type: 'stream.resync' } & StreamResyncEvent | { type: 'transcript.update' } & TranscriptUpdateEvent;

export function StreamEventFromJSON(json: any): StreamEvent {
    return StreamEventFromJSONTyped(json, false);
}

export function StreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamEvent {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
...
export function StreamEventToJSON(json: any): any {
    return StreamEventToJSONTyped(json, false);
}

export function StreamEventToJSONTyped(value?: StreamEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
