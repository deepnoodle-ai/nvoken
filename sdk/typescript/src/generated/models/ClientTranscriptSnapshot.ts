 ...
 *
 * @export
 * @interface ClientTranscriptSnapshot
 */
export interface ClientTranscriptSnapshot {
    /**
     *
     * @type {Array<ClientSessionMessage>}
     * @memberof ClientTranscriptSnapshot
     */
...
/**
 * Check if a given object implements the ClientTranscriptSnapshot interface.
 */
export function instanceOfClientTranscriptSnapshot(value: object): value is ClientTranscriptSnapshot {
...
export function ClientTranscriptSnapshotFromJSON(json: any): ClientTranscriptSnapshot {
    return ClientTranscriptSnapshotFromJSONTyped(json, false);
}

export function ClientTranscriptSnapshotFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientTranscriptSnapshot {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientTranscriptSnapshotToJSON(json: any): ClientTranscriptSnapshot {
    return ClientTranscriptSnapshotToJSONTyped(json, false);
}

export function ClientTranscriptSnapshotToJSONTyped(value?: ClientTranscriptSnapshot | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
