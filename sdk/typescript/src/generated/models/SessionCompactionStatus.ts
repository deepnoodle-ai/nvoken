...
/**
 * `applied` means the new summary took effect and is what the model now
 ...
 * @export
 */
export const SessionCompactionStatus = {
    Applied: 'applied',
    FellThrough: 'fell_through'
} as const;
export type SessionCompactionStatus = typeof SessionCompactionStatus[keyof typeof SessionCompactionStatus];


export function instanceOfSessionCompactionStatus(value: any): boolean {
    for (const key in SessionCompactionStatus) {
        if (Object.prototype.hasOwnProperty.call(SessionCompactionStatus, key)) {
            if (SessionCompactionStatus[key as keyof typeof SessionCompactionStatus] === value) {
                return true;
            }
        }
    }
...
export function SessionCompactionStatusFromJSON(json: any): SessionCompactionStatus {
    return SessionCompactionStatusFromJSONTyped(json, false);
}

export function SessionCompactionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionCompactionStatus {
    return json as SessionCompactionStatus;
}

export function SessionCompactionStatusToJSON(value?: SessionCompactionStatus | null): any {
    return value as any;
}

export function SessionCompactionStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): SessionCompactionStatus {
    return value as SessionCompactionStatus;
}
