...
import type { BrowserNoMemoryAccess } from './BrowserNoMemoryAccess.js';
import {
    instanceOfBrowserNoMemoryAccess,
    BrowserNoMemoryAccessFromJSON,
    BrowserNoMemoryAccessFromJSONTyped,
    BrowserNoMemoryAccessToJSON,
} from './BrowserNoMemoryAccess.js';
import type { BrowserUserMemoryAccess } from './BrowserUserMemoryAccess.js';
import {
    instanceOfBrowserUserMemoryAccess,
    BrowserUserMemoryAccessFromJSON,
    BrowserUserMemoryAccessFromJSONTyped,
    BrowserUserMemoryAccessToJSON,
} from './BrowserUserMemoryAccess.js';
 ...
 * @export
 */
export type BrowserMemoryAccess = { scope: 'none' } & BrowserNoMemoryAccess | { scope: 'user' } & BrowserUserMemoryAccess;

export function BrowserMemoryAccessFromJSON(json: any): BrowserMemoryAccess {
    return BrowserMemoryAccessFromJSONTyped(json, false);
}

export function BrowserMemoryAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserMemoryAccess {
    if (json == null) {
        return json;
    }
    switch (json['scope']) {
        case 'none':
            return Object.assign({}, BrowserNoMemoryAccessFromJSONTyped(json, true), { scope: 'none' } as const);
        case 'user':
            return Object.assign({}, BrowserUserMemoryAccessFromJSONTyped(json, true), { scope: 'user' } as const);
        default:
            return json;
    }
}

export function BrowserMemoryAccessToJSON(json: any): any {
    return BrowserMemoryAccessToJSONTyped(json, false);
}

export function BrowserMemoryAccessToJSONTyped(value?: BrowserMemoryAccess | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['scope']) {
        case 'none':
            return Object.assign({}, BrowserNoMemoryAccessToJSON(value), { scope: 'none' } as const);
        case 'user':
            return Object.assign({}, BrowserUserMemoryAccessToJSON(value), { scope: 'user' } as const);
        default:
            return value;
    }
}
