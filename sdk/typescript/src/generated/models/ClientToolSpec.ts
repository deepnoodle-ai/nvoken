 ...
 */
export function instanceOfClientToolSpec(value: object): value is ClientToolSpec {
...
export function ClientToolSpecFromJSON(json: any): ClientToolSpec {
    return ClientToolSpecFromJSONTyped(json, false);
}

export function ClientToolSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientToolSpec {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientToolSpecToJSON(json: any): ClientToolSpec {
    return ClientToolSpecToJSONTyped(json, false);
}

export function ClientToolSpecToJSONTyped(value?: ClientToolSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
