 ...
 *
 * @export
 * @interface BrowserInvocationResult
 */
export interface BrowserInvocationResult {
    /**
     *
     * @type {BrowserInvocation}
     * @memberof BrowserInvocationResult
     */
...
/**
 * Check if a given object implements the BrowserInvocationResult interface.
 */
export function instanceOfBrowserInvocationResult(value: object): value is BrowserInvocationResult {
...
export function BrowserInvocationResultFromJSON(json: any): BrowserInvocationResult {
    return BrowserInvocationResultFromJSONTyped(json, false);
}

export function BrowserInvocationResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationResult {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserInvocationResultToJSON(json: any): BrowserInvocationResult {
    return BrowserInvocationResultToJSONTyped(json, false);
}

export function BrowserInvocationResultToJSONTyped(value?: BrowserInvocationResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
