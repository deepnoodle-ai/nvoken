...
import type { BrowserInvocationWebhook } from './BrowserInvocationWebhook.js';
import {
    BrowserInvocationWebhookFromJSON,
    BrowserInvocationWebhookFromJSONTyped,
    BrowserInvocationWebhookToJSON,
    BrowserInvocationWebhookToJSONTyped,
} from './BrowserInvocationWebhook.js';
...
export function instanceOfBrowserAccess(value: object): value is BrowserAccess {
    ...
    if (!('invocationWebhook' in value) || value['invocationWebhook'] === undefined) return false;
...
export function BrowserAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserAccess {
    ...
    return {
        ...
        'invocationWebhook': BrowserInvocationWebhookFromJSON(json['invocation_webhook']),
...
export function BrowserAccessToJSONTyped(value?: BrowserAccess | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'invocation_webhook': BrowserInvocationWebhookToJSON(value['invocationWebhook']),
