...
import type { InvocationSessionOptions } from './InvocationSessionOptions.js';
import {
    InvocationSessionOptionsFromJSON,
    InvocationSessionOptionsFromJSONTyped,
    InvocationSessionOptionsToJSON,
    InvocationSessionOptionsToJSONTyped,
} from './InvocationSessionOptions.js';
...
export interface InvocationSession {
    /**
     * `new` creates a conversation, `continue` requires an existing
     * conversation selected by `id`, and
     * `continue_or_create` resolves or creates a keyed conversation.
     *
     * @type {InvocationSessionModeEnum}
     * @memberof InvocationSession
     */
    mode: InvocationSessionModeEnum;
    /**
     * Existing conversation ID. Valid only with `continue`.
     * @type {string}
     * @memberof InvocationSession
     */
    id?: string;
    /**
     * Caller key for `continue_or_create`.
     * @type {string}
     * @memberof InvocationSession
     */
    key?: string;
    /**
     * Policy for an existing conversation's nonterminal turn. Valid only
     * when the mode can continue a Session.
     *
     * @type {InvocationSessionIfActiveEnum}
     * @memberof InvocationSession
     */
    ifActive?: InvocationSessionIfActiveEnum;
    /**
     *
     * @type {InvocationSessionOptions}
     * @memberof InvocationSession
     */
 ...
 * @export
 */
export const InvocationSessionModeEnum = {
    New: 'new',
    Continue: 'continue',
    ContinueOrCreate: 'continue_or_create'
} as const;
export type InvocationSessionModeEnum = typeof InvocationSessionModeEnum[keyof typeof InvocationSessionModeEnum];

/**
 * @export
 */
export const InvocationSessionIfActiveEnum = {
    Reject: 'reject',
    Supersede: 'supersede',
    Interrupt: 'interrupt'
} as const;
export type InvocationSessionIfActiveEnum = typeof InvocationSessionIfActiveEnum[keyof typeof InvocationSessionIfActiveEnum];


/**
 * Check if a given object implements the InvocationSession interface.
 */
export function instanceOfInvocationSession(value: object): value is InvocationSession {
    if (!('mode' in value) || value['mode'] === undefined) return false;
    return true;
}

export function InvocationSessionFromJSON(json: any): InvocationSession {
    return InvocationSessionFromJSONTyped(json, false);
}

export function InvocationSessionFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationSession {
    if (json == null) {
        return json;
    }
    return {
        ...
        'options': json['options'] == null ? undefined : InvocationSessionOptionsFromJSON(json['options']),
    };
}

export function InvocationSessionToJSON(json: any): InvocationSession {
    return InvocationSessionToJSONTyped(json, false);
}

export function InvocationSessionToJSONTyped(value?: InvocationSession | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'options': InvocationSessionOptionsToJSON(value['options']),
    };
}
