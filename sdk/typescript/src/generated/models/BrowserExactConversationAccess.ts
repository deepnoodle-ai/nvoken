 ...
 *
 * @export
 * @interface BrowserExactConversationAccess
 */
export interface BrowserExactConversationAccess {
    /**
     *
     * @type {BrowserExactConversationAccessScopeEnum}
     * @memberof BrowserExactConversationAccess
     */
    scope: BrowserExactConversationAccessScopeEnum;
    /**
 ...
 * @export
 */
export const BrowserExactConversationAccessScopeEnum = {
    Exact: 'exact'
} as const;
export type BrowserExactConversationAccessScopeEnum = typeof BrowserExactConversationAccessScopeEnum[keyof typeof BrowserExactConversationAccessScopeEnum];


/**
 * Check if a given object implements the BrowserExactConversationAccess interface.
 */
export function instanceOfBrowserExactConversationAccess(value: object): value is BrowserExactConversationAccess {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    if (!('conversationId' in value) || value['conversationId'] === undefined) return false;
    return true;
}

export function BrowserExactConversationAccessFromJSON(json: any): BrowserExactConversationAccess {
    return BrowserExactConversationAccessFromJSONTyped(json, false);
}

export function BrowserExactConversationAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserExactConversationAccess {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserExactConversationAccessToJSON(json: any): BrowserExactConversationAccess {
    return BrowserExactConversationAccessToJSONTyped(json, false);
}

export function BrowserExactConversationAccessToJSONTyped(value?: BrowserExactConversationAccess | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
