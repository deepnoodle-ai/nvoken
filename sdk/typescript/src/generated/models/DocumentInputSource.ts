 ...
 *
 * @export
 * @interface DocumentInputSource
 */
export interface DocumentInputSource {
    /**
     *
     * @type {DocumentInputSourceMediaTypeEnum}
     * @memberof DocumentInputSource
     */
    mediaType?: DocumentInputSourceMediaTypeEnum;
    /**
    ...
    data?: string;
    /**
     * A public HTTPS URL, downloaded once as the turn is created. nvoken
 ...
 * @export
 */
export const DocumentInputSourceMediaTypeEnum = {
    DocumentPDF: 'application/pdf'
} as const;
export type DocumentInputSourceMediaTypeEnum = typeof DocumentInputSourceMediaTypeEnum[keyof typeof DocumentInputSourceMediaTypeEnum];


/**
 * Check if a given object implements the DocumentInputSource interface.
 */
export function instanceOfDocumentInputSource(value: object): value is DocumentInputSource {
    return true;
}

export function DocumentInputSourceFromJSON(json: any): DocumentInputSource {
    return DocumentInputSourceFromJSONTyped(json, false);
}

export function DocumentInputSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): DocumentInputSource {
    if (json == null) {
        return json;
    }
    return {
...
export function DocumentInputSourceToJSON(json: any): DocumentInputSource {
    return DocumentInputSourceToJSONTyped(json, false);
}

export function DocumentInputSourceToJSONTyped(value?: DocumentInputSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
