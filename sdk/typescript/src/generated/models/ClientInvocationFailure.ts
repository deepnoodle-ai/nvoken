 ...
 *
 * @export
 * @interface ClientInvocationFailure
 */
export interface ClientInvocationFailure {
    /**
     *
     * @type {string}
     * @memberof ClientInvocationFailure
     */
    code: string;
    /**
     *
...
/**
 * Check if a given object implements the ClientInvocationFailure interface.
 */
export function instanceOfClientInvocationFailure(value: object): value is ClientInvocationFailure {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function ClientInvocationFailureFromJSON(json: any): ClientInvocationFailure {
    return ClientInvocationFailureFromJSONTyped(json, false);
}

export function ClientInvocationFailureFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationFailure {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientInvocationFailureToJSON(json: any): ClientInvocationFailure {
    return ClientInvocationFailureToJSONTyped(json, false);
}

export function ClientInvocationFailureToJSONTyped(value?: ClientInvocationFailure | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
