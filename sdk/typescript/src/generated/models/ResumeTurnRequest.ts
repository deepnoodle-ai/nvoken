 ...
 * held Turn's `stop_reason`. Exactly that field must be present
 * and must be raised above both the previous ceiling and usage so far.
 *
 * @export
 * @interface ResumeTurnRequest
 */
export interface ResumeTurnRequest {
    /**
     *
     * @type {Limits}
     * @memberof ResumeTurnRequest
     */
    limits: Limits;
}

/**
 * Check if a given object implements the ResumeTurnRequest interface.
 */
export function instanceOfResumeTurnRequest(value: object): value is ResumeTurnRequest {
    if (!('limits' in value) || value['limits'] === undefined) return false;
    return true;
}

export function ResumeTurnRequestFromJSON(json: any): ResumeTurnRequest {
    return ResumeTurnRequestFromJSONTyped(json, false);
}

export function ResumeTurnRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResumeTurnRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ResumeTurnRequestToJSON(json: any): ResumeTurnRequest {
    return ResumeTurnRequestToJSONTyped(json, false);
}

export function ResumeTurnRequestToJSONTyped(value?: ResumeTurnRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
