 ...
 *
 * @export
 * @interface TenantConversationOwner
 */
export interface TenantConversationOwner {
    /**
     *
     * @type {TenantConversationOwnerKindEnum}
     * @memberof TenantConversationOwner
     */
    kind: TenantConversationOwnerKindEnum;
}
 ...
 * @export
 */
export const TenantConversationOwnerKindEnum = {
    Tenant: 'tenant'
} as const;
export type TenantConversationOwnerKindEnum = typeof TenantConversationOwnerKindEnum[keyof typeof TenantConversationOwnerKindEnum];


/**
 * Check if a given object implements the TenantConversationOwner interface.
 */
export function instanceOfTenantConversationOwner(value: object): value is TenantConversationOwner {
    if (!('kind' in value) || value['kind'] === undefined) return false;
    return true;
}

export function TenantConversationOwnerFromJSON(json: any): TenantConversationOwner {
    return TenantConversationOwnerFromJSONTyped(json, false);
}

export function TenantConversationOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): TenantConversationOwner {
    if (json == null) {
        return json;
    }
    return {
...
export function TenantConversationOwnerToJSON(json: any): TenantConversationOwner {
    return TenantConversationOwnerToJSONTyped(json, false);
}

export function TenantConversationOwnerToJSONTyped(value?: TenantConversationOwner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
