...
/**
 * Placeholder for an assistant message whose content is private.
 * @export
...
export interface RedactedBlock {
    /**
     *
     * @type {RedactedBlockTypeEnum}
     * @memberof RedactedBlock
     */
    type: RedactedBlockTypeEnum;
}
 ...
 * @export
 */
export const RedactedBlockTypeEnum = {
    TypeRedacted: 'redacted'
} as const;
export type RedactedBlockTypeEnum = typeof RedactedBlockTypeEnum[keyof typeof RedactedBlockTypeEnum];


/**
 * Check if a given object implements the RedactedBlock interface.
 */
export function instanceOfRedactedBlock(value: object): value is RedactedBlock {
    if (!('type' in value) || value['type'] === undefined) return false;
    return true;
}

export function RedactedBlockFromJSON(json: any): RedactedBlock {
    return RedactedBlockFromJSONTyped(json, false);
}

export function RedactedBlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): RedactedBlock {
    if (json == null) {
        return json;
    }
    return {
...
export function RedactedBlockToJSON(json: any): RedactedBlock {
    return RedactedBlockToJSONTyped(json, false);
}

export function RedactedBlockToJSONTyped(value?: RedactedBlock | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
