 ...
 *
 * @export
 * @interface AdmissionReasonCount
 */
export interface AdmissionReasonCount {
    /**
     *
     * @type {string}
     * @memberof AdmissionReasonCount
     */
    errorCode: string;
    /**
     *
...
/**
 * Check if a given object implements the AdmissionReasonCount interface.
 */
export function instanceOfAdmissionReasonCount(value: object): value is AdmissionReasonCount {
    if (!('errorCode' in value) || value['errorCode'] === undefined) return false;
    if (!('count' in value) || value['count'] === undefined) return false;
    return true;
}

export function AdmissionReasonCountFromJSON(json: any): AdmissionReasonCount {
    return AdmissionReasonCountFromJSONTyped(json, false);
}

export function AdmissionReasonCountFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdmissionReasonCount {
    if (json == null) {
        return json;
    }
    return {
...
export function AdmissionReasonCountToJSON(json: any): AdmissionReasonCount {
    return AdmissionReasonCountToJSONTyped(json, false);
}

export function AdmissionReasonCountToJSONTyped(value?: AdmissionReasonCount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
