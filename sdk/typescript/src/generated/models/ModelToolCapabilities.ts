...
import type { ModelToolChoiceCapabilities } from './ModelToolChoiceCapabilities.js';
import {
    ModelToolChoiceCapabilitiesFromJSON,
    ModelToolChoiceCapabilitiesFromJSONTyped,
    ModelToolChoiceCapabilitiesToJSON,
    ModelToolChoiceCapabilitiesToJSONTyped,
} from './ModelToolChoiceCapabilities.js';
...
export interface ModelToolCapabilities {
    /**
     *
     * @type {ModelToolChoiceCapabilities}
     * @memberof ModelToolCapabilities
     */
    choice: ModelToolChoiceCapabilities;
    /**
     * Whether this model can run the provider's own web search. If it reports
...
/**
 * Check if a given object implements the ModelToolCapabilities interface.
 */
export function instanceOfModelToolCapabilities(value: object): value is ModelToolCapabilities {
    if (!('choice' in value) || value['choice'] === undefined) return false;
    if (!('webSearch' in value) || value['webSearch'] === undefined) return false;
    return true;
}

export function ModelToolCapabilitiesFromJSON(json: any): ModelToolCapabilities {
    return ModelToolCapabilitiesFromJSONTyped(json, false);
}

export function ModelToolCapabilitiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelToolCapabilities {
    if (json == null) {
        return json;
    }
    return {

        'choice': ModelToolChoiceCapabilitiesFromJSON(json['choice']),
        'webSearch': json['web_search'],
    };
}

export function ModelToolCapabilitiesToJSON(json: any): ModelToolCapabilities {
    return ModelToolCapabilitiesToJSONTyped(json, false);
}

export function ModelToolCapabilitiesToJSONTyped(value?: ModelToolCapabilities | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'choice': ModelToolChoiceCapabilitiesToJSON(value['choice']),
