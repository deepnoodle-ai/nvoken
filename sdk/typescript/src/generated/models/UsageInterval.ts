 ...
 * @export
 */
export const UsageInterval = {
    Day: 'day',
    Week: 'week',
    Month: 'month'
} as const;
export type UsageInterval = typeof UsageInterval[keyof typeof UsageInterval];


export function instanceOfUsageInterval(value: any): boolean {
    for (const key in UsageInterval) {
        if (Object.prototype.hasOwnProperty.call(UsageInterval, key)) {
            if (UsageInterval[key as keyof typeof UsageInterval] === value) {
                return true;
            }
        }
    }
...
export function UsageIntervalFromJSON(json: any): UsageInterval {
    return UsageIntervalFromJSONTyped(json, false);
}

export function UsageIntervalFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageInterval {
    return json as UsageInterval;
}

export function UsageIntervalToJSON(value?: UsageInterval | null): any {
    return value as any;
}

export function UsageIntervalToJSONTyped(value: any, ignoreDiscriminator: boolean): UsageInterval {
    return value as UsageInterval;
}
