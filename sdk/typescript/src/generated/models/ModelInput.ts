...
/**
 * @type ModelInput
 * Which model to use. The object form — separate `provider` and `id` — is
...
export function ModelInputFromJSON(json: any): ModelInput {
    return ModelInputFromJSONTyped(json, false);
}

export function ModelInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelInput {
    if (json == null) {
        return json;
    }
...
export function ModelInputToJSON(json: any): any {
    return ModelInputToJSONTyped(json, false);
}

export function ModelInputToJSONTyped(value?: ModelInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
