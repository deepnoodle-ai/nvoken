...
import type { AgentRevision } from './AgentRevision.js';
import {
    AgentRevisionFromJSON,
    AgentRevisionFromJSONTyped,
    AgentRevisionToJSON,
    AgentRevisionToJSONTyped,
} from './AgentRevision.js';

/**
 *
 * @export
 * @interface AgentRevisionList
 */
export interface AgentRevisionList {
    /**
     *
     * @type {Array<AgentRevision>}
     * @memberof AgentRevisionList
     */
    items: Array<AgentRevision>;
    /**
     *
     * @type {boolean}
     * @memberof AgentRevisionList
...
/**
 * Check if a given object implements the AgentRevisionList interface.
 */
export function instanceOfAgentRevisionList(value: object): value is AgentRevisionList {
...
export function AgentRevisionListFromJSON(json: any): AgentRevisionList {
    return AgentRevisionListFromJSONTyped(json, false);
}

export function AgentRevisionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentRevisionList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(AgentRevisionFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function AgentRevisionListToJSON(json: any): AgentRevisionList {
    return AgentRevisionListToJSONTyped(json, false);
}

export function AgentRevisionListToJSONTyped(value?: AgentRevisionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(AgentRevisionToJSON)),
