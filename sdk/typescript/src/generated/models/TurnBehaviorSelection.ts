...
import type { AgentTurnBehavior } from './AgentTurnBehavior.js';
import {
    instanceOfAgentTurnBehavior,
    AgentTurnBehaviorFromJSON,
    AgentTurnBehaviorFromJSONTyped,
    AgentTurnBehaviorToJSON,
} from './AgentTurnBehavior.js';
import type { InlineTurnBehavior } from './InlineTurnBehavior.js';
import {
    instanceOfInlineTurnBehavior,
    InlineTurnBehaviorFromJSON,
    InlineTurnBehaviorFromJSONTyped,
    InlineTurnBehaviorToJSON,
} from './InlineTurnBehavior.js';
 ...
 * @export
 */
export type TurnBehaviorSelection = { kind: 'agent' } & AgentTurnBehavior | { kind: 'inline' } & InlineTurnBehavior;

export function TurnBehaviorSelectionFromJSON(json: any): TurnBehaviorSelection {
    return TurnBehaviorSelectionFromJSONTyped(json, false);
}

export function TurnBehaviorSelectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnBehaviorSelection {
    if (json == null) {
        return json;
    }
    switch (json['kind']) {
        case 'agent':
            return Object.assign({}, AgentTurnBehaviorFromJSONTyped(json, true), { kind: 'agent' } as const);
        case 'inline':
            return Object.assign({}, InlineTurnBehaviorFromJSONTyped(json, true), { kind: 'inline' } as const);
        default:
            return json;
    }
}

export function TurnBehaviorSelectionToJSON(json: any): any {
    return TurnBehaviorSelectionToJSONTyped(json, false);
}

export function TurnBehaviorSelectionToJSONTyped(value?: TurnBehaviorSelection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['kind']) {
        case 'agent':
            return Object.assign({}, AgentTurnBehaviorToJSON(value), { kind: 'agent' } as const);
        case 'inline':
            return Object.assign({}, InlineTurnBehaviorToJSON(value), { kind: 'inline' } as const);
        default:
            return value;
    }
}
