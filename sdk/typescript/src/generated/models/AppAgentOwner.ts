 ...
 *
 * @export
 * @interface AppAgentOwner
 */
export interface AppAgentOwner {
    /**
     *
     * @type {AppAgentOwnerKindEnum}
     * @memberof AppAgentOwner
     */
    kind: AppAgentOwnerKindEnum;
}
 ...
 * @export
 */
export const AppAgentOwnerKindEnum = {
    App: 'app'
} as const;
export type AppAgentOwnerKindEnum = typeof AppAgentOwnerKindEnum[keyof typeof AppAgentOwnerKindEnum];


/**
 * Check if a given object implements the AppAgentOwner interface.
 */
export function instanceOfAppAgentOwner(value: object): value is AppAgentOwner {
    if (!('kind' in value) || value['kind'] === undefined) return false;
    return true;
}

export function AppAgentOwnerFromJSON(json: any): AppAgentOwner {
    return AppAgentOwnerFromJSONTyped(json, false);
}

export function AppAgentOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppAgentOwner {
    if (json == null) {
        return json;
    }
    return {
...
export function AppAgentOwnerToJSON(json: any): AppAgentOwner {
    return AppAgentOwnerToJSONTyped(json, false);
}

export function AppAgentOwnerToJSONTyped(value?: AppAgentOwner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
