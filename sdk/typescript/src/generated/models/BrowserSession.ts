...
export interface BrowserSession {
    ...
    /**
     *
     * @type {BrowserSessionActiveInvocationStatusEnum}
     * @memberof BrowserSession
     */
    activeInvocationStatus: BrowserSessionActiveInvocationStatusEnum | null;
    /**
     *
     * @type {Date}
     * @memberof BrowserSession
 ...
 * @export
 */
export const BrowserSessionActiveInvocationStatusEnum = {
    Queued: 'queued',
    Running: 'running',
    Waiting: 'waiting',
    Paused: 'paused'
} as const;
export type BrowserSessionActiveInvocationStatusEnum = typeof BrowserSessionActiveInvocationStatusEnum[keyof typeof BrowserSessionActiveInvocationStatusEnum];


/**
 * Check if a given object implements the BrowserSession interface.
 */
export function instanceOfBrowserSession(value: object): value is BrowserSession {
...
export function BrowserSessionFromJSON(json: any): BrowserSession {
    return BrowserSessionFromJSONTyped(json, false);
}

export function BrowserSessionFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserSession {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserSessionToJSON(json: any): BrowserSession {
    return BrowserSessionToJSONTyped(json, false);
}

export function BrowserSessionToJSONTyped(value?: BrowserSession | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
