 ...
 *
 * @export
 * @interface AgentDefinitionCreate
 */
...
/**
 * Check if a given object implements the AgentDefinitionCreate interface.
 */
...
export function AgentDefinitionCreateFromJSON(json: any): AgentDefinitionCreate {
    return AgentDefinitionCreateFromJSONTyped(json, false);
}

export function AgentDefinitionCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentDefinitionCreate {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentDefinitionCreateToJSON(json: any): AgentDefinitionCreate {
    return AgentDefinitionCreateToJSONTyped(json, false);
}

export function AgentDefinitionCreateToJSONTyped(value?: AgentDefinitionCreate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
