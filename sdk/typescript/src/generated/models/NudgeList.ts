...
import type { Nudge } from './Nudge.js';
import {
    NudgeFromJSON,
    NudgeFromJSONTyped,
    NudgeToJSON,
...
/**
 * Check if a given object implements the NudgeList interface.
 */
export function instanceOfNudgeList(value: object): value is NudgeList {
...
export function NudgeListFromJSON(json: any): NudgeList {
    return NudgeListFromJSONTyped(json, false);
}

export function NudgeListFromJSONTyped(json: any, ignoreDiscriminator: boolean): NudgeList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(NudgeFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function NudgeListToJSON(json: any): NudgeList {
    return NudgeListToJSONTyped(json, false);
}

export function NudgeListToJSONTyped(value?: NudgeList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(NudgeToJSON)),
