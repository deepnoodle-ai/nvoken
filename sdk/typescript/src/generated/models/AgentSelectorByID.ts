...
/**
 * Check if a given object implements the AgentSelectorByID interface.
 */
export function instanceOfAgentSelectorByID(value: object): value is AgentSelectorByID {
    if (!('agentId' in value) || value['agentId'] === undefined) return false;
    if (!('revision' in value) || value['revision'] === undefined) return false;
    return true;
}

export function AgentSelectorByIDFromJSON(json: any): AgentSelectorByID {
    return AgentSelectorByIDFromJSONTyped(json, false);
}

export function AgentSelectorByIDFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentSelectorByID {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentSelectorByIDToJSON(json: any): AgentSelectorByID {
    return AgentSelectorByIDToJSONTyped(json, false);
}

export function AgentSelectorByIDToJSONTyped(value?: AgentSelectorByID | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
