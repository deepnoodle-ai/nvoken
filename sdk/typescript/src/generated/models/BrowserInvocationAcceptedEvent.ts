 ...
 *
 * @export
 * @interface BrowserInvocationAcceptedEvent
 */
export interface BrowserInvocationAcceptedEvent {
    /**
     *
     * @type {BrowserInvocationAcceptedEventTypeEnum}
     * @memberof BrowserInvocationAcceptedEvent
     */
    type: BrowserInvocationAcceptedEventTypeEnum;
    /**
 ...
 * @export
 */
export const BrowserInvocationAcceptedEventTypeEnum = {
    InvocationAccepted: 'invocation.accepted'
} as const;
export type BrowserInvocationAcceptedEventTypeEnum = typeof BrowserInvocationAcceptedEventTypeEnum[keyof typeof BrowserInvocationAcceptedEventTypeEnum];


/**
 * Check if a given object implements the BrowserInvocationAcceptedEvent interface.
 */
export function instanceOfBrowserInvocationAcceptedEvent(value: object): value is BrowserInvocationAcceptedEvent {
...
export function BrowserInvocationAcceptedEventFromJSON(json: any): BrowserInvocationAcceptedEvent {
    return BrowserInvocationAcceptedEventFromJSONTyped(json, false);
}

export function BrowserInvocationAcceptedEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationAcceptedEvent {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserInvocationAcceptedEventToJSON(json: any): BrowserInvocationAcceptedEvent {
    return BrowserInvocationAcceptedEventToJSONTyped(json, false);
}

export function BrowserInvocationAcceptedEventToJSONTyped(value?: BrowserInvocationAcceptedEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
