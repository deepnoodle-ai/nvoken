 ...
 *
 * @export
 * @interface DeliveryAgentRevisionSource
 */
export interface DeliveryAgentRevisionSource {
    /**
     *
     * @type {DeliveryAgentRevisionSourceKindEnum}
 ...
 * @export
 */
export const DeliveryAgentRevisionSourceKindEnum = {
    AgentRevision: 'agent_revision'
} as const;
export type DeliveryAgentRevisionSourceKindEnum = typeof DeliveryAgentRevisionSourceKindEnum[keyof typeof DeliveryAgentRevisionSourceKindEnum];


/**
 * Check if a given object implements the DeliveryAgentRevisionSource interface.
 */
export function instanceOfDeliveryAgentRevisionSource(value: object): value is DeliveryAgentRevisionSource {
...
export function DeliveryAgentRevisionSourceFromJSON(json: any): DeliveryAgentRevisionSource {
    return DeliveryAgentRevisionSourceFromJSONTyped(json, false);
}

export function DeliveryAgentRevisionSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeliveryAgentRevisionSource {
    if (json == null) {
        return json;
    }
    return {
...
export function DeliveryAgentRevisionSourceToJSON(json: any): DeliveryAgentRevisionSource {
    return DeliveryAgentRevisionSourceToJSONTyped(json, false);
}

export function DeliveryAgentRevisionSourceToJSONTyped(value?: DeliveryAgentRevisionSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
