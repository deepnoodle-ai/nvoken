...
import type { MemorySpaceSelector } from './MemorySpaceSelector.js';
import {
    MemorySpaceSelectorFromJSON,
    MemorySpaceSelectorFromJSONTyped,
    MemorySpaceSelectorToJSON,
    MemorySpaceSelectorToJSONTyped,
} from './MemorySpaceSelector.js';

/**
 *
 * @export
 * @interface ResolveMemorySpaceRequest
 */
export interface ResolveMemorySpaceRequest {
    /**
     *
     * @type {string}
     * @memberof ResolveMemorySpaceRequest
     */
    tenantKey: string;
    /**
     *
...
/**
 * Check if a given object implements the ResolveMemorySpaceRequest interface.
 */
export function instanceOfResolveMemorySpaceRequest(value: object): value is ResolveMemorySpaceRequest {
    if (!('tenantKey' in value) || value['tenantKey'] === undefined) return false;
    if (!('selector' in value) || value['selector'] === undefined) return false;
    return true;
}

export function ResolveMemorySpaceRequestFromJSON(json: any): ResolveMemorySpaceRequest {
    return ResolveMemorySpaceRequestFromJSONTyped(json, false);
}

export function ResolveMemorySpaceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResolveMemorySpaceRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'selector': MemorySpaceSelectorFromJSON(json['selector']),
        'retentionTtlSeconds': json['retention_ttl_seconds'] == null ? undefined : json['retention_ttl_seconds'],
        'expiresAt': json['expires_at'] == null ? undefined : (new Date(json['expires_at'])),
    };
}

export function ResolveMemorySpaceRequestToJSON(json: any): ResolveMemorySpaceRequest {
    return ResolveMemorySpaceRequestToJSONTyped(json, false);
}

export function ResolveMemorySpaceRequestToJSONTyped(value?: ResolveMemorySpaceRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'selector': MemorySpaceSelectorToJSON(value['selector']),
