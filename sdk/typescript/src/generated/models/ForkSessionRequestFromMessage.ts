 ...
 * @export
 */
export type ForkSessionRequestFromMessage = number | string;

export function ForkSessionRequestFromMessageFromJSON(json: any): ForkSessionRequestFromMessage {
    return ForkSessionRequestFromMessageFromJSONTyped(json, false);
}

export function ForkSessionRequestFromMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): ForkSessionRequestFromMessage {
    if (json == null) {
        return json;
    }
...
export function ForkSessionRequestFromMessageToJSON(json: any): any {
    return ForkSessionRequestFromMessageToJSONTyped(json, false);
}

export function ForkSessionRequestFromMessageToJSONTyped(value?: ForkSessionRequestFromMessage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
