...
/**
 * Check if a given object implements the WebSearchLocation interface.
 */
export function instanceOfWebSearchLocation(value: object): value is WebSearchLocation {
    return true;
}

export function WebSearchLocationFromJSON(json: any): WebSearchLocation {
    return WebSearchLocationFromJSONTyped(json, false);
}

export function WebSearchLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebSearchLocation {
    if (json == null) {
        return json;
    }
    return {
...
export function WebSearchLocationToJSON(json: any): WebSearchLocation {
    return WebSearchLocationToJSONTyped(json, false);
}

export function WebSearchLocationToJSONTyped(value?: WebSearchLocation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
