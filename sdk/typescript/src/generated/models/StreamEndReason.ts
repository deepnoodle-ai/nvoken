...
/**
 * Why this connection is closing. No reason here speaks about a turn:
...
export type StreamEndReason = typeof StreamEndReason[keyof typeof StreamEndReason];


export function instanceOfStreamEndReason(value: any): boolean {
    for (const key in StreamEndReason) {
        if (Object.prototype.hasOwnProperty.call(StreamEndReason, key)) {
            if (StreamEndReason[key as keyof typeof StreamEndReason] === value) {
                return true;
            }
        }
    }
...
export function StreamEndReasonFromJSON(json: any): StreamEndReason {
    return StreamEndReasonFromJSONTyped(json, false);
}

export function StreamEndReasonFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamEndReason {
    return json as StreamEndReason;
}

export function StreamEndReasonToJSON(value?: StreamEndReason | null): any {
    return value as any;
}

export function StreamEndReasonToJSONTyped(value: any, ignoreDiscriminator: boolean): StreamEndReason {
    return value as StreamEndReason;
}
