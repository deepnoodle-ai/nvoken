 ...
 *
 * @export
 * @interface BrowserNoMemoryAccess
 */
export interface BrowserNoMemoryAccess {
    /**
     *
     * @type {BrowserNoMemoryAccessScopeEnum}
     * @memberof BrowserNoMemoryAccess
     */
    scope: BrowserNoMemoryAccessScopeEnum;
}
 ...
 * @export
 */
export const BrowserNoMemoryAccessScopeEnum = {
    None: 'none'
} as const;
export type BrowserNoMemoryAccessScopeEnum = typeof BrowserNoMemoryAccessScopeEnum[keyof typeof BrowserNoMemoryAccessScopeEnum];


/**
 * Check if a given object implements the BrowserNoMemoryAccess interface.
 */
export function instanceOfBrowserNoMemoryAccess(value: object): value is BrowserNoMemoryAccess {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    return true;
}

export function BrowserNoMemoryAccessFromJSON(json: any): BrowserNoMemoryAccess {
    return BrowserNoMemoryAccessFromJSONTyped(json, false);
}

export function BrowserNoMemoryAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserNoMemoryAccess {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserNoMemoryAccessToJSON(json: any): BrowserNoMemoryAccess {
    return BrowserNoMemoryAccessToJSONTyped(json, false);
}

export function BrowserNoMemoryAccessToJSONTyped(value?: BrowserNoMemoryAccess | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
