...
export interface SessionOptions {
    ...
    /**
     * What this conversation or standalone turn is bound to, in your own terms. If your authorization
     ...
     * @memberof SessionOptions
     */
    authorizationContext?: { [key: string]: string; };
    /**
     * What you are asserting about a Session that already exists.
     ...
     *
     * @type {SessionOptionsOnConflictEnum}
     * @memberof SessionOptions
     */
    onConflict?: SessionOptionsOnConflictEnum;
}
 ...
 * @export
 */
export const SessionOptionsOnConflictEnum = {
    Refuse: 'refuse',
    Join: 'join'
} as const;
export type SessionOptionsOnConflictEnum = typeof SessionOptionsOnConflictEnum[keyof typeof SessionOptionsOnConflictEnum];
