...
import type { ClientSessionMessage } from './ClientSessionMessage.js';
import {
    ClientSessionMessageFromJSON,
    ClientSessionMessageFromJSONTyped,
    ClientSessionMessageToJSON,
    ClientSessionMessageToJSONTyped,
} from './ClientSessionMessage.js';
import type { ClientInvocation } from './ClientInvocation.js';
import {
    ClientInvocationFromJSON,
    ClientInvocationFromJSONTyped,
    ClientInvocationToJSON,
    ClientInvocationToJSONTyped,
} from './ClientInvocation.js';

/**
 *
 * @export
 * @interface ClientInvocationUpdateEvent
 */
export interface ClientInvocationUpdateEvent {
    /**
     *
     * @type {ClientInvocationUpdateEventTypeEnum}
     * @memberof ClientInvocationUpdateEvent
     */
    type: ClientInvocationUpdateEventTypeEnum;
    /**
    ...
    /**
     *
     * @type {Array<ClientSessionMessage>}
     * @memberof ClientInvocationUpdateEvent
     */
    newMessages: Array<ClientSessionMessage>;
}
 ...
 * @export
 */
export const ClientInvocationUpdateEventTypeEnum = {
    InvocationUpdate: 'invocation.update'
} as const;
export type ClientInvocationUpdateEventTypeEnum = typeof ClientInvocationUpdateEventTypeEnum[keyof typeof ClientInvocationUpdateEventTypeEnum];


/**
 * Check if a given object implements the ClientInvocationUpdateEvent interface.
 */
export function instanceOfClientInvocationUpdateEvent(value: object): value is ClientInvocationUpdateEvent {
...
export function ClientInvocationUpdateEventFromJSON(json: any): ClientInvocationUpdateEvent {
    return ClientInvocationUpdateEventFromJSONTyped(json, false);
}

export function ClientInvocationUpdateEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationUpdateEvent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'invocation': ClientInvocationFromJSON(json['invocation']),
        'newMessages': ((json['new_messages'] as Array<any>).map(ClientSessionMessageFromJSON)),
    };
}

export function ClientInvocationUpdateEventToJSON(json: any): ClientInvocationUpdateEvent {
    return ClientInvocationUpdateEventToJSONTyped(json, false);
}

export function ClientInvocationUpdateEventToJSONTyped(value?: ClientInvocationUpdateEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'invocation': ClientInvocationToJSON(value['invocation']),
        'new_messages': ((value['newMessages'] as Array<any>).map(ClientSessionMessageToJSON)),
    };
}
