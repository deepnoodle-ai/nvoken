 ...
 *
 * @export
 * @interface TenantAgentOwner
 */
export interface TenantAgentOwner {
    /**
     *
     * @type {TenantAgentOwnerKindEnum}
     * @memberof TenantAgentOwner
     */
    kind: TenantAgentOwnerKindEnum;
    /**
     *
     * @type {string}
     * @memberof TenantAgentOwner
 ...
 * @export
 */
export const TenantAgentOwnerKindEnum = {
    Tenant: 'tenant'
} as const;
export type TenantAgentOwnerKindEnum = typeof TenantAgentOwnerKindEnum[keyof typeof TenantAgentOwnerKindEnum];


/**
 * Check if a given object implements the TenantAgentOwner interface.
 */
export function instanceOfTenantAgentOwner(value: object): value is TenantAgentOwner {
    if (!('kind' in value) || value['kind'] === undefined) return false;
    if (!('tenantKey' in value) || value['tenantKey'] === undefined) return false;
    return true;
}

export function TenantAgentOwnerFromJSON(json: any): TenantAgentOwner {
    return TenantAgentOwnerFromJSONTyped(json, false);
}

export function TenantAgentOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): TenantAgentOwner {
    if (json == null) {
        return json;
    }
    return {
...
export function TenantAgentOwnerToJSON(json: any): TenantAgentOwner {
    return TenantAgentOwnerToJSONTyped(json, false);
}

export function TenantAgentOwnerToJSONTyped(value?: TenantAgentOwner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
