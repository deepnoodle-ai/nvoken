...
import type { ContinueOrCreateTurnConversation } from './ContinueOrCreateTurnConversation.js';
import {
    instanceOfContinueOrCreateTurnConversation,
    ContinueOrCreateTurnConversationFromJSON,
    ContinueOrCreateTurnConversationFromJSONTyped,
    ContinueOrCreateTurnConversationToJSON,
} from './ContinueOrCreateTurnConversation.js';
import type { ContinueTurnConversation } from './ContinueTurnConversation.js';
import {
    instanceOfContinueTurnConversation,
    ContinueTurnConversationFromJSON,
    ContinueTurnConversationFromJSONTyped,
    ContinueTurnConversationToJSON,
} from './ContinueTurnConversation.js';
import type { NewTurnConversation } from './NewTurnConversation.js';
import {
    instanceOfNewTurnConversation,
    NewTurnConversationFromJSON,
    NewTurnConversationFromJSONTyped,
    NewTurnConversationToJSON,
} from './NewTurnConversation.js';
 ...
 * @export
 */
export type TurnConversation = { mode: 'continue' } & ContinueTurnConversation | { mode: 'continue_or_create' } & ContinueOrCreateTurnConversation | { mode: 'new' } & NewTurnConversation;

export function TurnConversationFromJSON(json: any): TurnConversation {
    return TurnConversationFromJSONTyped(json, false);
}

export function TurnConversationFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnConversation {
    if (json == null) {
        return json;
    }
    switch (json['mode']) {
        case 'continue':
            return Object.assign({}, ContinueTurnConversationFromJSONTyped(json, true), { mode: 'continue' } as const);
        case 'continue_or_create':
            return Object.assign({}, ContinueOrCreateTurnConversationFromJSONTyped(json, true), { mode: 'continue_or_create' } as const);
        case 'new':
            return Object.assign({}, NewTurnConversationFromJSONTyped(json, true), { mode: 'new' } as const);
        default:
            return json;
    }
}

export function TurnConversationToJSON(json: any): any {
    return TurnConversationToJSONTyped(json, false);
}

export function TurnConversationToJSONTyped(value?: TurnConversation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['mode']) {
        case 'continue':
            return Object.assign({}, ContinueTurnConversationToJSON(value), { mode: 'continue' } as const);
        case 'continue_or_create':
            return Object.assign({}, ContinueOrCreateTurnConversationToJSON(value), { mode: 'continue_or_create' } as const);
        case 'new':
            return Object.assign({}, NewTurnConversationToJSON(value), { mode: 'new' } as const);
        default:
            return value;
    }
}
