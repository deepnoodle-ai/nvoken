 ...
 * @export
 * @interface InvocationChildCounts
 */
export interface InvocationChildCounts {
    /**
     *
     * @type {number}
     * @memberof InvocationChildCounts
     */
    total: number;
    /**
...
/**
 * Check if a given object implements the InvocationChildCounts interface.
 */
export function instanceOfInvocationChildCounts(value: object): value is InvocationChildCounts {
...
export function InvocationChildCountsFromJSON(json: any): InvocationChildCounts {
    return InvocationChildCountsFromJSONTyped(json, false);
}

export function InvocationChildCountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationChildCounts {
    if (json == null) {
        return json;
    }
    return {
...
export function InvocationChildCountsToJSON(json: any): InvocationChildCounts {
    return InvocationChildCountsToJSONTyped(json, false);
}

export function InvocationChildCountsToJSONTyped(value?: InvocationChildCounts | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
