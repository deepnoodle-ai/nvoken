 ...
 */
export function instanceOfUsageBreakdownItem(value: object): value is UsageBreakdownItem {
...
export function UsageBreakdownItemToJSON(json: any): UsageBreakdownItem {
    return UsageBreakdownItemToJSONTyped(json, false);
}

export function UsageBreakdownItemToJSONTyped(value?: UsageBreakdownItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
