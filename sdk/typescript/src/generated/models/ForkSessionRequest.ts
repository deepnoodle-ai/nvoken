...
import type { ForkSessionRequestFromMessage } from './ForkSessionRequestFromMessage.js';
import {
    ForkSessionRequestFromMessageFromJSON,
    ForkSessionRequestFromMessageFromJSONTyped,
    ForkSessionRequestFromMessageToJSON,
    ForkSessionRequestFromMessageToJSONTyped,
} from './ForkSessionRequestFromMessage.js';
import type { ForkSessionOptions } from './ForkSessionOptions.js';
import {
    ForkSessionOptionsFromJSON,
    ForkSessionOptionsFromJSONTyped,
    ForkSessionOptionsToJSON,
    ForkSessionOptionsToJSONTyped,
} from './ForkSessionOptions.js';

/**
 * There is no `user_key` here. A fork copies the transcript, including
...
export interface ForkSessionRequest {
    /**
     *
     * @type {ForkSessionRequestFromMessage}
     * @memberof ForkSessionRequest
     */
    fromMessage: ForkSessionRequestFromMessage;
    /**
     * Optional tenant/Agent-scoped keyed identity for the child.
     * @type {string}
     * @memberof ForkSessionRequest
     */
    sessionKey?: string;
     ...
     * @memberof ForkSessionRequest
     */
    sessionOptions?: ForkSessionOptions;
}
...
export function instanceOfForkSessionRequest(value: object): value is ForkSessionRequest {
    if (!('fromMessage' in value) || value['fromMessage'] === undefined) return false;
    return true;
}
...
export function ForkSessionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ForkSessionRequest {
    ...
    return {
        ...
        'fromMessage': ForkSessionRequestFromMessageFromJSON(json['from_message']),
        'sessionKey': json['session_key'] == null ? undefined : json['session_key'],
        'sessionOptions': json['session_options'] == null ? undefined : ForkSessionOptionsFromJSON(json['session_options']),
    };
}
...
export function ForkSessionRequestToJSONTyped(value?: ForkSessionRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'from_message': ForkSessionRequestFromMessageToJSON(value['fromMessage']),
        'session_key': value['sessionKey'],
        'session_options': ForkSessionOptionsToJSON(value['sessionOptions']),
    };
}
