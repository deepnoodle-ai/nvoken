 ...
 *
 * @export
 * @interface DefaultMemoryNone
 */
export interface DefaultMemoryNone {
    /**
     *
     * @type {DefaultMemoryNoneDefaultScopeEnum}
     * @memberof DefaultMemoryNone
     */
    defaultScope: DefaultMemoryNoneDefaultScopeEnum;
}
 ...
 * @export
 */
export const DefaultMemoryNoneDefaultScopeEnum = {
    None: 'none'
} as const;
export type DefaultMemoryNoneDefaultScopeEnum = typeof DefaultMemoryNoneDefaultScopeEnum[keyof typeof DefaultMemoryNoneDefaultScopeEnum];


/**
 * Check if a given object implements the DefaultMemoryNone interface.
 */
export function instanceOfDefaultMemoryNone(value: object): value is DefaultMemoryNone {
    if (!('defaultScope' in value) || value['defaultScope'] === undefined) return false;
    return true;
}

export function DefaultMemoryNoneFromJSON(json: any): DefaultMemoryNone {
    return DefaultMemoryNoneFromJSONTyped(json, false);
}

export function DefaultMemoryNoneFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefaultMemoryNone {
    if (json == null) {
        return json;
    }
    return {
...
export function DefaultMemoryNoneToJSON(json: any): DefaultMemoryNone {
    return DefaultMemoryNoneToJSONTyped(json, false);
}

export function DefaultMemoryNoneToJSONTyped(value?: DefaultMemoryNone | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
