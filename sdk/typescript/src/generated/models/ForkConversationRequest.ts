...
export interface ForkConversationRequest {
     ...
     * @type {string}
     * @memberof ForkConversationRequest
     */
...
/**
 * Check if a given object implements the ForkConversationRequest interface.
 */
export function instanceOfForkConversationRequest(value: object): value is ForkConversationRequest {
    if (!('fromMessageId' in value) || value['fromMessageId'] === undefined) return false;
    if (!('owner' in value) || value['owner'] === undefined) return false;
    return true;
}

export function ForkConversationRequestFromJSON(json: any): ForkConversationRequest {
    return ForkConversationRequestFromJSONTyped(json, false);
}

export function ForkConversationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ForkConversationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ForkConversationRequestToJSON(json: any): ForkConversationRequest {
    return ForkConversationRequestToJSONTyped(json, false);
}

export function ForkConversationRequestToJSONTyped(value?: ForkConversationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'from_message_id': value['fromMessageId'],
