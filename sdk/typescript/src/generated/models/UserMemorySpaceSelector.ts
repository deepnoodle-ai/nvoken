 ...
 *
 * @export
 * @interface UserMemorySpaceSelector
 */
export interface UserMemorySpaceSelector {
    /**
     *
     * @type {UserMemorySpaceSelectorScopeEnum}
     * @memberof UserMemorySpaceSelector
     */
    scope: UserMemorySpaceSelectorScopeEnum;
    /**
     *
     * @type {string}
     * @memberof UserMemorySpaceSelector
 ...
 * @export
 */
export const UserMemorySpaceSelectorScopeEnum = {
    User: 'user'
} as const;
export type UserMemorySpaceSelectorScopeEnum = typeof UserMemorySpaceSelectorScopeEnum[keyof typeof UserMemorySpaceSelectorScopeEnum];


/**
 * Check if a given object implements the UserMemorySpaceSelector interface.
 */
export function instanceOfUserMemorySpaceSelector(value: object): value is UserMemorySpaceSelector {
...
export function UserMemorySpaceSelectorFromJSON(json: any): UserMemorySpaceSelector {
    return UserMemorySpaceSelectorFromJSONTyped(json, false);
}

export function UserMemorySpaceSelectorFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserMemorySpaceSelector {
    if (json == null) {
        return json;
    }
    return {
...
export function UserMemorySpaceSelectorToJSON(json: any): UserMemorySpaceSelector {
    return UserMemorySpaceSelectorToJSONTyped(json, false);
}

export function UserMemorySpaceSelectorToJSONTyped(value?: UserMemorySpaceSelector | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
