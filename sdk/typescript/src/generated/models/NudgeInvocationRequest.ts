...
/**
 * Check if a given object implements the NudgeInvocationRequest interface.
 */
export function instanceOfNudgeInvocationRequest(value: object): value is NudgeInvocationRequest {
    if (!('content' in value) || value['content'] === undefined) return false;
    return true;
}

export function NudgeInvocationRequestFromJSON(json: any): NudgeInvocationRequest {
    return NudgeInvocationRequestFromJSONTyped(json, false);
}

export function NudgeInvocationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): NudgeInvocationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function NudgeInvocationRequestToJSON(json: any): NudgeInvocationRequest {
    return NudgeInvocationRequestToJSONTyped(json, false);
}

export function NudgeInvocationRequestToJSONTyped(value?: NudgeInvocationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
