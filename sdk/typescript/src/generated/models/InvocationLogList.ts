 ...
 *
 * @export
 * @interface InvocationLogList
 */
export interface InvocationLogList {
    /**
     * Opaque identifier with the public `inv_` prefix. Treat the body as opaque.
     * @type {string}
     * @memberof InvocationLogList
     */
    invocationId: string;
    /**
...
/**
 * Check if a given object implements the InvocationLogList interface.
 */
export function instanceOfInvocationLogList(value: object): value is InvocationLogList {
...
export function InvocationLogListFromJSON(json: any): InvocationLogList {
    return InvocationLogListFromJSONTyped(json, false);
}

export function InvocationLogListFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationLogList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'items': ((json['items'] as Array<any>).map(InvocationLogFromJSON)),
        'nextCursor': json['next_cursor'],
    };
}

export function InvocationLogListToJSON(json: any): InvocationLogList {
    return InvocationLogListToJSONTyped(json, false);
}

export function InvocationLogListToJSONTyped(value?: InvocationLogList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(InvocationLogToJSON)),
