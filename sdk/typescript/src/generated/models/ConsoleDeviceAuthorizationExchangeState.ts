 ...
 *
 * @export
 * @interface ConsoleDeviceAuthorizationExchangeState
 */
export interface ConsoleDeviceAuthorizationExchangeState {
    /**
     *
     * @type {ConsoleDeviceAuthorizationExchangeStateStatusEnum}
     * @memberof ConsoleDeviceAuthorizationExchangeState
     */
    status: ConsoleDeviceAuthorizationExchangeStateStatusEnum;
}
 ...
 * @export
 */
export const ConsoleDeviceAuthorizationExchangeStateStatusEnum = {
    AuthorizationPending: 'authorization_pending',
    SlowDown: 'slow_down',
    AccessDenied: 'access_denied',
    ExpiredToken: 'expired_token'
} as const;
export type ConsoleDeviceAuthorizationExchangeStateStatusEnum = typeof ConsoleDeviceAuthorizationExchangeStateStatusEnum[keyof typeof ConsoleDeviceAuthorizationExchangeStateStatusEnum];


/**
 * Check if a given object implements the ConsoleDeviceAuthorizationExchangeState interface.
 */
export function instanceOfConsoleDeviceAuthorizationExchangeState(value: object): value is ConsoleDeviceAuthorizationExchangeState {
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function ConsoleDeviceAuthorizationExchangeStateFromJSON(json: any): ConsoleDeviceAuthorizationExchangeState {
    return ConsoleDeviceAuthorizationExchangeStateFromJSONTyped(json, false);
}

export function ConsoleDeviceAuthorizationExchangeStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsoleDeviceAuthorizationExchangeState {
    if (json == null) {
        return json;
    }
    return {
...
export function ConsoleDeviceAuthorizationExchangeStateToJSON(json: any): ConsoleDeviceAuthorizationExchangeState {
    return ConsoleDeviceAuthorizationExchangeStateToJSONTyped(json, false);
}

export function ConsoleDeviceAuthorizationExchangeStateToJSONTyped(value?: ConsoleDeviceAuthorizationExchangeState | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
