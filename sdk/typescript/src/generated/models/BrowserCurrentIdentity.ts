...
import type { BrowserCurrentIdentityAuthentication } from './BrowserCurrentIdentityAuthentication.js';
import {
    BrowserCurrentIdentityAuthenticationFromJSON,
    BrowserCurrentIdentityAuthenticationFromJSONTyped,
    BrowserCurrentIdentityAuthenticationToJSON,
    BrowserCurrentIdentityAuthenticationToJSONTyped,
} from './BrowserCurrentIdentityAuthentication.js';

/**
 *
 * @export
 * @interface BrowserCurrentIdentity
 */
export interface BrowserCurrentIdentity {
    /**
     *
     * @type {BrowserCurrentIdentityAuthentication}
     * @memberof BrowserCurrentIdentity
     */
    authentication: BrowserCurrentIdentityAuthentication;
}

/**
 * Check if a given object implements the BrowserCurrentIdentity interface.
 */
export function instanceOfBrowserCurrentIdentity(value: object): value is BrowserCurrentIdentity {
    if (!('authentication' in value) || value['authentication'] === undefined) return false;
    return true;
}

export function BrowserCurrentIdentityFromJSON(json: any): BrowserCurrentIdentity {
    return BrowserCurrentIdentityFromJSONTyped(json, false);
}

export function BrowserCurrentIdentityFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserCurrentIdentity {
    if (json == null) {
        return json;
    }
    return {

        'authentication': BrowserCurrentIdentityAuthenticationFromJSON(json['authentication']),
    };
}

export function BrowserCurrentIdentityToJSON(json: any): BrowserCurrentIdentity {
    return BrowserCurrentIdentityToJSONTyped(json, false);
}

export function BrowserCurrentIdentityToJSONTyped(value?: BrowserCurrentIdentity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'authentication': BrowserCurrentIdentityAuthenticationToJSON(value['authentication']),
    };
}
