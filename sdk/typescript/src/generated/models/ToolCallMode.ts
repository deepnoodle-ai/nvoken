 ...
 * @export
 */
export const ToolCallMode = {
    Builtin: 'builtin',
    Host: 'host',
    Callback: 'callback',
    Mcp: 'mcp'
} as const;
export type ToolCallMode = typeof ToolCallMode[keyof typeof ToolCallMode];


export function instanceOfToolCallMode(value: any): boolean {
    for (const key in ToolCallMode) {
        if (Object.prototype.hasOwnProperty.call(ToolCallMode, key)) {
            if (ToolCallMode[key as keyof typeof ToolCallMode] === value) {
                return true;
            }
        }
    }
...
export function ToolCallModeFromJSON(json: any): ToolCallMode {
    return ToolCallModeFromJSONTyped(json, false);
}

export function ToolCallModeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ToolCallMode {
    return json as ToolCallMode;
}

export function ToolCallModeToJSON(value?: ToolCallMode | null): any {
    return value as any;
}

export function ToolCallModeToJSONTyped(value: any, ignoreDiscriminator: boolean): ToolCallMode {
    return value as ToolCallMode;
}
