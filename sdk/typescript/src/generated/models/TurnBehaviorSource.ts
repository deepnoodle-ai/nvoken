...
import type { InlineTurnBehaviorSource } from './InlineTurnBehaviorSource.js';
import {
    instanceOfInlineTurnBehaviorSource,
    InlineTurnBehaviorSourceFromJSON,
    InlineTurnBehaviorSourceFromJSONTyped,
    InlineTurnBehaviorSourceToJSON,
} from './InlineTurnBehaviorSource.js';
import type { StoredTurnBehaviorSource } from './StoredTurnBehaviorSource.js';
import {
    instanceOfStoredTurnBehaviorSource,
    StoredTurnBehaviorSourceFromJSON,
    StoredTurnBehaviorSourceFromJSONTyped,
    StoredTurnBehaviorSourceToJSON,
} from './StoredTurnBehaviorSource.js';
 ...
 * @export
 */
export type TurnBehaviorSource = { kind: 'agent_revision' } & StoredTurnBehaviorSource | { kind: 'inline' } & InlineTurnBehaviorSource;

export function TurnBehaviorSourceFromJSON(json: any): TurnBehaviorSource {
    return TurnBehaviorSourceFromJSONTyped(json, false);
}

export function TurnBehaviorSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnBehaviorSource {
    if (json == null) {
        return json;
    }
    switch (json['kind']) {
        case 'agent_revision':
            return Object.assign({}, StoredTurnBehaviorSourceFromJSONTyped(json, true), { kind: 'agent_revision' } as const);
        case 'inline':
            return Object.assign({}, InlineTurnBehaviorSourceFromJSONTyped(json, true), { kind: 'inline' } as const);
        default:
            return json;
    }
}

export function TurnBehaviorSourceToJSON(json: any): any {
    return TurnBehaviorSourceToJSONTyped(json, false);
}

export function TurnBehaviorSourceToJSONTyped(value?: TurnBehaviorSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['kind']) {
        case 'agent_revision':
            return Object.assign({}, StoredTurnBehaviorSourceToJSON(value), { kind: 'agent_revision' } as const);
        case 'inline':
            return Object.assign({}, InlineTurnBehaviorSourceToJSON(value), { kind: 'inline' } as const);
        default:
            return value;
    }
}
