...
export interface CreateClientKeyRequest {
    /**
     * Bounded operator-facing display name.
     * @type {string}
     * @memberof CreateClientKeyRequest
     */
    name: string;
    /**
     * Standard padded base64 for exactly 32 Ed25519 public-key bytes.
     * @type {string}
     * @memberof CreateClientKeyRequest
     */
    publicKey: string;
...
/**
 * Check if a given object implements the CreateClientKeyRequest interface.
 */
export function instanceOfCreateClientKeyRequest(value: object): value is CreateClientKeyRequest {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('publicKey' in value) || value['publicKey'] === undefined) return false;
    return true;
}

export function CreateClientKeyRequestFromJSON(json: any): CreateClientKeyRequest {
    return CreateClientKeyRequestFromJSONTyped(json, false);
}

export function CreateClientKeyRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateClientKeyRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateClientKeyRequestToJSON(json: any): CreateClientKeyRequest {
    return CreateClientKeyRequestToJSONTyped(json, false);
}

export function CreateClientKeyRequestToJSONTyped(value?: CreateClientKeyRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
