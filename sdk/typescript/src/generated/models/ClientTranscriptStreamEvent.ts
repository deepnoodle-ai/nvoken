...
import type { ClientTranscriptUpdate } from './ClientTranscriptUpdate.js';
import {
    instanceOfClientTranscriptUpdate,
    ClientTranscriptUpdateFromJSON,
    ClientTranscriptUpdateFromJSONTyped,
    ClientTranscriptUpdateToJSON,
} from './ClientTranscriptUpdate.js';
...
/**
 * @type ClientTranscriptStreamEvent
 * Browser stream event. Thinking previews and host-only transcript fields are never emitted.
 * @export
 */
export type ClientTranscriptStreamEvent = ClientTranscriptUpdate | OutputTextDeltaEvent | StreamEndEvent | StreamResyncEvent;

export function ClientTranscriptStreamEventFromJSON(json: any): ClientTranscriptStreamEvent {
    return ClientTranscriptStreamEventFromJSONTyped(json, false);
}

export function ClientTranscriptStreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientTranscriptStreamEvent {
    if (json == null) {
        return json;
    }
    ...
    if (instanceOfClientTranscriptUpdate(json)) {
        return ClientTranscriptUpdateFromJSONTyped(json, true);
    }
...
export function ClientTranscriptStreamEventToJSON(json: any): any {
    return ClientTranscriptStreamEventToJSONTyped(json, false);
}

export function ClientTranscriptStreamEventToJSONTyped(value?: ClientTranscriptStreamEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfClientTranscriptUpdate(value)) {
        return ClientTranscriptUpdateToJSON(value as ClientTranscriptUpdate);
    }
