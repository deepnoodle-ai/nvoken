 ...
 * @export
 */
export const MemoryContextMode = {
    Index: 'index',
    Full: 'full',
    False: 'false'
} as const;
export type MemoryContextMode = typeof MemoryContextMode[keyof typeof MemoryContextMode];


export function instanceOfMemoryContextMode(value: any): boolean {
    for (const key in MemoryContextMode) {
        if (Object.prototype.hasOwnProperty.call(MemoryContextMode, key)) {
            if (MemoryContextMode[key as keyof typeof MemoryContextMode] === value) {
                return true;
            }
        }
    }
...
export function MemoryContextModeFromJSON(json: any): MemoryContextMode {
    return MemoryContextModeFromJSONTyped(json, false);
}

export function MemoryContextModeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemoryContextMode {
    return json as MemoryContextMode;
}

export function MemoryContextModeToJSON(value?: MemoryContextMode | null): any {
    return value as any;
}

export function MemoryContextModeToJSONTyped(value: any, ignoreDiscriminator: boolean): MemoryContextMode {
    return value as MemoryContextMode;
}
