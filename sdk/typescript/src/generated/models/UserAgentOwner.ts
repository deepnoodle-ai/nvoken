 ...
 *
 * @export
 * @interface UserAgentOwner
 */
export interface UserAgentOwner {
    /**
     *
     * @type {UserAgentOwnerKindEnum}
     * @memberof UserAgentOwner
     */
    kind: UserAgentOwnerKindEnum;
    /**
     *
     * @type {string}
     * @memberof UserAgentOwner
 ...
 * @export
 */
export const UserAgentOwnerKindEnum = {
    User: 'user'
} as const;
export type UserAgentOwnerKindEnum = typeof UserAgentOwnerKindEnum[keyof typeof UserAgentOwnerKindEnum];


/**
 * Check if a given object implements the UserAgentOwner interface.
 */
export function instanceOfUserAgentOwner(value: object): value is UserAgentOwner {
...
export function UserAgentOwnerFromJSON(json: any): UserAgentOwner {
    return UserAgentOwnerFromJSONTyped(json, false);
}

export function UserAgentOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserAgentOwner {
    if (json == null) {
        return json;
    }
    return {
...
export function UserAgentOwnerToJSON(json: any): UserAgentOwner {
    return UserAgentOwnerToJSONTyped(json, false);
}

export function UserAgentOwnerToJSONTyped(value?: UserAgentOwner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
