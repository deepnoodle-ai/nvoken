 ...
 *
 * @export
 * @interface ConversationCompactionList
 */
export interface ConversationCompactionList {
    /**
     *
     * @type {Array<ConversationCompaction>}
     * @memberof ConversationCompactionList
     */
    items: Array<ConversationCompaction>;
    /**
     *
     * @type {boolean}
     * @memberof ConversationCompactionList
...
/**
 * Check if a given object implements the ConversationCompactionList interface.
 */
export function instanceOfConversationCompactionList(value: object): value is ConversationCompactionList {
...
export function ConversationCompactionListFromJSON(json: any): ConversationCompactionList {
    return ConversationCompactionListFromJSONTyped(json, false);
}

export function ConversationCompactionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationCompactionList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ConversationCompactionFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function ConversationCompactionListToJSON(json: any): ConversationCompactionList {
    return ConversationCompactionListToJSONTyped(json, false);
}

export function ConversationCompactionListToJSONTyped(value?: ConversationCompactionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ConversationCompactionToJSON)),
