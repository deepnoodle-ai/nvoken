...
export const ErrorCode = {
    ...
    Forbidden: 'forbidden',
    NotFound: 'not_found',
    InvocationErased: 'invocation_erased',
    IdempotencyConflict: 'idempotency_conflict',
    SessionOptionsConflict: 'session_options_conflict',
    SessionUserKeyConflict: 'session_user_key_conflict',
    ProviderKeyConflict: 'provider_key_conflict',
    SessionInvocationActive: 'session_invocation_active',
    InvocationActive: 'invocation_active',
    InvocationSessionBound: 'invocation_session_bound',
