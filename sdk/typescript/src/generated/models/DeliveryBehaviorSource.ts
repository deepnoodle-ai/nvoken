...
import type { DeliveryAgentRevisionSource } from './DeliveryAgentRevisionSource.js';
import {
    instanceOfDeliveryAgentRevisionSource,
    DeliveryAgentRevisionSourceFromJSON,
    DeliveryAgentRevisionSourceFromJSONTyped,
    DeliveryAgentRevisionSourceToJSON,
} from './DeliveryAgentRevisionSource.js';
import type { DeliveryInlineSource } from './DeliveryInlineSource.js';
import {
    instanceOfDeliveryInlineSource,
    DeliveryInlineSourceFromJSON,
    DeliveryInlineSourceFromJSONTyped,
    DeliveryInlineSourceToJSON,
} from './DeliveryInlineSource.js';
 ...
 * @export
 */
export type DeliveryBehaviorSource = { kind: 'agent_revision' } & DeliveryAgentRevisionSource | { kind: 'inline' } & DeliveryInlineSource;

export function DeliveryBehaviorSourceFromJSON(json: any): DeliveryBehaviorSource {
    return DeliveryBehaviorSourceFromJSONTyped(json, false);
}

export function DeliveryBehaviorSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeliveryBehaviorSource {
    if (json == null) {
        return json;
    }
    switch (json['kind']) {
        case 'agent_revision':
            return Object.assign({}, DeliveryAgentRevisionSourceFromJSONTyped(json, true), { kind: 'agent_revision' } as const);
        case 'inline':
            return Object.assign({}, DeliveryInlineSourceFromJSONTyped(json, true), { kind: 'inline' } as const);
        default:
            return json;
    }
}

export function DeliveryBehaviorSourceToJSON(json: any): any {
    return DeliveryBehaviorSourceToJSONTyped(json, false);
}

export function DeliveryBehaviorSourceToJSONTyped(value?: DeliveryBehaviorSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['kind']) {
        case 'agent_revision':
            return Object.assign({}, DeliveryAgentRevisionSourceToJSON(value), { kind: 'agent_revision' } as const);
        case 'inline':
            return Object.assign({}, DeliveryInlineSourceToJSON(value), { kind: 'inline' } as const);
        default:
            return value;
    }
}
