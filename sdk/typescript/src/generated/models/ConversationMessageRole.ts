...
export function instanceOfConversationMessageRole(value: any): boolean {
    for (const key in ConversationMessageRole) {
        if (Object.prototype.hasOwnProperty.call(ConversationMessageRole, key)) {
            if (ConversationMessageRole[key as keyof typeof ConversationMessageRole] === value) {
                return true;
            }
        }
    }
...
export function ConversationMessageRoleFromJSON(json: any): ConversationMessageRole {
    return ConversationMessageRoleFromJSONTyped(json, false);
}

export function ConversationMessageRoleFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationMessageRole {
    return json as ConversationMessageRole;
}

export function ConversationMessageRoleToJSON(value?: ConversationMessageRole | null): any {
    return value as any;
}

export function ConversationMessageRoleToJSONTyped(value: any, ignoreDiscriminator: boolean): ConversationMessageRole {
    return value as ConversationMessageRole;
}
