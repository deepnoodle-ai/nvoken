...
import type { BrowserInvocationResult } from './BrowserInvocationResult.js';
import {
    BrowserInvocationResultFromJSON,
    BrowserInvocationResultFromJSONTyped,
    BrowserInvocationResultToJSON,
    BrowserInvocationResultToJSONTyped,
} from './BrowserInvocationResult.js';

/**
 *
 * @export
 * @interface BrowserInvocationResultEvent
 */
export interface BrowserInvocationResultEvent {
    /**
     *
     * @type {BrowserInvocationResultEventTypeEnum}
     * @memberof BrowserInvocationResultEvent
     */
    type: BrowserInvocationResultEventTypeEnum;
    /**
 ...
 * @export
 */
export const BrowserInvocationResultEventTypeEnum = {
    InvocationResult: 'invocation.result'
} as const;
export type BrowserInvocationResultEventTypeEnum = typeof BrowserInvocationResultEventTypeEnum[keyof typeof BrowserInvocationResultEventTypeEnum];


/**
 * Check if a given object implements the BrowserInvocationResultEvent interface.
 */
export function instanceOfBrowserInvocationResultEvent(value: object): value is BrowserInvocationResultEvent {
...
export function BrowserInvocationResultEventFromJSON(json: any): BrowserInvocationResultEvent {
    return BrowserInvocationResultEventFromJSONTyped(json, false);
}

export function BrowserInvocationResultEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationResultEvent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'result': BrowserInvocationResultFromJSON(json['result']),
    };
}

export function BrowserInvocationResultEventToJSON(json: any): BrowserInvocationResultEvent {
    return BrowserInvocationResultEventToJSONTyped(json, false);
}

export function BrowserInvocationResultEventToJSONTyped(value?: BrowserInvocationResultEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'result': BrowserInvocationResultToJSON(value['result']),
    };
}
