...
import type { ConsoleDeviceAuthorizationExchangeState } from './ConsoleDeviceAuthorizationExchangeState.js';
import {
    instanceOfConsoleDeviceAuthorizationExchangeState,
    ConsoleDeviceAuthorizationExchangeStateFromJSON,
    ConsoleDeviceAuthorizationExchangeStateFromJSONTyped,
    ConsoleDeviceAuthorizationExchangeStateToJSON,
} from './ConsoleDeviceAuthorizationExchangeState.js';
 ...
 * @export
 */
export type ExchangeConsoleDeviceAuthorization403Response = ConsoleDeviceAuthorizationExchangeState | ErrorResponse;

export function ExchangeConsoleDeviceAuthorization403ResponseFromJSON(json: any): ExchangeConsoleDeviceAuthorization403Response {
    return ExchangeConsoleDeviceAuthorization403ResponseFromJSONTyped(json, false);
}

export function ExchangeConsoleDeviceAuthorization403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExchangeConsoleDeviceAuthorization403Response {
    if (json == null) {
        return json;
    }
    ...
    if (instanceOfConsoleDeviceAuthorizationExchangeState(json)) {
        return ConsoleDeviceAuthorizationExchangeStateFromJSONTyped(json, true);
    }
...
export function ExchangeConsoleDeviceAuthorization403ResponseToJSON(json: any): any {
    return ExchangeConsoleDeviceAuthorization403ResponseToJSONTyped(json, false);
}

export function ExchangeConsoleDeviceAuthorization403ResponseToJSONTyped(value?: ExchangeConsoleDeviceAuthorization403Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfConsoleDeviceAuthorizationExchangeState(value)) {
        return ConsoleDeviceAuthorizationExchangeStateToJSON(value as ConsoleDeviceAuthorizationExchangeState);
    }
