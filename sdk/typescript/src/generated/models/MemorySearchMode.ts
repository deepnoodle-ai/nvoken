...
export function instanceOfMemorySearchMode(value: any): boolean {
    for (const key in MemorySearchMode) {
        if (Object.prototype.hasOwnProperty.call(MemorySearchMode, key)) {
            if (MemorySearchMode[key as keyof typeof MemorySearchMode] === value) {
                return true;
            }
        }
    }
...
export function MemorySearchModeFromJSON(json: any): MemorySearchMode {
    return MemorySearchModeFromJSONTyped(json, false);
}

export function MemorySearchModeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemorySearchMode {
    return json as MemorySearchMode;
}

export function MemorySearchModeToJSON(value?: MemorySearchMode | null): any {
    return value as any;
}

export function MemorySearchModeToJSONTyped(value: any, ignoreDiscriminator: boolean): MemorySearchMode {
