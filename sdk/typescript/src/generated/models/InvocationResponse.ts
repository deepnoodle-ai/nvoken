 ...
 * @export
 */
export type InvocationResponse = BrowserInvocation | Invocation;
...
export function InvocationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationResponse {
    ...
    if (false) {
        return BrowserInvocationFromJSONTyped(json, true);
    }
    if (true) {
        return InvocationFromJSONTyped(json, true);
    }
    return {} as any;
}

export function InvocationResponseToJSON(json: any): any {
...
export function InvocationResponseToJSONTyped(value?: InvocationResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return BrowserInvocationToJSON(value as BrowserInvocation);
    }
    if (true) {
        return InvocationToJSON(value as Invocation);
    }
    return {};
}
