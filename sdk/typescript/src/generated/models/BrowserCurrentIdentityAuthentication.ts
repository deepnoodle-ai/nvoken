 ...
 *
 * @export
 * @interface BrowserCurrentIdentityAuthentication
 */
export interface BrowserCurrentIdentityAuthentication {
    /**
     * Opaque identifier with the public `app_` prefix. Treat the body as opaque.
     * @type {string}
     * @memberof BrowserCurrentIdentityAuthentication
     */
    appId: string;
    /**
     *
    ...
    /**
     *
     * @type {BrowserCurrentIdentityAuthenticationMethodEnum}
     * @memberof BrowserCurrentIdentityAuthentication
     */
    method: BrowserCurrentIdentityAuthenticationMethodEnum;
    /**
     *
     * @type {BrowserCurrentIdentityAuthenticationAssuranceEnum}
     * @memberof BrowserCurrentIdentityAuthentication
     */
    assurance: BrowserCurrentIdentityAuthenticationAssuranceEnum;
}
 ...
 * @export
 */
export const BrowserCurrentIdentityAuthenticationMethodEnum = {
    ClientToken: 'client_token',
    AnonymousToken: 'anonymous_token'
} as const;
export type BrowserCurrentIdentityAuthenticationMethodEnum = typeof BrowserCurrentIdentityAuthenticationMethodEnum[keyof typeof BrowserCurrentIdentityAuthenticationMethodEnum];

/**
 * @export
 */
export const BrowserCurrentIdentityAuthenticationAssuranceEnum = {
    Bearer: 'bearer'
} as const;
export type BrowserCurrentIdentityAuthenticationAssuranceEnum = typeof BrowserCurrentIdentityAuthenticationAssuranceEnum[keyof typeof BrowserCurrentIdentityAuthenticationAssuranceEnum];


/**
 * Check if a given object implements the BrowserCurrentIdentityAuthentication interface.
 */
export function instanceOfBrowserCurrentIdentityAuthentication(value: object): value is BrowserCurrentIdentityAuthentication {
...
export function BrowserCurrentIdentityAuthenticationFromJSON(json: any): BrowserCurrentIdentityAuthentication {
    return BrowserCurrentIdentityAuthenticationFromJSONTyped(json, false);
}

export function BrowserCurrentIdentityAuthenticationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserCurrentIdentityAuthentication {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserCurrentIdentityAuthenticationToJSON(json: any): BrowserCurrentIdentityAuthentication {
    return BrowserCurrentIdentityAuthenticationToJSONTyped(json, false);
}

export function BrowserCurrentIdentityAuthenticationToJSONTyped(value?: BrowserCurrentIdentityAuthentication | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
