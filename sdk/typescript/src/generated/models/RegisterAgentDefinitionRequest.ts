...
/**
 * One Agent Definition accepted by registration or nested under
 ...
 *
 * @export
 * @interface RegisterAgentDefinitionRequest
 */
export interface RegisterAgentDefinitionRequest {
    /**
     * Optional model instructions. Omission adds no hidden default.
     * @type {string}
     * @memberof RegisterAgentDefinitionRequest
     */
    instructions?: string;
    /**
     *
...
/**
 * Check if a given object implements the RegisterAgentDefinitionRequest interface.
 */
export function instanceOfRegisterAgentDefinitionRequest(value: object): value is RegisterAgentDefinitionRequest {
    if (!('model' in value) || value['model'] === undefined) return false;
    return true;
}

export function RegisterAgentDefinitionRequestFromJSON(json: any): RegisterAgentDefinitionRequest {
    return RegisterAgentDefinitionRequestFromJSONTyped(json, false);
}

export function RegisterAgentDefinitionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegisterAgentDefinitionRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RegisterAgentDefinitionRequestToJSON(json: any): RegisterAgentDefinitionRequest {
    return RegisterAgentDefinitionRequestToJSONTyped(json, false);
}

export function RegisterAgentDefinitionRequestToJSONTyped(value?: RegisterAgentDefinitionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
