...
export interface RegisterOrgRequest {
     ...
     *
     * @type {string}
     * @memberof RegisterOrgRequest
     */
    displayName: string;
    /**
     * Optional unique identity-provider Org identifier. Reusing it
...
/**
 * Check if a given object implements the RegisterOrgRequest interface.
 */
export function instanceOfRegisterOrgRequest(value: object): value is RegisterOrgRequest {
    if (!('displayName' in value) || value['displayName'] === undefined) return false;
    return true;
}

export function RegisterOrgRequestFromJSON(json: any): RegisterOrgRequest {
    return RegisterOrgRequestFromJSONTyped(json, false);
}

export function RegisterOrgRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegisterOrgRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RegisterOrgRequestToJSON(json: any): RegisterOrgRequest {
    return RegisterOrgRequestToJSONTyped(json, false);
}

export function RegisterOrgRequestToJSONTyped(value?: RegisterOrgRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
