...
import type { MemorySearchResult } from './MemorySearchResult.js';
import {
    MemorySearchResultFromJSON,
    MemorySearchResultFromJSONTyped,
    MemorySearchResultToJSON,
    MemorySearchResultToJSONTyped,
} from './MemorySearchResult.js';
import type { MemorySearchCoverage } from './MemorySearchCoverage.js';
import {
    MemorySearchCoverageFromJSON,
    MemorySearchCoverageFromJSONTyped,
    MemorySearchCoverageToJSON,
    MemorySearchCoverageToJSONTyped,
} from './MemorySearchCoverage.js';
...
export interface MemoryList {
    /**
     *
     * @type {Array<MemorySearchResult>}
     * @memberof MemoryList
     */
    items: Array<MemorySearchResult>;
    /**
     *
     * @type {MemorySearchCoverage}
     * @memberof MemoryList
     */
    searchCoverage: MemorySearchCoverage;
    /**
     *
     * @type {boolean}
     * @memberof MemoryList
...
/**
 * Check if a given object implements the MemoryList interface.
 */
export function instanceOfMemoryList(value: object): value is MemoryList {
    if (!('items' in value) || value['items'] === undefined) return false;
    if (!('searchCoverage' in value) || value['searchCoverage'] === undefined) return false;
    if (!('hasMore' in value) || value['hasMore'] === undefined) return false;
    if (!('nextCursor' in value) || value['nextCursor'] === undefined) return false;
    return true;
}

export function MemoryListFromJSON(json: any): MemoryList {
    return MemoryListFromJSONTyped(json, false);
}

export function MemoryListFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemoryList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(MemorySearchResultFromJSON)),
        'searchCoverage': MemorySearchCoverageFromJSON(json['search_coverage']),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function MemoryListToJSON(json: any): MemoryList {
    return MemoryListToJSONTyped(json, false);
}

export function MemoryListToJSONTyped(value?: MemoryList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(MemorySearchResultToJSON)),
        'search_coverage': MemorySearchCoverageToJSON(value['searchCoverage']),
