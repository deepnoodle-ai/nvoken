 ...
 *
 * @export
 * @interface AgentDefinitionRegistration
 */
export interface AgentDefinitionRegistration {
     ...
     * @type {string}
     * @memberof AgentDefinitionRegistration
     */
...
/**
 * Check if a given object implements the AgentDefinitionRegistration interface.
 */
export function instanceOfAgentDefinitionRegistration(value: object): value is AgentDefinitionRegistration {
...
export function AgentDefinitionRegistrationFromJSON(json: any): AgentDefinitionRegistration {
    return AgentDefinitionRegistrationFromJSONTyped(json, false);
}

export function AgentDefinitionRegistrationFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentDefinitionRegistration {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentDefinitionRegistrationToJSON(json: any): AgentDefinitionRegistration {
    return AgentDefinitionRegistrationToJSONTyped(json, false);
}

export function AgentDefinitionRegistrationToJSONTyped(value?: AgentDefinitionRegistration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
