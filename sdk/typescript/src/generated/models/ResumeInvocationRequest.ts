 ...
 *
 * @export
 * @interface ResumeInvocationRequest
 */
export interface ResumeInvocationRequest {
    /**
     *
     * @type {Limits}
     * @memberof ResumeInvocationRequest
     */
    limits: Limits;
}

/**
 * Check if a given object implements the ResumeInvocationRequest interface.
 */
export function instanceOfResumeInvocationRequest(value: object): value is ResumeInvocationRequest {
    if (!('limits' in value) || value['limits'] === undefined) return false;
    return true;
}

export function ResumeInvocationRequestFromJSON(json: any): ResumeInvocationRequest {
    return ResumeInvocationRequestFromJSONTyped(json, false);
}

export function ResumeInvocationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResumeInvocationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ResumeInvocationRequestToJSON(json: any): ResumeInvocationRequest {
    return ResumeInvocationRequestToJSONTyped(json, false);
}

export function ResumeInvocationRequestToJSONTyped(value?: ResumeInvocationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
