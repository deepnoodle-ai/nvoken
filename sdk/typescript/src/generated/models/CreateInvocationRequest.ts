...
import type { InvocationSession } from './InvocationSession.js';
import {
    InvocationSessionFromJSON,
    InvocationSessionFromJSONTyped,
    InvocationSessionToJSON,
    InvocationSessionToJSONTyped,
} from './InvocationSession.js';
...
export interface CreateInvocationRequest {
    ...
    /**
     * Conversation intent. Omit this object for a standalone Invocation;
    ...
    /**
     * Retention for a newly created conversation or a standalone turn.
    ...
    /**
     * Conversation compaction policy. Invalid for standalone turns.
     * @type {CompactionPolicy}
     * @memberof CreateInvocationRequest
     */
    compaction?: CompactionPolicy;
    /**
     * Host authorization binding recorded on a newly created conversation.
...
export function CreateInvocationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateInvocationRequest {
    ...
    return {
        ...
        'session': json['session'] == null ? undefined : InvocationSessionFromJSON(json['session']),
...
export function CreateInvocationRequestToJSONTyped(value?: CreateInvocationRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'session': InvocationSessionToJSON(value['session']),
