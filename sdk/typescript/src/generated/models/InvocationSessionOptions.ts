 ...
 *
 * @export
 * @interface InvocationSessionOptions
 */
export interface InvocationSessionOptions {
    /**
     *
     * @type {number}
     * @memberof InvocationSessionOptions
     */
    pinnedRevision?: number;
    /**
     * With `continue_or_create`, `join` accepts the stored conversation
     * policies; `refuse` reports mismatches.
     *
     * @type {InvocationSessionOptionsOnConflictEnum}
     * @memberof InvocationSessionOptions
     */
    onConflict?: InvocationSessionOptionsOnConflictEnum;
}
 ...
 * @export
 */
export const InvocationSessionOptionsOnConflictEnum = {
    Refuse: 'refuse',
    Join: 'join'
} as const;
export type InvocationSessionOptionsOnConflictEnum = typeof InvocationSessionOptionsOnConflictEnum[keyof typeof InvocationSessionOptionsOnConflictEnum];


/**
 * Check if a given object implements the InvocationSessionOptions interface.
 */
export function instanceOfInvocationSessionOptions(value: object): value is InvocationSessionOptions {
    return true;
}

export function InvocationSessionOptionsFromJSON(json: any): InvocationSessionOptions {
    return InvocationSessionOptionsFromJSONTyped(json, false);
}

export function InvocationSessionOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvocationSessionOptions {
    if (json == null) {
        return json;
    }
    return {
        ...
        'onConflict': json['on_conflict'] == null ? undefined : json['on_conflict'],
    };
}

export function InvocationSessionOptionsToJSON(json: any): InvocationSessionOptions {
    return InvocationSessionOptionsToJSONTyped(json, false);
}

export function InvocationSessionOptionsToJSONTyped(value?: InvocationSessionOptions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
