...
/**
 * Per-turn replacements that cannot expand tools, data access, memory, or browser authority.
 * @export
 * @interface AgentDefinitionOverrides
 */
export interface AgentDefinitionOverrides {
    /**
     *
     * @type {ModelInput}
     * @memberof AgentDefinitionOverrides
     */
    model?: ModelInput;
    /**
     *
...
/**
 * Check if a given object implements the AgentDefinitionOverrides interface.
 */
export function instanceOfAgentDefinitionOverrides(value: object): value is AgentDefinitionOverrides {
    return true;
}

export function AgentDefinitionOverridesFromJSON(json: any): AgentDefinitionOverrides {
    return AgentDefinitionOverridesFromJSONTyped(json, false);
}

export function AgentDefinitionOverridesFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentDefinitionOverrides {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentDefinitionOverridesToJSON(json: any): AgentDefinitionOverrides {
    return AgentDefinitionOverridesToJSONTyped(json, false);
}

export function AgentDefinitionOverridesToJSONTyped(value?: AgentDefinitionOverrides | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
