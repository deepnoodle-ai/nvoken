...
import type { BrowserInvocationFailure } from './BrowserInvocationFailure.js';
import {
    BrowserInvocationFailureFromJSON,
    BrowserInvocationFailureFromJSONTyped,
    BrowserInvocationFailureToJSON,
    BrowserInvocationFailureToJSONTyped,
} from './BrowserInvocationFailure.js';
...
export interface BrowserInvocationChange {
    ...
    /**
     * Why the turn stopped. Present once it has stopped.
    ...
    /**
     *
     * @type {BrowserInvocationFailure}
     * @memberof BrowserInvocationChange
     */
    error: BrowserInvocationFailure | null;
    /**
     *
     * @type {{ [key: string]: any; }}
     * @memberof BrowserInvocationChange
...
/**
 * Check if a given object implements the BrowserInvocationChange interface.
 */
export function instanceOfBrowserInvocationChange(value: object): value is BrowserInvocationChange {
...
export function BrowserInvocationChangeFromJSON(json: any): BrowserInvocationChange {
    return BrowserInvocationChangeFromJSONTyped(json, false);
}

export function BrowserInvocationChangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationChange {
    if (json == null) {
        return json;
    }
    return {
        ...
        'error': BrowserInvocationFailureFromJSON(json['error']),
        'structuredOutput': json['structured_output'],
        'occurredAt': (new Date(json['occurred_at'])),
    };
}

export function BrowserInvocationChangeToJSON(json: any): BrowserInvocationChange {
    return BrowserInvocationChangeToJSONTyped(json, false);
}

export function BrowserInvocationChangeToJSONTyped(value?: BrowserInvocationChange | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'error': BrowserInvocationFailureToJSON(value['error']),
