...
export function instanceOfAgentOwnerKind(value: any): boolean {
    for (const key in AgentOwnerKind) {
        if (Object.prototype.hasOwnProperty.call(AgentOwnerKind, key)) {
            if (AgentOwnerKind[key as keyof typeof AgentOwnerKind] === value) {
                return true;
            }
        }
    }
...
export function AgentOwnerKindFromJSON(json: any): AgentOwnerKind {
    return AgentOwnerKindFromJSONTyped(json, false);
}

export function AgentOwnerKindFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentOwnerKind {
    return json as AgentOwnerKind;
}

export function AgentOwnerKindToJSON(value?: AgentOwnerKind | null): any {
    return value as any;
}

export function AgentOwnerKindToJSONTyped(value: any, ignoreDiscriminator: boolean): AgentOwnerKind {
    return value as AgentOwnerKind;
}
