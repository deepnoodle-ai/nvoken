 ...
 * @export
 */
export const ModelToolChoiceMode = {
    ChoiceAuto: 'auto',
    ChoiceNone: 'none',
    ChoiceRequired: 'required',
    ChoiceNamed: 'named'
} as const;
export type ModelToolChoiceMode = typeof ModelToolChoiceMode[keyof typeof ModelToolChoiceMode];


export function instanceOfModelToolChoiceMode(value: any): boolean {
    for (const key in ModelToolChoiceMode) {
        if (Object.prototype.hasOwnProperty.call(ModelToolChoiceMode, key)) {
            if (ModelToolChoiceMode[key as keyof typeof ModelToolChoiceMode] === value) {
                return true;
            }
        }
    }
...
export function ModelToolChoiceModeFromJSON(json: any): ModelToolChoiceMode {
    return ModelToolChoiceModeFromJSONTyped(json, false);
}

export function ModelToolChoiceModeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelToolChoiceMode {
    return json as ModelToolChoiceMode;
}

export function ModelToolChoiceModeToJSON(value?: ModelToolChoiceMode | null): any {
    return value as any;
}

export function ModelToolChoiceModeToJSONTyped(value: any, ignoreDiscriminator: boolean): ModelToolChoiceMode {
    return value as ModelToolChoiceMode;
}
