...
import type { ModelCallRecord } from './ModelCallRecord.js';
import {
    ModelCallRecordFromJSON,
    ModelCallRecordFromJSONTyped,
    ModelCallRecordToJSON,
    ModelCallRecordToJSONTyped,
} from './ModelCallRecord.js';
...
export interface UsageRecords {
    /**
     *
     * @type {Array<ModelCallRecord>}
     * @memberof UsageRecords
     */
    items: Array<ModelCallRecord>;
    /**
     *
     * @type {string}
     * @memberof UsageRecords
...
/**
 * Check if a given object implements the UsageRecords interface.
 */
export function instanceOfUsageRecords(value: object): value is UsageRecords {
    if (!('items' in value) || value['items'] === undefined) return false;
    if (!('nextCursor' in value) || value['nextCursor'] === undefined) return false;
    return true;
}

export function UsageRecordsFromJSON(json: any): UsageRecords {
    return UsageRecordsFromJSONTyped(json, false);
}

export function UsageRecordsFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageRecords {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ModelCallRecordFromJSON)),
        'nextCursor': json['next_cursor'],
    };
}

export function UsageRecordsToJSON(json: any): UsageRecords {
    return UsageRecordsToJSONTyped(json, false);
}

export function UsageRecordsToJSONTyped(value?: UsageRecords | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ModelCallRecordToJSON)),
