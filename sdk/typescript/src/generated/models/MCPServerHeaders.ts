 ...
 *
 * @export
 * @interface MCPServerHeaders
 */
export interface MCPServerHeaders {
    /**
     * Exact name of one MCP server in the selected Agent Definition.
     * @type {string}
     * @memberof MCPServerHeaders
     */
    name: string;
    /**
...
/**
 * Check if a given object implements the MCPServerHeaders interface.
 */
export function instanceOfMCPServerHeaders(value: object): value is MCPServerHeaders {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('headers' in value) || value['headers'] === undefined) return false;
    return true;
}

export function MCPServerHeadersFromJSON(json: any): MCPServerHeaders {
    return MCPServerHeadersFromJSONTyped(json, false);
}

export function MCPServerHeadersFromJSONTyped(json: any, ignoreDiscriminator: boolean): MCPServerHeaders {
    if (json == null) {
        return json;
    }
    return {
...
export function MCPServerHeadersToJSON(json: any): MCPServerHeaders {
    return MCPServerHeadersToJSONTyped(json, false);
}

export function MCPServerHeadersToJSONTyped(value?: MCPServerHeaders | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
