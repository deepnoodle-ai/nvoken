...
/**
 * Whether this installation has a hosted observation store.
 * @export
 */
...
export function instanceOfObservationStatus(value: any): boolean {
    for (const key in ObservationStatus) {
        if (Object.prototype.hasOwnProperty.call(ObservationStatus, key)) {
            if (ObservationStatus[key as keyof typeof ObservationStatus] === value) {
                return true;
            }
        }
    }
...
export function ObservationStatusFromJSON(json: any): ObservationStatus {
    return ObservationStatusFromJSONTyped(json, false);
}

export function ObservationStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObservationStatus {
    return json as ObservationStatus;
}

export function ObservationStatusToJSON(value?: ObservationStatus | null): any {
    return value as any;
}

export function ObservationStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): ObservationStatus {
