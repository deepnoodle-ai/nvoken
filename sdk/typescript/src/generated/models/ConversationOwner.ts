...
import type { TenantConversationOwner } from './TenantConversationOwner.js';
import {
    instanceOfTenantConversationOwner,
    TenantConversationOwnerFromJSON,
    TenantConversationOwnerFromJSONTyped,
    TenantConversationOwnerToJSON,
} from './TenantConversationOwner.js';
import type { UserConversationOwner } from './UserConversationOwner.js';
import {
    instanceOfUserConversationOwner,
    UserConversationOwnerFromJSON,
    UserConversationOwnerFromJSONTyped,
    UserConversationOwnerToJSON,
} from './UserConversationOwner.js';
 ...
 * @export
 */
export type ConversationOwner = { kind: 'tenant' } & TenantConversationOwner | { kind: 'user' } & UserConversationOwner;

export function ConversationOwnerFromJSON(json: any): ConversationOwner {
    return ConversationOwnerFromJSONTyped(json, false);
}

export function ConversationOwnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationOwner {
    if (json == null) {
        return json;
    }
    switch (json['kind']) {
        case 'tenant':
            return Object.assign({}, TenantConversationOwnerFromJSONTyped(json, true), { kind: 'tenant' } as const);
        case 'user':
            return Object.assign({}, UserConversationOwnerFromJSONTyped(json, true), { kind: 'user' } as const);
        default:
            return json;
    }
}

export function ConversationOwnerToJSON(json: any): any {
    return ConversationOwnerToJSONTyped(json, false);
}

export function ConversationOwnerToJSONTyped(value?: ConversationOwner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['kind']) {
        case 'tenant':
            return Object.assign({}, TenantConversationOwnerToJSON(value), { kind: 'tenant' } as const);
        case 'user':
            return Object.assign({}, UserConversationOwnerToJSON(value), { kind: 'user' } as const);
        default:
            return value;
    }
}
