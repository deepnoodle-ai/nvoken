...
import type { BrowserTranscriptSnapshot } from './BrowserTranscriptSnapshot.js';
import {
    BrowserTranscriptSnapshotFromJSON,
    BrowserTranscriptSnapshotFromJSONTyped,
    BrowserTranscriptSnapshotToJSON,
} from './BrowserTranscriptSnapshot.js';
 ...
 * @export
 */
export type TranscriptSnapshotResponse = BrowserTranscriptSnapshot | TranscriptSnapshot;

export function TranscriptSnapshotResponseFromJSON(json: any): TranscriptSnapshotResponse {
    return TranscriptSnapshotResponseFromJSONTyped(json, false);
}

export function TranscriptSnapshotResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscriptSnapshotResponse {
    if (json == null) {
        return json;
    }
    ...
    if (false) {
        return BrowserTranscriptSnapshotFromJSONTyped(json, true);
    }
    if (true) {
...
export function TranscriptSnapshotResponseToJSON(json: any): any {
    return TranscriptSnapshotResponseToJSONTyped(json, false);
}

export function TranscriptSnapshotResponseToJSONTyped(value?: TranscriptSnapshotResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (false) {
        return BrowserTranscriptSnapshotToJSON(value as BrowserTranscriptSnapshot);
    }
    if (true) {
