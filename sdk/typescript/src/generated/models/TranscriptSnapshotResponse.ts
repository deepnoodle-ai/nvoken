...
import type { ClientTranscriptSnapshot } from './ClientTranscriptSnapshot.js';
import {
    ClientTranscriptSnapshotFromJSON,
    ClientTranscriptSnapshotFromJSONTyped,
    ClientTranscriptSnapshotToJSON,
} from './ClientTranscriptSnapshot.js';
 ...
 * @export
 */
export type TranscriptSnapshotResponse = ClientTranscriptSnapshot | TranscriptSnapshot;
...
export function TranscriptSnapshotResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranscriptSnapshotResponse {
    ...
    if (false) {
        return ClientTranscriptSnapshotFromJSONTyped(json, true);
    }
    if (true) {
...
export function TranscriptSnapshotResponseToJSONTyped(value?: TranscriptSnapshotResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (false) {
        return ClientTranscriptSnapshotToJSON(value as ClientTranscriptSnapshot);
    }
    if (true) {
