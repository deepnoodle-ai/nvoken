...
import type { BrowserInvocationAcceptedEvent } from './BrowserInvocationAcceptedEvent.js';
import {
    instanceOfBrowserInvocationAcceptedEvent,
    BrowserInvocationAcceptedEventFromJSON,
    BrowserInvocationAcceptedEventFromJSONTyped,
    BrowserInvocationAcceptedEventToJSON,
} from './BrowserInvocationAcceptedEvent.js';
import type { BrowserInvocationResultEvent } from './BrowserInvocationResultEvent.js';
import {
    instanceOfBrowserInvocationResultEvent,
    BrowserInvocationResultEventFromJSON,
    BrowserInvocationResultEventFromJSONTyped,
    BrowserInvocationResultEventToJSON,
} from './BrowserInvocationResultEvent.js';
import type { BrowserInvocationUpdateEvent } from './BrowserInvocationUpdateEvent.js';
import {
    instanceOfBrowserInvocationUpdateEvent,
    BrowserInvocationUpdateEventFromJSON,
    BrowserInvocationUpdateEventFromJSONTyped,
    BrowserInvocationUpdateEventToJSON,
} from './BrowserInvocationUpdateEvent.js';
...
/**
 * @type BrowserInvocationStreamEvent
 * Browser Invocation stream event. Switch on `type`. Host-only fields are
 * never emitted. New frame types may appear here over time, and existing
 * ones may gain fields.
 *
 * @export
 */
export type BrowserInvocationStreamEvent = { type: 'invocation.accepted' } & BrowserInvocationAcceptedEvent | { type: 'invocation.result' } & BrowserInvocationResultEvent | { type: 'invocation.update' } & BrowserInvocationUpdateEvent | { type: 'output_text.delta' } & OutputTextDeltaEvent | { type: 'stream.end' } & StreamEndEvent | { type: 'stream.resync' } & StreamResyncEvent | { type: 'thinking.delta' } & ThinkingDeltaEvent;

export function BrowserInvocationStreamEventFromJSON(json: any): BrowserInvocationStreamEvent {
    return BrowserInvocationStreamEventFromJSONTyped(json, false);
}

export function BrowserInvocationStreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationStreamEvent {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
        case 'invocation.accepted':
            return Object.assign({}, BrowserInvocationAcceptedEventFromJSONTyped(json, true), { type: 'invocation.accepted' } as const);
        case 'invocation.result':
            return Object.assign({}, BrowserInvocationResultEventFromJSONTyped(json, true), { type: 'invocation.result' } as const);
        case 'invocation.update':
            return Object.assign({}, BrowserInvocationUpdateEventFromJSONTyped(json, true), { type: 'invocation.update' } as const);
        case 'output_text.delta':
            return Object.assign({}, OutputTextDeltaEventFromJSONTyped(json, true), { type: 'output_text.delta' } as const);
        case 'stream.end':
            return Object.assign({}, StreamEndEventFromJSONTyped(json, true), { type: 'stream.end' } as const);
        case 'stream.resync':
            return Object.assign({}, StreamResyncEventFromJSONTyped(json, true), { type: 'stream.resync' } as const);
        case 'thinking.delta':
            return Object.assign({}, ThinkingDeltaEventFromJSONTyped(json, true), { type: 'thinking.delta' } as const);
        default:
            return json;
    }
}

export function BrowserInvocationStreamEventToJSON(json: any): any {
    return BrowserInvocationStreamEventToJSONTyped(json, false);
}

export function BrowserInvocationStreamEventToJSONTyped(value?: BrowserInvocationStreamEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        case 'invocation.accepted':
            return Object.assign({}, BrowserInvocationAcceptedEventToJSON(value), { type: 'invocation.accepted' } as const);
        case 'invocation.result':
            return Object.assign({}, BrowserInvocationResultEventToJSON(value), { type: 'invocation.result' } as const);
        case 'invocation.update':
            return Object.assign({}, BrowserInvocationUpdateEventToJSON(value), { type: 'invocation.update' } as const);
        case 'output_text.delta':
            return Object.assign({}, OutputTextDeltaEventToJSON(value), { type: 'output_text.delta' } as const);
        case 'stream.end':
            return Object.assign({}, StreamEndEventToJSON(value), { type: 'stream.end' } as const);
        case 'stream.resync':
            return Object.assign({}, StreamResyncEventToJSON(value), { type: 'stream.resync' } as const);
        case 'thinking.delta':
            return Object.assign({}, ThinkingDeltaEventToJSON(value), { type: 'thinking.delta' } as const);
        default:
            return value;
    }
}
