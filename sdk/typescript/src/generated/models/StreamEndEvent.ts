...
import type { StreamEndReason } from './StreamEndReason.js';
import {
    StreamEndReasonFromJSON,
    StreamEndReasonFromJSONTyped,
    StreamEndReasonToJSON,
    StreamEndReasonToJSONTyped,
} from './StreamEndReason.js';
...
export interface StreamEndEvent {
    ...
    sessionId: string;
    /**
     * The Invocation this connection was following, or null on a Session
     * stream.
     *
     * @type {string}
     * @memberof StreamEndEvent
...
export function StreamEndEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamEndEvent {
    ...
    return {
        ...
        'reason': StreamEndReasonFromJSON(json['reason']),
        'cursor': json['cursor'],
    };
}
...
export function StreamEndEventToJSONTyped(value?: StreamEndEvent | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'reason': StreamEndReasonToJSON(value['reason']),
        'cursor': value['cursor'],
    };
}
