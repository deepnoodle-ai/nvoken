...
import type { BrowserInvocation } from './BrowserInvocation.js';
import {
    BrowserInvocationFromJSON,
    BrowserInvocationFromJSONTyped,
    BrowserInvocationToJSON,
    BrowserInvocationToJSONTyped,
} from './BrowserInvocation.js';
 ...
 *
 * @export
 * @interface BrowserInvocationUpdateEvent
 */
export interface BrowserInvocationUpdateEvent {
    /**
     *
     * @type {BrowserInvocationUpdateEventTypeEnum}
     * @memberof BrowserInvocationUpdateEvent
     */
    type: BrowserInvocationUpdateEventTypeEnum;
    /**
     ...
     * @memberof BrowserInvocationUpdateEvent
     */
    newMessages: Array<BrowserSessionMessage>;
}
 ...
 * @export
 */
export const BrowserInvocationUpdateEventTypeEnum = {
    InvocationUpdate: 'invocation.update'
} as const;
export type BrowserInvocationUpdateEventTypeEnum = typeof BrowserInvocationUpdateEventTypeEnum[keyof typeof BrowserInvocationUpdateEventTypeEnum];


/**
 * Check if a given object implements the BrowserInvocationUpdateEvent interface.
 */
export function instanceOfBrowserInvocationUpdateEvent(value: object): value is BrowserInvocationUpdateEvent {
...
export function BrowserInvocationUpdateEventFromJSON(json: any): BrowserInvocationUpdateEvent {
    return BrowserInvocationUpdateEventFromJSONTyped(json, false);
}

export function BrowserInvocationUpdateEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationUpdateEvent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'invocation': BrowserInvocationFromJSON(json['invocation']),
        'newMessages': ((json['new_messages'] as Array<any>).map(BrowserSessionMessageFromJSON)),
    };
}

export function BrowserInvocationUpdateEventToJSON(json: any): BrowserInvocationUpdateEvent {
    return BrowserInvocationUpdateEventToJSONTyped(json, false);
}

export function BrowserInvocationUpdateEventToJSONTyped(value?: BrowserInvocationUpdateEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'invocation': BrowserInvocationToJSON(value['invocation']),
        'new_messages': ((value['newMessages'] as Array<any>).map(BrowserSessionMessageToJSON)),
    };
}
