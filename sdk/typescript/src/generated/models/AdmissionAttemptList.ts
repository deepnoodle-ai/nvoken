...
import type { AdmissionAttempt } from './AdmissionAttempt.js';
import {
    AdmissionAttemptFromJSON,
    AdmissionAttemptFromJSONTyped,
    AdmissionAttemptToJSON,
    AdmissionAttemptToJSONTyped,
} from './AdmissionAttempt.js';

/**
 *
 * @export
 * @interface AdmissionAttemptList
 */
export interface AdmissionAttemptList {
    /**
     *
     * @type {Array<AdmissionAttempt>}
     * @memberof AdmissionAttemptList
     */
    items: Array<AdmissionAttempt>;
    /**
     *
     * @type {string}
     * @memberof AdmissionAttemptList
...
/**
 * Check if a given object implements the AdmissionAttemptList interface.
 */
export function instanceOfAdmissionAttemptList(value: object): value is AdmissionAttemptList {
    if (!('items' in value) || value['items'] === undefined) return false;
    if (!('nextCursor' in value) || value['nextCursor'] === undefined) return false;
    return true;
}

export function AdmissionAttemptListFromJSON(json: any): AdmissionAttemptList {
    return AdmissionAttemptListFromJSONTyped(json, false);
}

export function AdmissionAttemptListFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdmissionAttemptList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(AdmissionAttemptFromJSON)),
        'nextCursor': json['next_cursor'],
    };
}

export function AdmissionAttemptListToJSON(json: any): AdmissionAttemptList {
    return AdmissionAttemptListToJSONTyped(json, false);
}

export function AdmissionAttemptListToJSONTyped(value?: AdmissionAttemptList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(AdmissionAttemptToJSON)),
