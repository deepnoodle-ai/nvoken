...
/**
 * Check if a given object implements the TurnList interface.
 */
export function instanceOfTurnList(value: object): value is TurnList {
...
export function TurnListFromJSON(json: any): TurnList {
    return TurnListFromJSONTyped(json, false);
}

export function TurnListFromJSONTyped(json: any, ignoreDiscriminator: boolean): TurnList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(TurnFromJSON)),
...
export function TurnListToJSON(json: any): TurnList {
    return TurnListToJSONTyped(json, false);
}

export function TurnListToJSONTyped(value?: TurnList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(TurnToJSON)),
