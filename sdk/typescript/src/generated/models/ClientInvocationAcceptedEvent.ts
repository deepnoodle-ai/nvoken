 ...
 *
 * @export
 * @interface ClientInvocationAcceptedEvent
 */
export interface ClientInvocationAcceptedEvent {
    /**
     *
     * @type {ClientInvocationAcceptedEventTypeEnum}
     * @memberof ClientInvocationAcceptedEvent
     */
    type: ClientInvocationAcceptedEventTypeEnum;
    /**
 ...
 * @export
 */
export const ClientInvocationAcceptedEventTypeEnum = {
    InvocationAccepted: 'invocation.accepted'
} as const;
export type ClientInvocationAcceptedEventTypeEnum = typeof ClientInvocationAcceptedEventTypeEnum[keyof typeof ClientInvocationAcceptedEventTypeEnum];


/**
 * Check if a given object implements the ClientInvocationAcceptedEvent interface.
 */
export function instanceOfClientInvocationAcceptedEvent(value: object): value is ClientInvocationAcceptedEvent {
...
export function ClientInvocationAcceptedEventFromJSON(json: any): ClientInvocationAcceptedEvent {
    return ClientInvocationAcceptedEventFromJSONTyped(json, false);
}

export function ClientInvocationAcceptedEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientInvocationAcceptedEvent {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientInvocationAcceptedEventToJSON(json: any): ClientInvocationAcceptedEvent {
    return ClientInvocationAcceptedEventToJSONTyped(json, false);
}

export function ClientInvocationAcceptedEventToJSONTyped(value?: ClientInvocationAcceptedEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
