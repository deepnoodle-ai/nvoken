...
import {
    ProviderKeyFromJSON,
    ProviderKeyFromJSONTyped,
    ProviderKeyToJSON,
    ProviderKeyToJSONTyped,
} from './ProviderKey.js';

/**
 *
 * @export
 * @interface ProviderKeyList
 */
export interface ProviderKeyList {
    /**
     *
     * @type {Array<ProviderKey>}
     * @memberof ProviderKeyList
     */
    items: Array<ProviderKey>;
    /**
     *
     * @type {boolean}
     * @memberof ProviderKeyList
...
/**
 * Check if a given object implements the ProviderKeyList interface.
 */
export function instanceOfProviderKeyList(value: object): value is ProviderKeyList {
...
export function ProviderKeyListFromJSON(json: any): ProviderKeyList {
    return ProviderKeyListFromJSONTyped(json, false);
}

export function ProviderKeyListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProviderKeyList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(ProviderKeyFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function ProviderKeyListToJSON(json: any): ProviderKeyList {
    return ProviderKeyListToJSONTyped(json, false);
}

export function ProviderKeyListToJSONTyped(value?: ProviderKeyList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(ProviderKeyToJSON)),
