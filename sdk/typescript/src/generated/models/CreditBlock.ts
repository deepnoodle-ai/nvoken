...
/**
 * Check if a given object implements the CreditBlock interface.
 */
export function instanceOfCreditBlock(value: object): value is CreditBlock {
    if (!('tenantKey' in value) || value['tenantKey'] === undefined) return false;
    return true;
}

export function CreditBlockFromJSON(json: any): CreditBlock {
    return CreditBlockFromJSONTyped(json, false);
}

export function CreditBlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditBlock {
    if (json == null) {
        return json;
    }
    return {
...
export function CreditBlockToJSON(json: any): CreditBlock {
    return CreditBlockToJSONTyped(json, false);
}

export function CreditBlockToJSONTyped(value?: CreditBlock | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
