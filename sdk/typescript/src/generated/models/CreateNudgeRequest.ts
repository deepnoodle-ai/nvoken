...
/**
 * Check if a given object implements the CreateNudgeRequest interface.
 */
export function instanceOfCreateNudgeRequest(value: object): value is CreateNudgeRequest {
    if (!('content' in value) || value['content'] === undefined) return false;
    return true;
}

export function CreateNudgeRequestFromJSON(json: any): CreateNudgeRequest {
    return CreateNudgeRequestFromJSONTyped(json, false);
}

export function CreateNudgeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateNudgeRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateNudgeRequestToJSON(json: any): CreateNudgeRequest {
    return CreateNudgeRequestToJSONTyped(json, false);
}

export function CreateNudgeRequestToJSONTyped(value?: CreateNudgeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
