 ...
 *
 * @export
 * @interface BrowserInvocationList
 */
export interface BrowserInvocationList {
    /**
     *
     * @type {Array<BrowserInvocation>}
     * @memberof BrowserInvocationList
     */
    items: Array<BrowserInvocation>;
    /**
     *
     * @type {boolean}
     * @memberof BrowserInvocationList
...
/**
 * Check if a given object implements the BrowserInvocationList interface.
 */
export function instanceOfBrowserInvocationList(value: object): value is BrowserInvocationList {
...
export function BrowserInvocationListFromJSON(json: any): BrowserInvocationList {
    return BrowserInvocationListFromJSONTyped(json, false);
}

export function BrowserInvocationListFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserInvocationList {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(BrowserInvocationFromJSON)),
        'hasMore': json['has_more'],
        'nextCursor': json['next_cursor'],
    };
}

export function BrowserInvocationListToJSON(json: any): BrowserInvocationList {
    return BrowserInvocationListToJSONTyped(json, false);
}

export function BrowserInvocationListToJSONTyped(value?: BrowserInvocationList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(BrowserInvocationToJSON)),
