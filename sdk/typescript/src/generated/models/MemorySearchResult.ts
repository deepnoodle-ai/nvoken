...
/**
 * Check if a given object implements the MemorySearchResult interface.
 */
export function instanceOfMemorySearchResult(value: object): value is MemorySearchResult {
    if (!('memory' in value) || value['memory'] === undefined) return false;
    if (!('score' in value) || value['score'] === undefined) return false;
    return true;
}

export function MemorySearchResultFromJSON(json: any): MemorySearchResult {
    return MemorySearchResultFromJSONTyped(json, false);
}

export function MemorySearchResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemorySearchResult {
    if (json == null) {
        return json;
    }
    return {
...
export function MemorySearchResultToJSON(json: any): MemorySearchResult {
    return MemorySearchResultToJSONTyped(json, false);
}

export function MemorySearchResultToJSONTyped(value?: MemorySearchResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
