 ...
 *
 * @export
 * @interface NoTurnMemory
 */
export interface NoTurnMemory {
    /**
     *
     * @type {NoTurnMemoryScopeEnum}
     * @memberof NoTurnMemory
     */
    scope: NoTurnMemoryScopeEnum;
}
 ...
 * @export
 */
export const NoTurnMemoryScopeEnum = {
    None: 'none'
} as const;
export type NoTurnMemoryScopeEnum = typeof NoTurnMemoryScopeEnum[keyof typeof NoTurnMemoryScopeEnum];


/**
 * Check if a given object implements the NoTurnMemory interface.
 */
export function instanceOfNoTurnMemory(value: object): value is NoTurnMemory {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    return true;
}

export function NoTurnMemoryFromJSON(json: any): NoTurnMemory {
    return NoTurnMemoryFromJSONTyped(json, false);
}

export function NoTurnMemoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): NoTurnMemory {
    if (json == null) {
        return json;
    }
    return {
...
export function NoTurnMemoryToJSON(json: any): NoTurnMemory {
    return NoTurnMemoryToJSONTyped(json, false);
}

export function NoTurnMemoryToJSONTyped(value?: NoTurnMemory | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
