...
import type { MemoryContextConfig } from './MemoryContextConfig.js';
import {
    MemoryContextConfigFromJSON,
    MemoryContextConfigFromJSONTyped,
    MemoryContextConfigToJSON,
    MemoryContextConfigToJSONTyped,
} from './MemoryContextConfig.js';

/**
 * Opts this Agent Definition into durable memory and automatically
...
export interface MemoryConfig {
    /**
     * User scope requires user_key on every admitted Invocation.
     * @type {MemoryConfigScopeEnum}
     * @memberof MemoryConfig
     */
    scope?: MemoryConfigScopeEnum;
    /**
     *
 ...
 * @export
 */
export const MemoryConfigScopeEnum = {
    Tenant: 'tenant',
    User: 'user'
} as const;
export type MemoryConfigScopeEnum = typeof MemoryConfigScopeEnum[keyof typeof MemoryConfigScopeEnum];


/**
 * Check if a given object implements the MemoryConfig interface.
 */
export function instanceOfMemoryConfig(value: object): value is MemoryConfig {
    return true;
}

export function MemoryConfigFromJSON(json: any): MemoryConfig {
    return MemoryConfigFromJSONTyped(json, false);
}

export function MemoryConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemoryConfig {
    if (json == null) {
        return json;
    }
    return {
        ...
        'context': json['context'] == null ? undefined : MemoryContextConfigFromJSON(json['context']),
    };
}

export function MemoryConfigToJSON(json: any): MemoryConfig {
    return MemoryConfigToJSONTyped(json, false);
}

export function MemoryConfigToJSONTyped(value?: MemoryConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'scope': value['scope'],
        'context': MemoryContextConfigToJSON(value['context']),
    };
}
