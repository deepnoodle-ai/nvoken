 ...
 *
 * @export
 * @interface BrowserStandaloneOnlyAccess
 */
export interface BrowserStandaloneOnlyAccess {
    /**
     *
     * @type {BrowserStandaloneOnlyAccessScopeEnum}
     * @memberof BrowserStandaloneOnlyAccess
     */
    scope: BrowserStandaloneOnlyAccessScopeEnum;
}
 ...
 * @export
 */
export const BrowserStandaloneOnlyAccessScopeEnum = {
    StandaloneOnly: 'standalone_only'
} as const;
export type BrowserStandaloneOnlyAccessScopeEnum = typeof BrowserStandaloneOnlyAccessScopeEnum[keyof typeof BrowserStandaloneOnlyAccessScopeEnum];


/**
 * Check if a given object implements the BrowserStandaloneOnlyAccess interface.
 */
export function instanceOfBrowserStandaloneOnlyAccess(value: object): value is BrowserStandaloneOnlyAccess {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    return true;
}

export function BrowserStandaloneOnlyAccessFromJSON(json: any): BrowserStandaloneOnlyAccess {
    return BrowserStandaloneOnlyAccessFromJSONTyped(json, false);
}

export function BrowserStandaloneOnlyAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowserStandaloneOnlyAccess {
    if (json == null) {
        return json;
    }
    return {
...
export function BrowserStandaloneOnlyAccessToJSON(json: any): BrowserStandaloneOnlyAccess {
    return BrowserStandaloneOnlyAccessToJSONTyped(json, false);
}

export function BrowserStandaloneOnlyAccessToJSONTyped(value?: BrowserStandaloneOnlyAccess | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
