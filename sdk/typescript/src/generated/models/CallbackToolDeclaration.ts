...
/**
 * A callback tool is a host tool nvoken delivers to the host's endpoint
 * instead of waiting for the host to poll.
 *
 * @export
 * @interface CallbackToolDeclaration
 */
export interface CallbackToolDeclaration {
    /**
     * The tool's name, unique within this agent definition. Names starting
     ...
     *
     * @type {string}
     * @memberof CallbackToolDeclaration
     */
    name: string;
    /**
     *
    ...
    /**
     *
     * @type {CallbackToolDeclarationModeEnum}
     * @memberof CallbackToolDeclaration
     */
    mode: CallbackToolDeclarationModeEnum;
    /**
 ...
 * @export
 */
export const CallbackToolDeclarationModeEnum = {
    ModeCallback: 'callback'
} as const;
export type CallbackToolDeclarationModeEnum = typeof CallbackToolDeclarationModeEnum[keyof typeof CallbackToolDeclarationModeEnum];


/**
 * Check if a given object implements the CallbackToolDeclaration interface.
 */
export function instanceOfCallbackToolDeclaration(value: object): value is CallbackToolDeclaration {
...
export function CallbackToolDeclarationFromJSON(json: any): CallbackToolDeclaration {
    return CallbackToolDeclarationFromJSONTyped(json, false);
}

export function CallbackToolDeclarationFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallbackToolDeclaration {
    if (json == null) {
        return json;
    }
    return {
...
export function CallbackToolDeclarationToJSON(json: any): CallbackToolDeclaration {
    return CallbackToolDeclarationToJSONTyped(json, false);
}

export function CallbackToolDeclarationToJSONTyped(value?: CallbackToolDeclaration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
