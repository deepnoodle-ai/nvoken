...
func TestTurnStartUsesTargetCommandAndEndpoint(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
		...
		case "/v1/agents/agent_01kc514000e008000000000001":
			_, _ = writer.Write([]byte(`{"id":"agent_01kc514000e008000000000001","agent_key":"analyst","name":"Analyst","owner":{"kind":"app"},"current_revision":1,"archived_at":null,"created_at":"2026-01-01T00:00:00Z","updated_at":"2026-01-01T00:00:00Z"}`))
		case "/v1/turns":
	...
	result := newApp().Test(t,
		cli.TestArgs("--json", "turn", "start", "--agent-id", "agent_01kc514000e008000000000001", "--tenant", "acme", "hello"),
	...
	if !strings.Contains(result.Stdout, `"id": "turn_01kc514000e008000000000001"`) {
		t.Fatalf("stdout = %s", result.Stdout)
	}
	want := []string{"GET /v1/agents/agent_01kc514000e008000000000001", "POST /v1/turns", "GET /v1/turns/turn_01kc514000e008000000000001/result"}
