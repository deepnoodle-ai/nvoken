...
| --- | --- | --- |
| `single_daemon` | **Pending** | The runtime mode and initial retention posture are implemented, but packaged install, restart/failure, upgrade/rollback, restore, diagnosis, capacity, and secret-handling evidence has not been recorded for this profile. |
