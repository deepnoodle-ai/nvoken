...
func TestReleasePassesServingRevisionToMigrationPreflight(t *testing.T) {
	...
	if !strings.Contains(log, "migration-vars current_image=us-central1-docker.pkg.dev/example-project/nvoken-test/nvokend:build-13 current_schema=13 target_schema=17 mode=transition") {
